System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, UITransform, Size, Prefab, instantiate, Vec3, tween, Mask, GodWealth_BaseComponent, AudioManager, SoundList, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, GodWealth_Roller;
  ...
  function _reportPossibleCrUseOfGodWealth_Icon(extras) {
    _reporterNs.report("GodWealth_Icon", "./GodWealth_Icon", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ca6658S5/NEBLdptvmXNXDz", "GodWealth_Roller", undefined);
      ...
      _export("GodWealth_Roller", GodWealth_Roller = (_dec = ccclass('GodWealth_Roller'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec(_class = (_class2 = class GodWealth_Roller extends (_crd && GodWealth_BaseComponent === void 0 ? (_reportPossibleCrUseOfGodWealth_BaseComponent({
        error: Error()
        ...
        bindUI() {
          ...
          for (var i = 0; i < this.rollerData.portraitNum; i++) {
            ...
            icon.getComponent("GodWealth_Icon").setFace(this.rollerData.data[index]);
        ...
        startRoll(stopIndex, isSpeed) {
          ...
          this.RollerLayOut.children.forEach(icon => {
            icon.getComponent("GodWealth_Icon").setEffect();
          });
        ...
        joinIcon() {
          ...
          this.RollerLayOut.addChild(icon);
          icon.getComponent("GodWealth_Icon").setFace(this.rollerData.data[this.lastJoinIconIndex]);
        ...
        setIconEffect(mode, target, allState) {
          ...
          if (mode === 'index') {
            this.RollerLayOut.children.forEach(icon => {
              var comp = icon.getComponent("GodWealth_Icon");
        ...
        addDockIcon(targetArr) {
          ...
          targetArr.forEach((item, index) => {
            try {
              ...
              icon.getComponent("GodWealth_Icon").hiddenAmounts(item[1]);
...
//# sourceMappingURL=f320fe5eb39c45a5b6340e69c42742f5b7c584d7.js.map