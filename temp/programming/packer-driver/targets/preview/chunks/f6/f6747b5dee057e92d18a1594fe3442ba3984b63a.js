  ...
  return {
    ...
    execute: function () {
      ...
      _export("Fish_RoomChoose", Fish_RoomChoose = (_dec = ccclass('Fish_RoomChoose'), _dec(_class = class Fish_RoomChoose extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initRoomInfo() {
          for (var i = 0; i < this.props.roomInfos.length; i++) {
            var _roomInfo = this.props.roomInfos[i];
            var roomNode = this.node.getChildByName("props_room_" + (i + 1));
            roomNode && this.updateRoomInfo(roomNode, _roomInfo);
          }
        }
...
//# sourceMappingURL=f6747b5dee057e92d18a1594fe3442ba3984b63a.js.map