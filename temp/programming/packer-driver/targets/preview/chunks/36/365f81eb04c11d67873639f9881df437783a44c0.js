    ...
    execute: function () {
      ...
      _export("Share_Info", Share_Info = (_dec = ccclass('Share_Info'), _dec(_class = class Share_Info extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          this.propertyNode.props_spr_title.on(Node.EventType.TOUCH_END, () => {
            (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              ...
              var help = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                error: Error()
          ...
          this.propertyNode.props_btn_share_mengi.on(Node.EventType.TOUCH_END, () => {
            //绑定会员
            var actingId = this.propertyNode.props_EditBox_shareName.getComponent(EditBox).string.trim();
          ...
          this.propertyNode.props_spr_QR_code.on(Node.EventType.TOUCH_END, () => {
            // 打开二维码
            var node = instantiate(this.propertyNode.props_spr_QR_code);
        ...
        createQRCode(text, sz, callback) {
          var qr = (_crd && qrcode === void 0 ? (_reportPossibleCrUseOfqrcode({
            error: Error()
          }), qrcode) : qrcode)(4, 'L');
          qr.addData(text);
          qr.make();
          ...
          var tileH = size / qr.getModuleCount(); // 绘制二维码
          ...
          var imageAsset = new ImageAsset(canvas); // 创建 Texture2D
...
//# sourceMappingURL=365f81eb04c11d67873639f9881df437783a44c0.js.map