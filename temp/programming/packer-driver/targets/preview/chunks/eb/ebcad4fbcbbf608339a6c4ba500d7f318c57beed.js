System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ViewModel, StoreInject, global, config, convertBetData, convertToServerBetType, gameCacheData, SKT_MAG_TYPE, sktInstance, getStore, _clearBet, seatBet, changeSeatBet, _dec, _class, _crd, BetAreaViewModel;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      _clearBet = _unresolved_8.clearBet;
      ...
      BetAreaViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          this.setEvent({
            ...
            clearBet: () => {
              this.dispatch((_crd && _clearBet === void 0 ? (_reportPossibleCrUseOfclearBet({
                error: Error()
              }), _clearBet) : _clearBet)(false));
            },
            openShop: () => {
        ...
        initBetData(memberBetDetail, seats) {
          ...
          memberBetDetail.forEach(v => {
            var seat = seats.find(seat => seat.userId === v.memberId);
            var index = seat ? seat.index : (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
            }), config) : config).gameOption.lookOnIndex;
            var betData = (_crd && convertBetData === void 0 ? (_reportPossibleCrUseOfconvertBetData({
              error: Error()
...
//# sourceMappingURL=ebcad4fbcbbf608339a6c4ba500d7f318c57beed.js.map