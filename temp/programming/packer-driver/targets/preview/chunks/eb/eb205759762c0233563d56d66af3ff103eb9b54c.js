System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function createCustomEqual(options) {
    ...
    var config = (_crd && createEqualityComparatorConfig === void 0 ? (_reportPossibleCrUseOfcreateEqualityComparatorConfig({
      error: Error()
    }), createEqualityComparatorConfig) : createEqualityComparatorConfig)(options);
    var comparator = (_crd && createEqualityComparator === void 0 ? (_reportPossibleCrUseOfcreateEqualityComparator({
      error: Error()
    }), createEqualityComparator) : createEqualityComparator)(config);
    var equals = createCustomInternalComparator ? createCustomInternalComparator(comparator) : (_crd && createInternalEqualityComparator === void 0 ? (_reportPossibleCrUseOfcreateInternalEqualityComparator({
      error: Error()
...
//# sourceMappingURL=eb205759762c0233563d56d66af3ff103eb9b54c.js.map