System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "redux-act"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "94e32uA0qRJxoumGhgcmBZ+", "game", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_CHANGE_GAME]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_CHANGE_VIEW_GAME]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_UPDATE_BALANCE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_CHANGE_PROFIT]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_CHANGE_AUTO_LAUNCHER_TYPE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_UPDATE_SUBGAME_TIMES]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_SET_SUBGAME_TIMES]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_UPDATE_JACKPOT_AMOUNT]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_SET_WAITING]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_SET_AUTO_LAUNCH]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_SET_AUTO_LAUNCHED_TIMES]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_SET_STOP_MODE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_SET_SORT]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_FREE_GAME_ID]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).PHOENIX_FREE_GAME_RATE]: (state, payload) => {
          return _extends({}, state, {
...
//# sourceMappingURL=542f1a3be4afbdfc9e633d0ca837d4a3652188fd.js.map