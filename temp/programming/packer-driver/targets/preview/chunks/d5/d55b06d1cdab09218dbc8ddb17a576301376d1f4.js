System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Label, Node, Toggle, Color, BaseComponent, setAutoLauncherInfo, setBetDropDownList, updateDialogInfo, updatePositionId, updateSubGameAnimationPlayInfo, updateRollerStatus, updateSpeedStatus, AutoLauncherType, calBetAmount, DialogType, GameType, isAuto, RollerStatus, config, StepNumber, cacheData, godWealthV2_Audio, mainViewModel, SoundPathDefine, StepNumberV2, global, _dec, _class, _crd, ccclass, property, GodWealthV2_Footer;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      godWealthV2_Audio = _unresolved_9.godWealthV2_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2fff0T4OXlIL4BrDg6hVaA2", "GodWealthV2_Footer", undefined);

      __checkObsolete__(['_decorator', 'Button', 'Label', 'Node', 'Sprite', 'Toggle', 'Animation', 'Color']);
      ...
      _export("GodWealthV2_Footer", GodWealthV2_Footer = (_dec = ccclass('GodWealthV2_Footer'), _dec(_class = class GodWealthV2_Footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        bindEvent() {
          ...
          this.propertyNode.props_startButton.on(Node.EventType.TOUCH_END, () => {
            ...
            this.unscheduleLong(); // this.unscheduleAllCallbacks();
            ...
            if ((_crd && isAuto === void 0 ? (_reportPossibleCrUseOfisAuto({
              ...
              if (this.props.rollerStatus === (_crd && RollerStatus === void 0 ? (_reportPossibleCrUseOfRollerStatus({
                error: Error()
              }), RollerStatus) : RollerStatus).END && !this.isChangeGame()) {
          ...
          this.propertyNode.props_SZX_bz_btn.on(Node.EventType.TOUCH_END, () => {
            ...
            this.events.openHelpPanel(); // this.dispatch(updateDialogInfo({
        ...
        updateMaxBetStatus() {
          var isMaxBet = this.props.positionId >= this.getMaxBetPositionId();
        ...
        bindUI() {
          ...
          (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
          }), mainViewModel) : mainViewModel).setStartBtnPos(this.propertyNode.props_startButton.worldPosition);
          this.propertyNode.props_spr_nomoney.active = false;
        }
...
//# sourceMappingURL=d55b06d1cdab09218dbc8ddb17a576301376d1f4.js.map