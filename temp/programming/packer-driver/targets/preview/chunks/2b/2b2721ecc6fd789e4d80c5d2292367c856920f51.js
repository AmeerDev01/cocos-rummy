    ...
    execute: function () {
      ...
      _export("Qiuqiu_SendCard", Qiuqiu_SendCard = (_dec = ccclass('Qiuqiu_SendCard'), _dec(_class = class Qiuqiu_SendCard extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        beginDeal(dealNumber) {
          var gameNumber = this.getGameNumber();
        ...
        roundDeal(gameNumber, dealNumber, flySeatIndex) {
          ...
          this.dealCount++;
          var startNode = this.node.getChildByName("prpos_spr_card" + this.dealIndex);
        ...
        flyCard(startNode, rountNumber, gameNumber, count, flySeatIndex, done) {
          ...
          var seatIndex = flySeatIndex;
          var endPos = this.events.getSeatCardPoint(seatIndex, rountNumber);
        ...
        createFlyCard(startPos, endPos, done) {
          var flyNode = instantiate(this.propertyNode.props_icon_qiuqiu_paibei);
          flyNode.active = true;
          ...
          if ((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            var dealAnimeSpeed = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
        ...
        reconnectShowCard() {
          ...
          for (var i = 1; i < this.dealIndex; i++) {
...
//# sourceMappingURL=2b2721ecc6fd789e4d80c5d2292367c856920f51.js.map