System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, Sprite, _decorator, BaseComponent, formatNumber, getGoldShorten, getNodeByNameDeep, omitStr, config, global, _dec, _class, _crd, ccclass, property, Yxx_LosePanel;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c55a9GE5A1Gu7V5J+o5GArY", "Yxx_LosePanel", undefined);

      __checkObsolete__(['Label', 'Node', 'Sprite', 'SpriteFrame', 'Tween', 'Vec3', '_decorator', 'instantiate', 'tween']);
      ...
      _export("Yxx_LosePanel", Yxx_LosePanel = (_dec = ccclass('Yxx_LosePanel'), _dec(_class = class Yxx_LosePanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          if (key === 'userInfos') {
            ...
            this.propertyNode.props_lose_label.string = (_crd && formatNumber === void 0 ? (_reportPossibleCrUseOfformatNumber({
              error: Error()
...
//# sourceMappingURL=4a54d7375dcabadcdcedd42ed25737d984674d90.js.map