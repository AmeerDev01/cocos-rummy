    ...
    execute: function () {
      ...
      BaseBoardViewModel = class BaseBoardViewModel extends (_crd && ViewModel === void 0 ? (_reportPossibleCrUseOfViewModel({
        ...
        begin() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              ...
              var givePanel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                error: Error()
          ...
          var baseBoard = this.comp.getPropertyNode().props_mainBoard;
        ...
        initMainPanel(baseBoard) {
          ...
          this.mainPanelViewModel.logOut = function (isForce) {
            if (isForce === void 0) {
              isForce = false;
            }
            ...
            var exit = () => {
              ...
              _this.comp.props.openGameInfo && _this.comp.closeSubGame();
              sys.localStorage.removeItem("token"); // this.comp.getMainBoardNode().destroyAllChildren()

              _this.initLoginPanel(baseBoard, false);
              ...
              _this.dispatch((_crd && resetMemberInfo === void 0 ? (_reportPossibleCrUseOfresetMemberInfo({
                error: Error()
              }), resetMemberInfo) : resetMemberInfo)(undefined));

              _this.dispatch((_crd && resetWithDrawInfo === void 0 ? (_reportPossibleCrUseOfresetWithDrawInfo({
                error: Error()
              }), resetWithDrawInfo) : resetWithDrawInfo)(undefined));

              _this.comp.scheduleOnce(() => {
                // 踏马的，这里有点诡异
                _this.mainPanelViewModel.unMount().then(() => {
                  _this.mainPanelViewModel = null;
                });
              }, 0.3);
            };
            ...
            if (isForce) {
              ...
              (_crd && fetcher === void 0 ? (_reportPossibleCrUseOffetcher({
                ...
                !isForce && _this.dispatch((_crd && addToastAction === void 0 ? (_reportPossibleCrUseOfaddToastAction({
                  error: Error()
                }), addToastAction) : addToastAction)({
                  content: (_crd && lang === void 0 ? (_reportPossibleCrUseOflang({
                    error: Error()
        ...
        initLoginPanel(baseBoard, isAutoLogin) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            if (isAutoLogin === void 0) {
              isAutoLogin = true;
            }

            // this.loginPageViewModel = new LoginPageViewModel()
            _this2.loginPageV2ViewModel = new (_crd && LoginPageV2ViewModel === void 0 ? (_reportPossibleCrUseOfLoginPageV2ViewModel({
              error: Error()
            }), LoginPageV2ViewModel) : LoginPageV2ViewModel)().mountView((yield (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              error: Error()
              ...
              onLoginSuccess: () => {
                _this2.dispatch((_crd && setLoadingAction === void 0 ? (_reportPossibleCrUseOfsetLoadingAction({
                  error: Error()
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  // }
                  _this2.loginPageV2ViewModel.unMount((_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                    error: Error()
                  }), EffectType) : EffectType).EFFECT1);
                  ...
                  _this2.initMainPanel(baseBoard);
                }).catch(e => {
                  (_crd && sktInstance === void 0 ? (_reportPossibleCrUseOfsktInstance({
                    error: Error()
                  }), sktInstance) : sktInstance).close();
...
//# sourceMappingURL=dbc5c629dfab2826c5ec34d5c7b77a5746b89cb2.js.map