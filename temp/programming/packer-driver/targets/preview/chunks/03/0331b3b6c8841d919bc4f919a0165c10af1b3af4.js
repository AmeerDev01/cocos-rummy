System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, RollerMediatorConst, RollerType, BaseCommand, SKT_MAG_TYPE, sktMsgListener, SubGameType, getSlotProxy, getSocketProxy, RollerCommand, _crd, RollerCommandConst;
  ...
  function _reportPossibleCrUseOfgetSlotProxy(extras) {
    _reporterNs.report("getSlotProxy", "../phoenix_utils", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c08647u/ARGX5yehw4znh0N", "RollerCommand", undefined);
          ...
          this.listExecute = [{
            ...
            handler(notification) {
              ...
              (_crd && getSlotProxy === void 0 ? (_reportPossibleCrUseOfgetSlotProxy({
                error: Error()
              }), getSlotProxy) : getSlotProxy)().initRoller(); // if (gameType === 1 && freeGameCount === 0) {
...
//# sourceMappingURL=0331b3b6c8841d919bc4f919a0165c10af1b3af4.js.map