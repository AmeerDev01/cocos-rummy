  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ModalBox = class ModalBox extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        show(option, okHandler, cancleHandler) {
          if (okHandler === void 0) {
            okHandler = () => true;
          }

          if (cancleHandler === void 0) {
            cancleHandler = () => true;
          }

          this.isShow = true;
          this.contentStr = option.content;
          var modalBox = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
...
//# sourceMappingURL=73203358544481657fecf738069c4d58bd9655b8.js.map