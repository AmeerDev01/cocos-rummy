    ...
    execute: function () {
      ...
      _export("ThorV2_Footer", ThorV2_Footer = (_dec = ccclass('ThorV2_Footer'), _dec(_class = class ThorV2_Footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        updateStartButtonAutoType() {
          var startBgNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          }), getNodeByNameDeep) : getNodeByNameDeep)("props_word_down_pular", this.propertyNode.props_startButton);
          var stopBgNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
        ...
        updateAutoBtn() {
          var props_autoLaunch_not_auto = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          }), getNodeByNameDeep) : getNodeByNameDeep)("props_autoLaunch_not_auto", this.propertyNode.props_btn_down_auto);
          var props_autoLaunch_auto = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          ...
          if (!this.isMain()) {
            ...
            var props_autoLaunch_label = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            }), getNodeByNameDeep) : getNodeByNameDeep)("props_autoLaunch_label", props_autoLaunch_auto);
            var props_autoLaunch_limit = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            ...
            if (auto) {
              ...
              if (!this.isLimit()) {
                ...
                var props_autoLaunch_limit_count = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                  error: Error()
        ...
        updateScore(value) {
          ...
          this.stepNumber = new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
            ...
            if (this.node && this.node.isValid) {
              ...
              this.propertyNode.props_word_down_winNum.string = _value.formatAmountWithCommas();
            }
          });
...
//# sourceMappingURL=20849cbdbb0eacfa5b849b0b7eff781885971a3d.js.map