    ...
    execute: function () {
      ...
      _export("Domino_BalancePanel", Domino_BalancePanel = (_dec = ccclass('Domino_BalancePanel'), _dec(_class = class Domino_BalancePanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        genPlayerItem(balancePlayer) {
          var playerItem = instantiate(this.propertyNode.props_player_item);
          ...
          var headSprite = playerItem.getChildByName('props_btn_mine_head').getComponent(Sprite); // global.loadHeadSprite(balancePlayer.icon, headSprite);

          var cards = playerItem.getChildByName('props_layout_cards');
...
//# sourceMappingURL=f5624e897217ac0f9d4546d380204ca8c51e0100.js.map