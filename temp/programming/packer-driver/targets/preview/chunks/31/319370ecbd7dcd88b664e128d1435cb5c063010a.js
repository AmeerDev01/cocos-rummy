    ...
    execute: function () {
      ...
      _export("dragon_RollerPanel", dragon_RollerPanel = (_dec = ccclass('dragon_RollerPanel'), _dec2 = property(Prefab), _dec(_class = (_class2 = class dragon_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindUI() {
          ...
          var ui = this.node.parent.getComponent(UIOpacity); // ui.opacity = 0;
        ...
        stopRoll(i, callBack) {
          ...
          var rollerComp = this.rollerList[i].getComponent("dragon_Roller");
        ...
        controlTheHeightOfTheRingOfFire() {
          ...
          var Change = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
            error: Error()
          ...
          var _loop = function _loop(key) {
            _this.rollerList.forEach((roller, i) => {
              if (Change[key][0] === i) {
...
//# sourceMappingURL=319370ecbd7dcd88b664e128d1435cb5c063010a.js.map