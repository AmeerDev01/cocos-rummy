    ...
    execute: function () {
      ...
      _export("EgyptV2_Roller", EgyptV2_Roller = (_dec = ccclass('EgyptV2_Roller'), _dec(_class = class EgyptV2_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        buildSkeleton(parentNode, pos, iconCount) {
          var fileName = iconCount === 2 ? (_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
        ...
        addLockIcon(isPlayAnimation) {
          ...
          lockValues.forEach(v => {
            var egyptV2Icon = this.lockIcons.find(iconv => iconv.getIconIndex() === v.index);
        ...
        buildSingleRollerIcon(index, pos, icon) {
          var viewModel = new (_crd && EgyptV2SingleIconRollerViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2SingleIconRollerViewModel({
            error: Error()
        ...
        getBeetleNode(isIncludeSunGod) {
          if (isIncludeSunGod === void 0) {
            isIncludeSunGod = false;
          }

          var nodes = [];

          for (var i = 0; i < this.showIconCount; i++) {
            var element = this.iconArr[i]; // 获得太阳神图标，数字必须要大于0的

            var isSunGod = isIncludeSunGod && element.getId() === (_crd && IconId === void 0 ? (_reportPossibleCrUseOfIconId({
              error: Error()
        ...
        getSunGodIconNode() {
          ...
          var _loop2 = function _loop2(i) {
            var element = _this2.iconArr[i]; // 并且要是锁定的图标
...
//# sourceMappingURL=9ee199d3b591798a7f706bb672cce5483a5ef85c.js.map