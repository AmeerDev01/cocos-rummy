      ...
      _export("TurntablePanel", TurntablePanel = (_dec = ccclass('TurntablePanel'), _dec(_class = class TurntablePanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        updateLabel() {
          if (this.CarouselData.length > 0) {
            ...
            var currentPos = this.propertyNode.props_label_remind.getPosition();
        ...
        initAll() {
          var view = this.propertyNode.props_ScrollView_all.getChildByName('view');
          var content = view.getChildByName('content');
          var item = view.getChildByName('item');
          content.destroyAllChildren();
          this.winningRecordData.length > 0 && this.winningRecordData.forEach(i => {
            var node = instantiate(item);
            node.active = true;
        ...
        initMy() {
          var view = this.propertyNode.props_ScrollView_my.getChildByName('view');
          var content = view.getChildByName('content');
          var item = view.getChildByName('item');
          content.destroyAllChildren();
...
//# sourceMappingURL=279ff12f7ff62f1de360a7a297b4820d47aecff7.js.map