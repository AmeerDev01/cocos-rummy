      ...
      _export("GodWealth_roller", GodWealth_roller = (_dec = ccclass('GodWealth_roller'), _dec(_class = class GodWealth_roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          ...
          if (key === "iconEffectData") {
            ...
            var baoheIconNum = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
              error: Error()
            ...
            var baoheIconIndex = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
              error: Error()
            }), dataTransfer) : dataTransfer)((_crd && DataKeyType === void 0 ? (_reportPossibleCrUseOfDataKeyType({
              error: Error()
          ...
          if (key === "iconBaoHeEffectData") {
            ...
            if (value.cur.iconEffectArr.length) {
              value.cur.iconEffectArr.forEach((p, i) => {
                var index = 1;
                var baoHeIcon = new (_crd && RollerIconViewModel === void 0 ? (_reportPossibleCrUseOfRollerIconViewModel({
                  error: Error()
          ...
          if (key === "iconFreeGameEffectData") {
            ...
            for (var _i = 0, _l = this.displayIconList.length; _i < _l; _i++) {
              ...
              if (this.props.iconFreeGameEffectData.iconEffectArr.indexOf(_index) !== -1) {
                _item.setProps({
        ...
        creator(isInit) {
          ...
          var iconViewModel = this.joinIcon(isInit);
...
//# sourceMappingURL=2f6c6d197871862d788b4dea2dc50138eb74e5fe.js.map