System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Label, Node, Sprite, BaseComponent, getNodeByNameDeep, omitStr, global, _dec, _class, _crd, ccclass, property, GodWealth_jackPot;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b7aacWhEBtDKqY1MGOWXE24", "GodWealth_jackPot", undefined);
      ...
      _export("GodWealth_jackPot", GodWealth_jackPot = (_dec = ccclass('GodWealth_jackPot'), _dec(_class = class GodWealth_jackPot extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
          ...
          if (key === "jackPotUserArr") {
            if (value.cur) {
              ...
              value.cur.forEach((item, index) => {
                var userItem = instantiate(this.propertyNode.props_item);
...
//# sourceMappingURL=1f382a9ad55df00142543a79106becedc1bb9f3f.js.map