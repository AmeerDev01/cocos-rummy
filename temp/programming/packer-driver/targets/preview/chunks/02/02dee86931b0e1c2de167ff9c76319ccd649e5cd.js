    ...
    execute: function () {
      ...
      _export("BandarQiuQiu_maxHistory", BandarQiuQiu_maxHistory = (_dec = ccclass('BandarQiuQiu_maxHistory'), _dec(_class = class BandarQiuQiu_maxHistory extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        createHistory(maxHistory) {
          this.line = [];
          var startPosition = new Vec3(0, 10);
          ...
          maxHistory.reverse().forEach((item, i) => {
            ...
            var historyContent = instantiate(this.propertyNode.props_history_content);
            var blue = 4;
            var red = 4;
            var green = 4; // 4代表输 1为蓝方赢  2为红方赢  3为绿方赢
            ...
            if (i != maxHistory.length - 1) {
              var nextPosition = this.compareCoordinates(startPosition, nextP, i + 1);
...
//# sourceMappingURL=02dee86931b0e1c2de167ff9c76319ccd649e5cd.js.map