System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7cad7FTLEFPgogol9bvPTgB", "BlessedWealthy_footer", undefined);
      ...
      _export("BlessedWealthy_footer", BlessedWealthy_footer = (_dec = ccclass('BlessedWealthy_footer'), _dec(_class = class BlessedWealthy_footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        getBetListByLevel() {
          var level = +JSON.parse(sys.localStorage.getItem("dfdc")).lv;
        ...
        bindUI() {
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            if ((_crd && UseSetOption === void 0 ? (_reportPossibleCrUseOfUseSetOption({
              error: Error()
            }), UseSetOption) : UseSetOption).Instance().option.gameSet.dfdc && (_crd && UseSetOption === void 0 ? (_reportPossibleCrUseOfUseSetOption({
              error: Error()
            }), UseSetOption) : UseSetOption).Instance().option.gameSet.dfdc.betTarget) {
              var t = target.find(i => i.positionId === (_crd && UseSetOption === void 0 ? (_reportPossibleCrUseOfUseSetOption({
                error: Error()
              }), UseSetOption) : UseSetOption).Instance().option.gameSet.dfdc.betTarget.positionId);
              this.setState({
          ...
          this.useState((key, value) => {
            ...
            (_crd && UseSetOption === void 0 ? (_reportPossibleCrUseOfUseSetOption({
              error: Error()
            }), UseSetOption) : UseSetOption).Instance().setGameOption("dfdc", {
              betTarget: value.cur
            });
            this.setState({
...
//# sourceMappingURL=fafbdc1b56e6113bdc68c5375cc52880b4de9cdb.js.map