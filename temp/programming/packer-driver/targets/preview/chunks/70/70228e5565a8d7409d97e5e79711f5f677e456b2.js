      ...
      _export("default", BgMediator = class BgMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName, viewComponent) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              var comp = this.wrapView.getComponent("dragon_SlotBg");
            ...
            handler(notification) {
              ...
              if (fab.getIsChangeGameRunning() !== -1) {
                var length = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                  error: Error()
        ...
        listenerEvent() {
          var comp = this.wrapView.getComponent("dragon_SlotBg");
          var autoButtonWrap = this.wrapView.getComponent("dragon_SlotBg").autoLaunch;
          var props_toggle_fast = this.wrapView.getComponent("dragon_SlotBg").propsToggleFast;
...
//# sourceMappingURL=70228e5565a8d7409d97e5e79711f5f677e456b2.js.map