      ...
      _export("BandarQiuQiu_betArea", BandarQiuQiu_betArea = (_dec = ccclass('BandarQiuQiu_betArea'), _dec(_class = class BandarQiuQiu_betArea extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        playWinAnimation(winArea) {
          ...
          winArea.forEach((item, index) => {
            ...
            var uiOpacity = this.getNodeByBetType(item).getChildByName("sprite_animation_Win").getComponent(UIOpacity);
        ...
        flyWinChip(winBetData, index, isFly) {
          ...
          isFly = this.isShowGame;
          var odds = this.getNodeToBetRateType(this.props.winAreaRate[index]);
          var betArea = this.getNodeByBetType(winBetData.betType).getChildByName("Layout_bet");
        ...
        cancelBet(cancelBetData) {
          ...
          if (cancelBetData) {
            ...
            var betArea = this.getNodeByBetType(cancelBetData.betType).getChildByName("Layout_bet");
...
//# sourceMappingURL=70d7825b5933b2f47449e0ee7ff274bede6f51c3.js.map