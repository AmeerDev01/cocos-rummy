System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, global, lang, addToastAction, CommandDefine, ProxyDefine, BgMediatorConst, RollerMediatorConst, SocketRepository, config, getBgProxy, BaseProxy, SocketProxy, _crd, SubGameType, goldState, SKT_MAG_TYPE, dataMap, sktMsgListener;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CommandDefine = _unresolved_4.CommandDefine;
    }, function (_unresolved_5) {
      ProxyDefine = _unresolved_5.ProxyDefine;
    }, function (_unresolved_6) {
      BgMediatorConst = _unresolved_6.BgMediatorConst;
    }, function (_unresolved_7) {
      RollerMediatorConst = _unresolved_7.RollerMediatorConst;
    }, function (_unresolved_8) {
      SocketRepository = _unresolved_8.SocketRepository;
    }, function (_unresolved_9) {
      config = _unresolved_9.default;
    }, function (_unresolved_10) {
      getBgProxy = _unresolved_10.getBgProxy;
    }, function (_unresolved_11) {
      BaseProxy = _unresolved_11.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "faf85NBkAVEqIu/EtI9Ip4D", "SocketProxy", undefined);
      ...
      _export("SocketProxy", SocketProxy = class SocketProxy extends (_crd && BaseProxy === void 0 ? (_reportPossibleCrUseOfBaseProxy({
        ...
        getShiftAmount(direction) {
          ...
          if (this.repository.userSwitch < 6) {
            ...
            this.sendNotification((_crd && BgMediatorConst === void 0 ? (_reportPossibleCrUseOfBgMediatorConst({
              error: Error()
            }), BgMediatorConst) : BgMediatorConst).UPDATE_JACKPOT_TOTAL, {
              total: val * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
              }), config) : config).winning[3].minRate
            });
          }
        ...
        getTransferGameInfo() {
          return {
            ...
            getDockIcon: () => {
              ...
              var coord = [[0, []], [1, []], [2, []], [3, []], [4, []]];
              coord.forEach((item2, index2) => {
                var t = lines.filter(line => line[0] === index2).map(i => [i[1], i[2], i[3]]); // const t = lines.find((item3) => item3[0] === index2)
        ...
        setGameInfo() {
          var gameTypePre = this.getTransferGameInfo().gameType(); //更新数据[
        ...
        initGameData(data) {
          ...
          this.sendNotification((_crd && BgMediatorConst === void 0 ? (_reportPossibleCrUseOfBgMediatorConst({
            error: Error()
          }), BgMediatorConst) : BgMediatorConst).INITIALIZETHEPANEL);
          this.setGameInfo();
        }
...
//# sourceMappingURL=2dc78faf0d608663d58ae95e4708abf1aaf916ba.js.map