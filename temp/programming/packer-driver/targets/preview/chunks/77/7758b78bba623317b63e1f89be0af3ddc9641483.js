System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, BaseComponent, global, playBtnClick, _dec, _class, _crd, ccclass, property, Qiuqiu_RoomChoose;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7c694FrrxJKEIu5eKJJJbwN", "Qiuqiu_RoomChoose", undefined);
      ...
      _export("Qiuqiu_RoomChoose", Qiuqiu_RoomChoose = (_dec = ccclass('Qiuqiu_RoomChoose'), _dec(_class = class Qiuqiu_RoomChoose extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        initRoomUI(dataIndex) {
          var roomNode = this.propertyNode["props_btn_room_" + (dataIndex + 1)];
          var roomInfo = this.props.roomMap[dataIndex];
          ...
          roomNode.getChildByName("label_gold").getComponent(Label).string = roomInfo.afee.formatAmountWithCommas();
          var lower = roomInfo.lower;
          var lowerStr = lower >= 1000 ? lower.formatAmountWithLetter() : lower.formatAmountWithCommas();
          var upper = roomInfo.upper;
          var upperStr = lower >= 1000 ? upper.formatAmountWithLetter() : upper.formatAmountWithCommas();
          var range = upper > 0 ? lowerStr + "~" + upperStr : lowerStr + '+';
...
//# sourceMappingURL=7758b78bba623317b63e1f89be0af3ddc9641483.js.map