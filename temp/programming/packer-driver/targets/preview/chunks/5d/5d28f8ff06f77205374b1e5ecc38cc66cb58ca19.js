    ...
    execute: function () {
      ...
      GameBoardViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
              ...
              this.changeGameTypeTask = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                ...
                if (this.currentGameViewModel) {
                  if (lastGameType !== currGameType && lastGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
                    ...
                    var titleSkeleton = this.flyBgNode.getChildByName("caishenguochang").getComponent(sp.Skeleton);
        ...
        createRollerView(currGameType) {
          ...
          var greenBg = (_crd && gameBoardViewModel === void 0 ? (_reportPossibleCrUseOfgameBoardViewModel({
            error: Error()
          }), gameBoardViewModel) : gameBoardViewModel).comp.getPropertyNode().props_spr_main_greenBg;
          var mBlueBg = (_crd && gameBoardViewModel === void 0 ? (_reportPossibleCrUseOfgameBoardViewModel({
            error: Error()
          ...
          if (currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            ...
            var redBg = rollerPanelViewModel.comp.getPropertyNode().props_spr_phoenix_Redbg;
            var blueBg = rollerPanelViewModel.comp.getPropertyNode().props_spr_phoenix_Bluebg;
            var smallGameMBg = rollerPanelViewModel.comp.getPropertyNode().props_spr_smallGame_multipleBg;
            redBg.active = true;
            blueBg.active = false;
            ...
            greenBg.active = true;
            var _redBg = rollerPanelViewModel.comp.getPropertyNode().props_spr_phoenix_Redbg;
            var _blueBg = rollerPanelViewModel.comp.getPropertyNode().props_spr_phoenix_Bluebg;
            var _smallGameMBg = rollerPanelViewModel.comp.getPropertyNode().props_spr_smallGame_multipleBg;
            _redBg.active = false;
            _blueBg.active = true;
            _smallGameMBg.active = true;
            this.currentGameViewModel = rollerPanelViewModel;
          }
...
//# sourceMappingURL=5d28f8ff06f77205374b1e5ecc38cc66cb58ca19.js.map