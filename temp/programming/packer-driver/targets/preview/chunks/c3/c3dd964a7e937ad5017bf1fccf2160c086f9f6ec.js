System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, Label, Node, Sprite, BaseComponent, global, lang, TaskScheduler, StepNumber, starlight_Audio, SoundPathDefine, addToastAction, changeAutoLauncherType, setAutoLaunchedTimes, AutoLauncherType, _dec, _class, _crd, ccclass, property, Starlight_Header;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "60f007Rv/BErZ59DHvMSW2k", "Starlight_Header", undefined);

      __checkObsolete__(['_decorator', 'Animation', 'Button', 'Component', 'EventTouch', 'Label', 'Node', 'Sprite']);
      ...
      _export("Starlight_Header", Starlight_Header = (_dec = ccclass('Starlight_Header'), _dec(_class = class Starlight_Header extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
...
//# sourceMappingURL=c3dd964a7e937ad5017bf1fccf2160c086f9f6ec.js.map