  ...
  return {
    ...
    execute: function () {
      ...
      DragonV2MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        openRule() {
          var rulePanelViewMode = new (_crd && DragonV2RulePanelViewModel === void 0 ? (_reportPossibleCrUseOfDragonV2RulePanelViewModel({
            error: Error()
        ...
        showDialogWin(dialogInfo, done) {
          var dragonV2DialogWinViewModel = new (_crd && DragonV2DialogWinViewModel === void 0 ? (_reportPossibleCrUseOfDragonV2DialogWinViewModel({
            error: Error()
...
//# sourceMappingURL=7651f01d300b2c86fcadc85bf4c63b16a890bc4a.js.map