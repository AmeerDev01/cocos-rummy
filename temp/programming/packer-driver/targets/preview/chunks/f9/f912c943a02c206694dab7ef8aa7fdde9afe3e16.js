System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Vec3, BaseComponent, config, GameType, getColumnLockIconArr, IconId, cacheData, _dec, _class, _crd, ccclass, property, GodWealthV2_SingleIconRoller;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f6e9cuBGYlIta3heQwPlWJK", "GodWealthV2_SingleIconRoller", undefined);
      ...
      _export("GodWealthV2_SingleIconRoller", GodWealthV2_SingleIconRoller = (_dec = ccclass('GodWealthV2_SingleIconRoller'), _dec(_class = class GodWealthV2_SingleIconRoller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        stopRoll(stopIconIndex, rollOverCallback) {
          ...
          this.addLastJoinIconIndex(this.stopIconIndex, 3); // console.log(`stopRoll--- columnIndex:${this.columnIndex},slotIndex:${this.slotIndex},stopIconIndex:${this.stopIconIndex}, lastIndex:${this.lastIndex}`)
        }
...
//# sourceMappingURL=f912c943a02c206694dab7ef8aa7fdde9afe3e16.js.map