System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, RollerMediatorConst, RollerType, BaseCommand, SubGameType, SKT_MAG_TYPE, sktMsgListener, BgMediatorConst, getSlotProxy, getSocketProxy, RollerCommand, _crd, RollerCommandConst;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      getSlotProxy = _unresolved_7.getSlotProxy;
      getSocketProxy = _unresolved_7.getSocketProxy;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "b2f174MupRB4J+M50KdCj6M", "RollerCommand", undefined);
          ...
          this.listExecute = [{
            ...
            handler(notification) {
              ...
              (_crd && getSlotProxy === void 0 ? (_reportPossibleCrUseOfgetSlotProxy({
                error: Error()
              }), getSlotProxy) : getSlotProxy)().initRoller();
              ...
              (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
                ...
                var rollerType = _gameRunner === (_crd && SubGameType === void 0 ? (_reportPossibleCrUseOfSubGameType({
                  error: Error()
                ...
                var stopIndexArr = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                  error: Error()
                }), getSocketProxy) : getSocketProxy)().getTransferGameInfo().stopIndexArr();
                var dockIocn = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                  error: Error()
                }), getSocketProxy) : getSocketProxy)().getTransferGameInfo().getDockIcon(); // console.log(stopIndexArr)
...
//# sourceMappingURL=be4284ffb6e00a5709955f472717503b463b1f37.js.map