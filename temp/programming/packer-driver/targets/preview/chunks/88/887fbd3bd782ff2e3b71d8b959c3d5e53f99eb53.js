    ...
    execute: function () {
      ...
      _export("SocketProxy", SocketProxy = class SocketProxy extends (_crd && BaseProxy === void 0 ? (_reportPossibleCrUseOfBaseProxy({
        ...
        setGameInfo(init) {
          ...
          var gameType = this.getTransferGameInfo().gameType();
          var gameTypePre = init ? gameType : (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().getNextGame();
          var gameTypeNew = gameType;
...
//# sourceMappingURL=887fbd3bd782ff2e3b71d8b959c3d5e53f99eb53.js.map