      ...
      _export("default", BgMediator = class BgMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName, viewComponent) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              var comp = this.wrapView.getComponent("phoenix_SlotBg");
            ...
            handler(notification) {
              ...
              if (OtherGameAttributesVo.yuanBaoSpecialEffect) {
                ...
                this.viewComponent.addChild(dialog);
                var totalBetComponent = dialog.getComponent(_crd && phoenix_totalBet === void 0 ? (_reportPossibleCrUseOfphoenix_totalBet({
                  error: Error()
            ...
            handler(notification) {
              ...
              var sgChooseComponent = dialog.getComponent(_crd && phoenix_sgChoose === void 0 ? (_reportPossibleCrUseOfphoenix_sgChoose({
                error: Error()
              ...
              sgChooseComponent.node.children.filter(item => item.name.startsWith("props_")).forEach((item, index) => {
                item.once(Node.EventType.TOUCH_END, e => {
                  ...
                  var skeleton_in = e.target.getChildByName('skeleton_in');
                  skeleton_in.active = true;
                  (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
                    error: Error()
                  }), getBgProxy) : getBgProxy)().setFreeGamePositionId(index + 1); // 设置按钮次数

                  var smallGame = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                    error: Error()
            ...
            handler(notification) {
              ...
              var currentScore = clear ? 0 : (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                error: Error()
              ...
              var isChange = this.wrapView.getComponent("phoenix_SlotBg").updateScore(currentScore);
            ...
            handler(notification) {
              ...
              var resultSmall = this.getSource((_crd && PrefabDefine === void 0 ? (_reportPossibleCrUseOfPrefabDefine({
                error: Error()
              }), PrefabDefine) : PrefabDefine).RESULT_SMALL);
        ...
        listenerEvent() {
          var comp = this.wrapView.getComponent("phoenix_SlotBg");
          var autoButtonWrap = this.wrapView.getComponent("phoenix_SlotBg").autoLaunch;
          var props_toggle_fast = this.wrapView.getComponent("phoenix_SlotBg").propsToggleFast;
...
//# sourceMappingURL=c1c1ec65c656f41ad1575df5aa259efbb04dbf50.js.map