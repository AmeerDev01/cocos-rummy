  ...
  return {
    ...
    execute: function () {
      ...
      _export("FishNetManager", FishNetManager = class FishNetManager {
        ...
        play(info) {
          var fnObj = this.objectPool.getObject((_crd && ObjectClassType === void 0 ? (_reportPossibleCrUseOfObjectClassType({
            error: Error()
...
//# sourceMappingURL=11034920543067ea6935c8bc3305f83be6b3b5fd.js.map