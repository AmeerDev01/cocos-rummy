      ...
      _export("BlessedWealthy_dialogWin", BlessedWealthy_dialogWin = (_dec = ccclass('BlessedWealthy_dialogWin'), _dec(_class = class BlessedWealthy_dialogWin extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          if (key === "winning") {
            ...
            if (value.cur) {
              var titleSkeleton = this.propertyNode.props_sk_yowin.getComponent(sp.Skeleton); // titleSkeleton.skeletonData = sourceManageSeletor().getFile(this.props.winning.fileName[0]).source
...
//# sourceMappingURL=1110a4a007e47ff0497820acf18b7fe664924532.js.map