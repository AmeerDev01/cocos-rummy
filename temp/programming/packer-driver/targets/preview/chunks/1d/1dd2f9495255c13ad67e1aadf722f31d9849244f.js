      ...
      _export("Hall_ResetPassword", Hall_ResetPassword = (_dec = ccclass('Hall_ResetPassword'), _dec(_class = class Hall_ResetPassword extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_btn_send.on(Node.EventType.TOUCH_END, () => {
            var phoneNumber = this.propertyNode.props_intput_phone_phoneNum.getComponent(EditBox).string;
          ...
          this.propertyNode.props_btn_login.on(Node.EventType.TOUCH_END, () => {
            var phone = this.propertyNode.props_intput_phone_phoneNum.getComponent(EditBox).string;
            var verificationCode = this.propertyNode.props_intput_phone_captcha.getComponent(EditBox).string;
            var password = this.propertyNode.props_intput_phone_password.getComponent(EditBox).string;
...
//# sourceMappingURL=1dd2f9495255c13ad67e1aadf722f31d9849244f.js.map