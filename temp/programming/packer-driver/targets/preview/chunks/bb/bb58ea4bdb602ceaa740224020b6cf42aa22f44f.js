        ...
        useProps(key, value) {
          ...
          if (key === "iconEffectItemData") {
            ...
            for (var _i = 0, _l = this.displayIconList.length; _i < _l; _i++) {
              ...
              if (this.props.iconEffectItemData.iconEffectArr.indexOf(_index) !== -1) {
                _item.setProps({
                  iconEffect: this.props.iconEffectData.iconEffect
                });
              } else {
          ...
          if (key === "iconYuanBaoEffectData") {
            ...
            for (var _i2 = 0, _l2 = this.displayIconList.length; _i2 < _l2; _i2++) {
              ...
              if (this.props.iconYuanBaoEffectData.iconEffectArr.indexOf(_index2) !== -1) {
                _item2.setProps({
          ...
          if (key === "iconFreeGameEffectData") {
            ...
            for (var _i3 = 0, _l3 = this.displayIconList.length; _i3 < _l3; _i3++) {
              /**index是图标从下往上的序列号 */
              var _index3 = _i3;
              var _item3 = this.displayIconList[_index3];

              if (this.props.iconFreeGameEffectData.iconEffectArr.indexOf(_index3) !== -1) {
                _item3.setProps({
...
//# sourceMappingURL=bb58ea4bdb602ceaa740224020b6cf42aa22f44f.js.map