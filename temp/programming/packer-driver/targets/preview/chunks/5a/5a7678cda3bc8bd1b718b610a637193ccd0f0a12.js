      ...
      _export("Hall_MailBox", Hall_MailBox = (_dec = ccclass('Hall_MailBox'), _dec(_class = class Hall_MailBox extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          ...
          if (key === "mailList") {
            this.props.mailList.forEach(item => {
              var itemNode = instantiate(this.propertyNode.props_Toggle_mail_item);
        ...
        bindUI() {
          ...
          this.useState((key, value) => {
            ...
            var mailItem = this.props.mailList[value.cur];
            if (!mailItem) return;
            ...
            var newflag = this.propertyNode.props_ToggleGroup_mail_left.children[value.cur].getChildByName("spr_mail_new");
...
//# sourceMappingURL=5a7678cda3bc8bd1b718b610a637193ccd0f0a12.js.map