    ...
    execute: function () {
      ...
      _export("Common_LoaderPanel", Common_LoaderPanel = (_dec = ccclass('Common_LoaderPanel'), _dec(_class = class Common_LoaderPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        startLoad(bundleList, fileMap) {
          var totalCount = fileMap.filter(i => i.isPreLoad).length;
          var hasDoneCount = 0; // const sourceManageList: Array<SourceManage> = []
          // this.propertyNode.props_error_log.string = "开始加载"

          var self = this;
          bundleList.forEach(bundle => {
            var sourceManage = new (_crd && SourceManage === void 0 ? (_reportPossibleCrUseOfSourceManage({
              error: Error()
...
//# sourceMappingURL=28ef4b8912fcbb674258f14da12e34590a378eb9.js.map