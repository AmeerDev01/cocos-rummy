  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = class BulletManager {
         ...
         */
        init(bondSize, bulConfig, objectPool, sourceManage, batteryManager, scaleRatio) {
        ...
        update(dt) {
          for (var k = 0; k < this.aliveBulletObjectList.length; k++) {
            var v = this.aliveBulletObjectList[k];
            if (v == null) continue;
            v.update(dt);
        ...
        removeBulletObject(objID) {
          var obj = this.aliveBulletObjectList[objID];
...
//# sourceMappingURL=3305bc216a97021c9a4416f8d39c07b0e31ca175.js.map