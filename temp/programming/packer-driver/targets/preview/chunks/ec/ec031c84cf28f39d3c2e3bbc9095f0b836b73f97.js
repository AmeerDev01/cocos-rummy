  ...
  return {
    ...
    execute: function () {
      ...
      _export("Thor_RollerPanel", Thor_RollerPanel = (_dec = ccclass('Thor_RollerPanel'), _dec(_class = class Thor_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          ...
          if (key === "minigameCount") {
            if (value.cur > 2) {
              ...
              var props_label_num = this.propertyNode.props_add_freebox.getChildByName('props_label_add_num');
        ...
        setokkk(done) {
          //万能图标
          var count = 0; // thor_Audio.playOneShot(SoundPathDefine.SCATTER_SHOW)
...
//# sourceMappingURL=ec031c84cf28f39d3c2e3bbc9095f0b836b73f97.js.map