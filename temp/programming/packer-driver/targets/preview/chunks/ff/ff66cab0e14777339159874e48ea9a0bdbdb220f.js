      ...
      _export("default", BgMediator = class BgMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName, viewComponent) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              var comp = this.wrapView.getComponent("GodWealth_SlotBg");
        ...
        listenerEvent() {
          var comp = this.wrapView.getComponent("GodWealth_SlotBg");
          var autoButtonWrap = this.wrapView.getComponent("GodWealth_SlotBg").autoLaunch;
          var props_toggle_fast = this.wrapView.getComponent("GodWealth_SlotBg").propsToggleFast;
...
//# sourceMappingURL=ff66cab0e14777339159874e48ea9a0bdbdb220f.js.map