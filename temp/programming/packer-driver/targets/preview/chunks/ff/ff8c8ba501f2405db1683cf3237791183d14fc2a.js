      ...
      _export("GodWealth_rollerPanel", GodWealth_rollerPanel = (_dec = ccclass('GodWealth_rollerPanel'), _dec(_class = class GodWealth_rollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          ...
          if (key === "jackpotAmount") {
            var baseBetAmountTarget = (_crd && footerViewModel === void 0 ? (_reportPossibleCrUseOffooterViewModel({
              error: Error()
        ...
        showBaoHeAmount() {
          this.rollerViewModelMap.forEach((roller, index) => {
            ...
            var iconEffectArr = this.props.iconBaoHeEffectData.coord.filter(i => i[0] === index).map(i => i[1]);
...
//# sourceMappingURL=ff8c8ba501f2405db1683cf3237791183d14fc2a.js.map