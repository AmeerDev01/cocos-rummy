      ...
      LoginPageViewModel = class LoginPageViewModel extends (_crd && ViewModel === void 0 ? (_reportPossibleCrUseOfViewModel({
        ...
        begin() {
          ...
          return _asyncToGenerator(function* () {
            var isFastLogin = yield _this.checkFastLogin();
            ...
            if (!isFastLogin) {
              ...
              _this.setEvent({
                onOpenLoginDialog: () => {
                  if (_this.loginDialogViewModel) return;
                  _this.loginDialogViewModel = new (_crd && LoginDialogViewModel === void 0 ? (_reportPossibleCrUseOfLoginDialogViewModel({
                    error: Error()
                    ...
                    error: Error()
                  }), PrefabPathDefine) : PrefabPathDefine).LOGIN_DIALOG).source).appendTo(_this.viewNode, {
                    ...
                    closeHandler: () => {
                      _this.loginDialogViewModel.unMount((_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                        error: Error()
                      }), EffectType) : EffectType).EFFECT2).then(() => {
                        _this.loginDialogViewModel = null;
                      });
                    },
                    loginDoneHandler: () => {
                ...
                openService: () => {
                  var serviceVm = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                    ...
                    error: Error()
                  }), PrefabPathDefine) : PrefabPathDefine).HELL_SERVICE_WEBVIEW).source).appendTo(_this.viewNode, {
                    effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                      error: Error()
                    }), EffectType) : EffectType).EFFECT1,
                    isModal: true
                ...
                openActivity: () => {
                  var activityViewModel = new (_crd && ActivityViewModel === void 0 ? (_reportPossibleCrUseOfActivityViewModel({
                    ...
                    error: Error()
                  }), PrefabPathDefine) : PrefabPathDefine).HELL_ACTIVITY).source).appendTo(_this.viewNode, {
                    effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                      error: Error()
                    }), EffectType) : EffectType).EFFECT1,
                    isModal: true
...
//# sourceMappingURL=ac30081e46f327fd1a9d902fd150d28222ce6db7.js.map