    ...
    execute: function () {
      ...
      _export("BandarQiuQiu_cards", BandarQiuQiu_cards = (_dec = ccclass('BandarQiuQiu_cards'), _dec(_class = class BandarQiuQiu_cards extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        playAnimation() {
          ...
          var backCard = instantiate(this.propertyNode.props_node_card_back);
          this.propertyNode.props_node_card_back.active = false;
          ...
          this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
            ...
            if (this.props.cardType.greenType > 0) {
              var ani = this.getGreenCardTypeSkeleton(this.props.cardType.greenType);
            ...
            if (this.props.cardType.blueType > 0) {
              var _ani = this.getBlueRedCardTypeSkeleton(this.props.cardType.blueType);

              this.propertyNode.props_skeleton_blue_cardType.active = true;
              new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
                error: Error()
              }), SkeletonAnimationPlayer) : SkeletonAnimationPlayer)(this.propertyNode.props_skeleton_blue_cardType.getComponent(sp.Skeleton), _ani, false).playAnimation();
            }

            if (this.props.cardType.redType > 0) {
              var _ani2 = this.getBlueRedCardTypeSkeleton(this.props.cardType.redType);

              this.propertyNode.props_skeleton_red_cardType.active = true;
              new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
                error: Error()
              }), SkeletonAnimationPlayer) : SkeletonAnimationPlayer)(this.propertyNode.props_skeleton_red_cardType.getComponent(sp.Skeleton), _ani2, false).playAnimation();
            }
        ...
        changeCardUpDown(blueCard, redCard) {
          ...
          blueCard.forEach((b, i) => {
            var itemCard = this.getCard(b);
            var num = i + 1;
            var card = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
...
//# sourceMappingURL=81a3d54dfdd3a04a73771e0d7bc94ae04163d2e3.js.map