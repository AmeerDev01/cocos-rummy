System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1"], function (_export, _context) {
  ...
  function createBundle(id, data, options, onComplete) {
    var bundle = assetManager.bundles.get(data.name);
    ...
    execute: function () {
      ...
      _export("default", {
        ...
        getRemoteBundle: (subGameInfo, progressFn) => {
          ...
          // })
          return new Promise((reslove, reject) => {
            var gemeConfig = (_crd && subGameList === void 0 ? (_reportPossibleCrUseOfsubGameList({
              error: Error()
            ...
            var url = gemeConfig.enableRemote ? (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
...
//# sourceMappingURL=0de5b6e0058107a6a3d8a953911d01e4c1c0cc58.js.map