System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, sp, tween, UIOpacity, Vec3, BaseComponent, config, bindClickEvent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, BoxState, Egypt_AwardBox;
  ...
  function _reportPossibleCrUseOfbindClickEvent(extras) {
    _reporterNs.report("bindClickEvent", "../utils", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f2f1dMH489OW6suizPqwu2h", "Egypt_AwardBox", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Label', 'Node', 'sp', 'tween', 'UIOpacity', 'Vec3']);
      ...
      _export("Egypt_AwardBox", Egypt_AwardBox = (_dec = ccclass('Egypt_AwardBox'), _dec2 = property(Node), _dec3 = property(sp.SkeletonData), _dec4 = property(sp.SkeletonData), _dec5 = property(sp.SkeletonData), _dec6 = property(sp.SkeletonData), _dec7 = property(sp.SkeletonData), _dec8 = property(sp.SkeletonData), _dec9 = property(sp.SkeletonData), _dec(_class = (_class2 = class Egypt_AwardBox extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        showScore(amount) {
          ...
          var ui = score.getComponent(UIOpacity);
          score.active = true;
        ...
        setEffect(effectId, amount, cb) {
          ...
          var skeletonRoot = this.node.getComponent(sp.Skeleton);
          skeletonRoot.animation = 'diankaibaoxiang'; // skeletonRoot.loop = false //这个居然没有作用，MMP

          var awardBoxItem = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).awardBoxItem.find(item => item.id === effectId);
          window.setTimeout(() => {
            // 打开贝壳等一秒钟
            this.subIcon.active = true;
            var skeleton = this.subIcon.getComponent(sp.Skeleton);
...
//# sourceMappingURL=4e08382eb329fed95ab64f34f8807ab0ed65086e.js.map