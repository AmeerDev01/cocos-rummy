  ...
  return {
    ...
    execute: function () {
      ...
      TitleViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        openMenu() {
          var titleNode = this.comp.getPropertyNode().props_mask_titrle;
          var titleAnimation = titleNode.getComponent(Animation);
...
//# sourceMappingURL=4eaf0e4b733a081c3786867dfcc633da29e8a6ca.js.map