System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, sp, tween, UIOpacity, Vec3, GodWealth_BaseComponent, config, bindClickEvent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, BoxState, GodWealth_AwardBox;
  ...
  function _reportPossibleCrUseOfbindClickEvent(extras) {
    _reporterNs.report("bindClickEvent", "../GodWealth_utils", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "fe840OPjvJPhJaTIRNvCpeh", "GodWealth_AwardBox", undefined);
      ...
      _export("GodWealth_AwardBox", GodWealth_AwardBox = (_dec = ccclass('AwardBox'), _dec2 = property(Node), _dec3 = property(sp.SkeletonData), _dec4 = property(sp.SkeletonData), _dec5 = property(sp.SkeletonData), _dec6 = property(sp.SkeletonData), _dec7 = property(sp.SkeletonData), _dec8 = property(sp.SkeletonData), _dec9 = property(sp.SkeletonData), _dec(_class = (_class2 = class GodWealth_AwardBox extends (_crd && GodWealth_BaseComponent === void 0 ? (_reportPossibleCrUseOfGodWealth_BaseComponent({
        error: Error()
...
//# sourceMappingURL=f0543e37eeeaf7b1a1d68e2f010a9bc7c6184f3e.js.map