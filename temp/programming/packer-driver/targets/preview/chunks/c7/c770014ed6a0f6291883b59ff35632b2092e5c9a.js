    ...
    execute: function () {
      ...
      _export("gxfc_RollerPanel", gxfc_RollerPanel = (_dec = ccclass('gxfc_RollerPanel'), _dec2 = property(Prefab), _dec(_class = (_class2 = class gxfc_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindUI() {
          ...
          var ui = this.node.parent.addComponent(UIOpacity); // const ui = this.node.parent.getComponent(UIOpacity)
        ...
        stopRoll(i, callBack) {
          ...
          var rollerComp = this.rollerList[i].getComponent("gxfc_Roller");
...
//# sourceMappingURL=c770014ed6a0f6291883b59ff35632b2092e5c9a.js.map