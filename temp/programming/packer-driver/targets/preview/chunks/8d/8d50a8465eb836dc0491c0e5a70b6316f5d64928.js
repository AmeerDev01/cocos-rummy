System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, sp, BaseComponent, Task, TaskSchedulerDefault, StepNumber, SkeletonAnimationPlayer, _dec, _class, _crd, ccclass, property, Thor_BigPrize;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1279a1bDXVEwreksG9P50IS", "Thor_BigPrize", undefined);
      ...
      _export("Thor_BigPrize", Thor_BigPrize = (_dec = ccclass('Thor_BigPrize'), _dec(_class = class Thor_BigPrize extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          if (key === "winning") {
            ...
            if (value.cur) {
              ...
              titleSkeleton.setSkin(value.cur.defaultSkin); // titleSkeleton.timeScale = 1

              var nanzhuAnimation = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
                error: Error()
              }), SkeletonAnimationPlayer) : SkeletonAnimationPlayer)(titleSkeleton, 'start', false, () => {
                // 动画开始
                // 显示数字
                ...
                nanzhuAnimation.changeAnimation('keep', false, () => {
                  nanzhuAnimation.changeAnimation('end', false, () => {
                    this.events.killSelfHandler();
                  });
                });
              });
...
//# sourceMappingURL=8d50a8465eb836dc0491c0e5a70b6316f5d64928.js.map