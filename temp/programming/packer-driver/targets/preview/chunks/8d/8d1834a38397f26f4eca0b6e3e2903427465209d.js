      ...
      _export("Hall_ShopPanel", Hall_ShopPanel = (_dec = ccclass('Hall_ShopPanel'), _dec(_class = class Hall_ShopPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          if (key === "dataList") {
            ...
            value.cur.forEach((item, index) => {
              var toggleItem = instantiate(this.propertyNode.props_Toggle_template2);
        ...
        bindUI() {
          ...
          this.useState((key, value) => {
            ...
            var dataItem = this.props.dataList[value.cur];
            this.setState({
            ...
            if (dataItem) {
              ...
              var itemTemplate = this.propertyNode.props_ToggleGroup_gold.children[0];
              dataItem.preinstallList.forEach(amount => {
                var node = instantiate(itemTemplate);
          ...
          this.propertyNode.props_sbtn_shop_pergi.on(Node.EventType.TOUCH_END, () => {
            var amount = +this.propertyNode.props_input_gold_num.getComponent(EditBox).string;
          ...
          this.useState((key, varue) => {
            ...
            this.state.giftList.filter(i => i.mallPage === 1).forEach((item, index) => {
              var node = instantiate(this.propertyNode.props_spr_tas_template);
              ...
              node.getChildByName("btn_buy").on(Node.EventType.TOUCH_END, () => {
                //购买
                var chooseBankVM = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                  error: Error()
        ...
        channelAmountToggleCallback(event, customEventData) {
          ...
          var chooseAmount = +event.target['getChildByName']("amount_show").getComponent(Label).string; // console.log(chooseAmount)
...
//# sourceMappingURL=8d1834a38397f26f4eca0b6e3e2903427465209d.js.map