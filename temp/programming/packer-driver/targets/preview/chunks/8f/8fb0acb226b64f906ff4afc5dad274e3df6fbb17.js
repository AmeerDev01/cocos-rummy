System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, tween, Vec3, BaseComponent, TaskScheduler, Task, footerViewModel, config, _dec, _class, _crd, ccclass, property, Fruit777_JackPot;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "575b4pz/qdEUZFpOU3NmC0M", "Fruit777_JackPot", undefined);
      ...
      _export("Fruit777_JackPot", Fruit777_JackPot = (_dec = ccclass('Fruit777_JackPot'), _dec(_class = class Fruit777_JackPot extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        bindUI() {
          var value = (_crd && footerViewModel === void 0 ? (_reportPossibleCrUseOffooterViewModel({
            error: Error()
          }), footerViewModel) : footerViewModel).comp.getPositionData().value;
          this.propertyNode.props_level_body.children[0].getComponent(Label).string = "+" + (value * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).treasureBoxAddition.multiple1).formatAmountWithCommas();
          this.propertyNode.props_level_body.children[1].getComponent(Label).string = "+" + (value * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).treasureBoxAddition.multiple2).formatAmountWithCommas(); // this.propertyNode.props_level_body.children[2].getComponent(Label).string = "3 Rotasi gratis + " + this.getGratisAmount(value * config.treasureBoxAddition.multiple3)//(value * config.treasureBoxAddition.multiple3 / 1000).toFixed(1) + "K"
          ...
          this.propertyNode.props_level_body.children[2].getComponent(Label).string = "3 Rotasi gratis + " + (value * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).treasureBoxAddition.multiple3).formatAmountWithLetter();
          this.propertyNode.props_level_body.children[3].getComponent(Label).string = "6 Rotasi gratis + " + (value * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).treasureBoxAddition.multiple4).formatAmountWithLetter();
        }
...
//# sourceMappingURL=8fb0acb226b64f906ff4afc5dad274e3df6fbb17.js.map