System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "8b409fLG25F7Kdx7etLEQ82", "dataTransfer", undefined);
      ...
      _export("DataKeyType", DataKeyType = /*#__PURE__*/function (DataKeyType) {
        ...
        DataKeyType["COINS_AFTER_BETTING"] = "COINS_AFTER_BETTING";
        DataKeyType["ICON_EFFECT_DATA"] = "ICON_EFFECT_DATA";
        DataKeyType["FIXED_CHESSBOARD_ICON"] = "FIXED_CHESSBOARD_ICON";
        ...
        DataKeyType["SUBGAME_ALL_TIMES"] = "SUBGAME_ALL_TIMES";
        ...
        DataKeyType["TU_BIAO_ID"] = "TU_BIAO_ID";
        return DataKeyType;
      }({}));
      ...
      _export("default", dataKey => {
        ...
        var si = (useMock ? mockData : dataCache).dl.si[0]; // console.log(dataKey, si)
        ...
        switch (dataKey) {
          ...
          case DataKeyType.SUBGAME_ALL_TIMES:
            return si.totalFreeGameCount;
          ...
          case DataKeyType.FIXED_CHESSBOARD_ICON:
...
//# sourceMappingURL=8f16cb205cfffebed41f65c4d38593d0907fc51b.js.map