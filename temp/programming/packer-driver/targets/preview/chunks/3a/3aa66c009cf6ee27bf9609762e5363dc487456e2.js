System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "86141ZAIOJNd4o3b20qbP5s", "BgRepository", undefined);
      ...
      _export("BgRepository", BgRepository = class BgRepository extends (_crd && BaseRepository === void 0 ? (_reportPossibleCrUseOfBaseRepository({
        ...
        constructor() {
          ...
          /**小游戏剩余次数 */
          this.numberOfTimesRemaining = 0;

          /**小游戏总次数 */
          this.totalNumberOfTimes = 0;

          /**当前游戏 */
          this.currentGame = (_crd && SubGameType === void 0 ? (_reportPossibleCrUseOfSubGameType({
            error: Error()
          }), SubGameType) : SubGameType).MAIN;
...
//# sourceMappingURL=3aa66c009cf6ee27bf9609762e5363dc487456e2.js.map