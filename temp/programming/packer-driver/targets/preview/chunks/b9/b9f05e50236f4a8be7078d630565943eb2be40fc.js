  ...
  return {
    ...
    execute: function () {
      ...
      _export("GodWealth_footer", GodWealth_footer = (_dec = ccclass('GodWealth_footer'), _dec(_class = class GodWealth_footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        getBetListByLevel() {
          var level = +JSON.parse(sys.localStorage.getItem("godWealth")).lv;
        ...
        bindUI() {
          ...
          this.useState((key, value) => {
            ...
            var grandNode = (_crd && rollerPanelViewModel === void 0 ? (_reportPossibleCrUseOfrollerPanelViewModel({
              error: Error()
            }), rollerPanelViewModel) : rollerPanelViewModel).comp.getGrandNode();
            var majorNode = (_crd && rollerPanelViewModel === void 0 ? (_reportPossibleCrUseOfrollerPanelViewModel({
              error: Error()
            }), rollerPanelViewModel) : rollerPanelViewModel).comp.getMajorNode();
            var miniNode = (_crd && rollerPanelViewModel === void 0 ? (_reportPossibleCrUseOfrollerPanelViewModel({
              error: Error()
            }), rollerPanelViewModel) : rollerPanelViewModel).comp.getMiniNode();
            var startNumberGrand = parseInt(grandNode.string.replace(/,/g, ""));
            var startNumberMajor = parseInt(majorNode.string.replace(/,/g, ""));
            var startNumberMini = parseInt(miniNode.string.replace(/,/g, ""));
            this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
              error: Error()
            }), Task) : Task)(done => {
              this.stepNumber && this.stepNumber.stop();
...
//# sourceMappingURL=b9f05e50236f4a8be7078d630565943eb2be40fc.js.map