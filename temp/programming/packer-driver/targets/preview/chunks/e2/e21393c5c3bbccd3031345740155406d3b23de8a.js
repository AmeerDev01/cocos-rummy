System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "afef9hbtTRHwoHJ4kEF68CE", "Thor_Roller", undefined);
      ...
      _export("Thor_Roller", Thor_Roller = (_dec = ccclass('Thor_Roller'), _dec(_class = class Thor_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          ...
          if (key === "iconEffectData") {
            var effectLength = this.props.iconEffectData.iconEffectArr.length;
            var effectCount = 0;
            ...
            var isReScroll = false; //console.log(this.props.iconEffectData);

            var _loop = function _loop() {
              // const index = this.props.rollerType.direction === DirectionType.DOWN ? i : (this.displayIconList.length - 1 - i)

              /**index是图标从下往上的序列号 */
              var item = _this.displayIconList[i]; // console.log('clear --------- ' , this.props.rollerType.index, JSON.stringify(item.comp.props.iconData), i,
              // 	JSON.stringify(this.props.iconEffectData.iconEffectArr), this.props.iconEffectData.iconEffectArr.indexOf(i));

              if (_this.props.iconEffectData.iconEffectArr.indexOf(i) !== -1) {
                isReScroll = true;
                item.setProps({
                  iconEffect: _this.props.iconEffectData.iconEffect
                });
        ...
        reScroll(state) {
          // 重新滚动
          var length = this.propertyNode.props_roller.children.length;
          ...
          if (length === 5) {
            ...
            this.propertyNode.props_roller.children.forEach((item, index) => {
              ...
              var yp = -this.getRollerHeight() + index * this.itemHeight + this.itemHeight / 2;
              ...
              .call(() => {
                ...
                (_crd && thor_Audio === void 0 ? (_reportPossibleCrUseOfthor_Audio({
                  ...
                  error: Error()
                }), SoundPathDefine) : SoundPathDefine).SINGLE_ICON_FALL, 1, false);
              }).start();
            });
          }
        }
        ...
        creator() {
          ...
          if (this.props.rollerType.direction === (_crd && DirectionType === void 0 ? (_reportPossibleCrUseOfDirectionType({
            ...
            var py = -this.getRollerHeight() + itemHeight / 2 + insideCount * itemHeight;
        ...
        joinIcon() {
          //滑槽中的图表数
          //下一个要加入的图标
          var iconData = this.props.rollerType.iconQueue[this.nextJoinIconIndex]; // console.log('下一关图标',this.nextJoinIconIndex,iconData.iconId,'队列',this.props.rollerType.index);

          if (iconData.iconId > 10) {
            var rateItem = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
              error: Error()
          ...
          var iconViewModel = new (_crd && RollerIconViewModel === void 0 ? (_reportPossibleCrUseOfRollerIconViewModel({
            error: Error()
        ...
        scrollElement() {
          var rollerHeight = this.getRollerHeight(true);
...
//# sourceMappingURL=e21393c5c3bbccd3031345740155406d3b23de8a.js.map