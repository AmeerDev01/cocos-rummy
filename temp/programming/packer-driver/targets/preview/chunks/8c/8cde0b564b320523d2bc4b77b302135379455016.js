        ...
        constructor(mediatorName, viewComponent) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              assetManager.loadBundle("gxfc", /*#__PURE__*/_asyncToGenerator(function* (err, _bundle) {
                // 首先贴入加载框面板
                try {
                ...
                _bundle.load(panel.path, Prefab, (progress, total) => {
                  ...
                  var loaderScript = node.getComponent("gxfc_Loader");
...
//# sourceMappingURL=8cde0b564b320523d2bc4b77b302135379455016.js.map