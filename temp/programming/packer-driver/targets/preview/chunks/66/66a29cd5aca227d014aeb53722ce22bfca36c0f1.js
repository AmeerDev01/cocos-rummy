System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Font, Label, GodWealth_BaseComponent, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GodWealth_DynamicNumber;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "557ed+LAiVLfrq8iNTQOKF8", "GodWealth_DynamicNumber", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Font', 'Label', 'Node']);
      ...
      _export("GodWealth_DynamicNumber", GodWealth_DynamicNumber = (_dec = ccclass('GodWealth_DynamicNumber'), _dec2 = property(Font), _dec3 = property(Font), _dec(_class = (_class2 = class GodWealth_DynamicNumber extends (_crd && GodWealth_BaseComponent === void 0 ? (_reportPossibleCrUseOfGodWealth_BaseComponent({
        error: Error()
        ...
        onLoad() {
          var slef = this;
          var labelObj = this.getComponent(Label);
          Object.defineProperty(labelObj, "string", {
            get: function get() {
              var label = slef.node.getChildByName("number").getComponent(Label); // return self.currNumber
        ...
        startEffect(targetNumber) {
          ...
          var label = this.node.getChildByName("number").getComponent(Label); // if (this.timer) {
          // 	// 如果有在进行的动作
          ...
          var unitNum = +((this.targetNumber - this.fromNumber) * 20 / this.time).toFixed(0);
          ...
          var dynamicNum = this.fromNumber;
...
//# sourceMappingURL=66a29cd5aca227d014aeb53722ce22bfca36c0f1.js.map