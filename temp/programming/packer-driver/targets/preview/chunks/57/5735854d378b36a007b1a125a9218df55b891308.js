        ...
        createCards() {
          ...
          this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
            ...
            (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              ...
              var card = instantiate(this.propertyNode.props_spr_sendCard);
            ...
            var backCard = (_crd && cardViewModel === void 0 ? (_reportPossibleCrUseOfcardViewModel({
              error: Error()
...
//# sourceMappingURL=5735854d378b36a007b1a125a9218df55b891308.js.map