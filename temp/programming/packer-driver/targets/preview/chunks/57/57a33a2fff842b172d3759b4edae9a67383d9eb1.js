System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ViewModel, StoreInject, _initSeat, getStore, _dec, _class, _crd, HeadPanelViewModel;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      _initSeat = _unresolved_3.initSeat;
    ...
    execute: function () {
      ...
      HeadPanelViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          this.setEvent({
            initSeat: seats => {
              this.dispatch((_crd && _initSeat === void 0 ? (_reportPossibleCrUseOfinitSeat({
                error: Error()
              }), _initSeat) : _initSeat)(seats));
            }
          });
        }
...
//# sourceMappingURL=57a33a2fff842b172d3759b4edae9a67383d9eb1.js.map