      ...
      _export("GodWealthV2_RollerPanel", GodWealthV2_RollerPanel = (_dec = ccclass('GodWealthV2_RollerPanel'), _dec(_class = class GodWealthV2_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initRoller() {
          for (var i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            var roller = new (_crd && GodWealthV2RollerViewModel === void 0 ? (_reportPossibleCrUseOfGodWealthV2RollerViewModel({
              error: Error()
        ...
        updateWinloss() {
          ...
          if (this.isMain()) {
            ...
            if (!this.isSubGame2()) {
              var winloss = this.props.winloss + roundTw;
              this.dispatch((_crd && updateWinloss === void 0 ? (_reportPossibleCrUseOfupdateWinloss({
                error: Error()
        ...
        playBeetleAnimation(done) {
          ...
          ParticleNodes.forEach((p, i) => {
            var startPos = this.node.getComponent(UITransform).convertToNodeSpaceAR(p.getWorldPosition());
...
//# sourceMappingURL=5efcd05e7bee315ee8a71f68862ba253ebb5f638.js.map