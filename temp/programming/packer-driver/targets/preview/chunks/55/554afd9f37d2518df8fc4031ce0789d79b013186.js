    ...
    execute: function () {
      ...
      _export("Domino_Card", Domino_Card = (_dec = ccclass('Domino_Card'), _dec(_class = class Domino_Card extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        dragMove(event) {
          ...
          var startPosition = event.getUIStartLocation();
          var uiLocation = event.getUILocation(); // console.log(`start x ${startPosition.x}, y ${startPosition.y}, move x ${uiLocation.x}, y ${uiLocation.y}`);
          ...
          if (this._isCanOutCard) {
            var position = this.root.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(uiLocation.x, uiLocation.y));
        ...
        bindEvent() {
          var outCardNode = (_crd && roomChooseViewModel === void 0 ? (_reportPossibleCrUseOfroomChooseViewModel({
            error: Error()
          ...
          this.node.on(Node.EventType.TOUCH_START, () => {
            ...
            var handle = () => {
              ...
              var cardComponent = this.nodeCopy.getComponent(Domino_Card);
        ...
        setChecked(isChecked) {
          var offset = isChecked ? this.initY + 20 : this.initY;
        ...
        show(isAnime, done) {
          ...
          if (this.props.type === 1) {
            ...
            if (isAnime) {
              var speed = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
...
//# sourceMappingURL=554afd9f37d2518df8fc4031ce0789d79b013186.js.map