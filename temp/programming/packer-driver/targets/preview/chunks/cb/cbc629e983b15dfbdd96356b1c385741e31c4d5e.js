  ...
  return {
    ...
    execute: function () {
      ...
      ActivityViewModel = class ActivityViewModel extends (_crd && ViewModel === void 0 ? (_reportPossibleCrUseOfViewModel({
        ...
        getUnreadStatus(activityList, actIds) {
          if (actIds === void 0) {
            actIds = undefined;
          }
          ...
          for (var _i = 0; _i < actIds.length; _i++) {
            _loop2(_i);
          }
        ...
        setReadStatus(activityList, value) {
          var actIds = this.getCacheActIds();
          ...
          localStorage.setItem("actIds", JSON.stringify(actIds));
          var status = this.getUnreadStatus(activityList, actIds);
          this.dispatch((_crd && updateActivityStatus === void 0 ? (_reportPossibleCrUseOfupdateActivityStatus({
            error: Error()
          }), updateActivityStatus) : updateActivityStatus)(status));
        }
        ...
        initTurntabledateStatus(activityList) {
          var turntableData = activityList.find(v => v.gameId === (_crd && ActivityType === void 0 ? (_reportPossibleCrUseOfActivityType({
            error: Error()
          }), ActivityType) : ActivityType).TURNPLATE);
        ...
        getCacheActIds() {
          var value = localStorage.getItem("actIds");
          var actIds = [];
...
//# sourceMappingURL=cbc629e983b15dfbdd96356b1c385741e31c4d5e.js.map