      ...
      GameBoardViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            var memberId = data.memberData.memberId;
            var index = this.getSeatIndex(memberId);
            var isMyBet = this.comp.props.myInfo.memberId === memberId; // console.log(data.goldData[data.memberData.type]);
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            //11
            var seats = this.comp.props.usersInfo.filter(v => v.memberId === data.receiveMemberId); // 如果展示座位上有两个相同人，就同时送两次
        ...
        updateAreaWinLoseRateInfo(data, second) {
          ...
          this.stopCountdown();
          var areaWinLose = [data.spadeWinLose, data.heartWinLose, data.sakuraWinLose, data.blockWinLose];
          ...
          var seconds = second - 5; // result1.push(data.data.spadeWin[data.data.spadeWin.length-1])
        ...
        getHeadPos(memberId, isFrom) {
          var seat = this.comp.props.usersInfo.find(v => v.memberId === memberId);
          var pos;
        ...
        */
        ...
        listenerUserJoinOrQuit() {
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            var result1 = data.blackResults ? data.blackResults : [];
            var result2 = data.redResults ? data.redResults : [];
            var result3 = data.plumResults ? data.plumResults : [];
            var result4 = data.diamondResults ? data.diamondResults : [];
            var black = this.betHistoryViewModel.comp.getPropertyNode().props_layout_icon_black;
            var red = this.betHistoryViewModel.comp.getPropertyNode().props_layout_icon_red;
            var plum = this.betHistoryViewModel.comp.getPropertyNode().props_layout_icon_plum;
            var diamond = this.betHistoryViewModel.comp.getPropertyNode().props_layout_icon_diamond;
        ...
        openHeGuan(nodeWrap) {
          var baseViewModel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
        ...
        openPot() {
          var baseViewModel = new (_crd && PotViewModel === void 0 ? (_reportPossibleCrUseOfPotViewModel({
            error: Error()
        ...
        openTrigJackpot() {
          var baseViewModel = new (_crd && TrigJackpotViewModel === void 0 ? (_reportPossibleCrUseOfTrigJackpotViewModel({
            error: Error()
        ...
        getSeatIndex(memberId) {
          ...
          var seat = [...this.comp.props.usersInfo].reverse().find(v => v.memberId === memberId);
...
//# sourceMappingURL=25442fb443d68f7f63ebad63b3a701296165e4a6.js.map