  ...
  return {
    ...
    execute: function () {
      ...
      _export("Qiuqiu_Sure", Qiuqiu_Sure = (_dec = ccclass('Qiuqiu_Sure'), _dec(_class = class Qiuqiu_Sure extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        getProgress(slider) {
          var value = slider.progress - this.min;
        ...
        useProps(key, value) {
          if (key === 'afee' || key === 'newBetAmount') {
            var cellAmount = this.props.newBetAmount === 0 ? this.props.afee : value.cur;
        ...
        showHideAnima(show) {
          ...
          var value = show !== undefined ? show : !this.node.active;
...
//# sourceMappingURL=172cc1065663953efe6ef6ff0d5328d1065a7a7c.js.map