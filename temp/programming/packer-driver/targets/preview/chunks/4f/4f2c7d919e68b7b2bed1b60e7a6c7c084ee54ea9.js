            ...
            if (key === 'betDropDownlist') {// this.showOrHideBetDropDownlist(value.cur)
              ...
              if (value.cur) {
                ...
                value.cur.forEach((item, index) => {
                  var userItem = instantiate(this.propertyNode.props_jackpot_item);
              ...
              var startNumberGrand = parseInt(this.propertyNode.props_grand_number.string.replace(/,/g, ""));
              var startNumberMajor = parseInt(this.propertyNode.props_major_number.string.replace(/,/g, ""));
              var startNumberMini = parseInt(this.propertyNode.props_mini_number.string.replace(/,/g, ""));
              var betValueId = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
              ...
              if (value.cur <= 5) {
                new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
                  ...
                  if (this.node && this.node.isValid) {
                    ...
                    this.propertyNode.props_grand_number.string = _value.formatAmountWithCommas();
                  }
              ...
              new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
                ...
                if (this.node && this.node.isValid) {
                  ...
                  this.propertyNode.props_major_number.string = _value2.formatAmountWithCommas();
                }
              }).set((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
              }), config) : config).normalRollOption.numberRollerTime).start();
              new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
                ...
                if (this.node && this.node.isValid) {
                  ...
                  this.propertyNode.props_mini_number.string = _value3.formatAmountWithCommas();
                }
              }).set((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
              }), config) : config).normalRollOption.numberRollerTime).start();
              ...
              if (this.props.positionId > 5) {
                new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
                  ...
                  if (this.node && this.node.isValid) {
                    var _value4 = Number(num.toFixed(0));

                    this.propertyNode.props_grand_number.string = _value4.formatAmountWithCommas();
                  }
                }).set((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                  error: Error()
                }), config) : config).normalRollOption.numberRollerTime).start();
...
//# sourceMappingURL=4f2c7d919e68b7b2bed1b60e7a6c7c084ee54ea9.js.map