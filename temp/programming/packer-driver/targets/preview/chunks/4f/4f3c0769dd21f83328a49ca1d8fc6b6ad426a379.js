System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Game, game, sys, ViewModel, StoreInject, SKT_MAG_TYPE, sktInstance, sktMsgListener, config, AutoLauncherType, GameType, RollerPanelViewModel, NORMAL_MAG_TYPE, msgListener, sourceManageSeletor, PrefabPathDefine, changeAutoLauncherType, changeCurrGameType, changeGame, changeGameFreeGametotalMultiplier, changeProfit, changeViewGame, resetStore, setAutoLaunchedTimes, setSubGameTimes, updateBalance, updateSubGameTimes, getStore, dataTransfer, DataKeyType, setData, Task, TaskSchedulerDefault, EffectType, setRollRoundEnd, global, lang, addToastAction, _dec, _class, _crd, GameBoardViewModel;
  ...
  function _reportPossibleCrUseOfStarlight_GameBoard(extras) {
    _reporterNs.report("Starlight_GameBoard", "../components/Starlight_GameBoard", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/Starlight_GameBoard", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/Starlight_GameBoard", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "34bcb0udFNGxpstOZr+jzXE", "GameBoardViewModel", undefined);

      __checkObsolete__(['Game', 'Node', 'game', 'instantiate', 'log', 'sys']);
        ...
        begin() {
          ...
          this.dispatch((_crd && resetStore === void 0 ? (_reportPossibleCrUseOfresetStore({
            ...
            if (data.gameType && data.gameType !== (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
              ...
              this.dispatch((_crd && setRollRoundEnd === void 0 ? (_reportPossibleCrUseOfsetRollRoundEnd({
                error: Error()
              }), setRollRoundEnd) : setRollRoundEnd)(false)); //非小游戏需要读取盈利状态
            ...
            sys.localStorage.setItem("starlight", JSON.stringify(data)); // this.dispatch(changeGame(GameType.MAIN))
          ...
          this.setEvent({
            changeGameHandler: (lastGameType, currGameType) => {
              ...
              }).subscribeDone('change', () => {// window.setTimeout(() => {
...
//# sourceMappingURL=4f3c0769dd21f83328a49ca1d8fc6b6ad426a379.js.map