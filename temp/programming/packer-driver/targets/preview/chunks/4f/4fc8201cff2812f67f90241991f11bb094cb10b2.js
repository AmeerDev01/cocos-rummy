System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function paddingNum(num) {
    ...
    var result = num.toString().split(""); //将数字转化为了数组，便于使用数组中的splice方法插入逗号

    var position = result.indexOf("."); //获取小数点的位置，根据有无小数点确定position最终值进入添加逗号环节
...
//# sourceMappingURL=4fc8201cff2812f67f90241991f11bb094cb10b2.js.map