System.register(["__unresolved_0", "cc", "__unresolved_1", "redux-act", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c1ff1b4tIhFrbxtjrNcGs1C", "roller", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_BEGIN_ROLL]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_INIT_ROLL]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_STOP_ROLL]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_END_ROLLING]: (state, payload) => {
          // const _state = instantiate(state)
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_FLICKER]: (state, payload) => {
          return _extends({}, state, {
            iconEffectData: {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_ROUNT_END]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_ROLL_SPEED]: (state, payload) => {
          var _state = instantiate(state);
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_BAOHE_FLICKER]: (state, payload) => {
          return _extends({}, state, {
            iconBaoHeEffectData: {
              iconEffect: payload.iconEffect,
              coord: payload.flickerCoord
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_FREEGAME_FLICKER]: (state, payload) => {
          return _extends({}, state, {
...
//# sourceMappingURL=68e20ea086694d8bcf3025b33e3267dd1a3c0231.js.map