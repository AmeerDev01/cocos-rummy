      ...
      PhoenixV2MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            if (data.gameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
              ...
              if (data.phoenixFreeGameLine && data.totalFreeGameCount > 0 && data.freeGameCount > 0) {
                //上一把已进入小游戏
                var i = data.phoenixFreeGameLine - 1;
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            var si = data.dl.si[0]; // if (si.nextGameType === GameType.SUBGAME2 || this.comp.props.gameTypeInfo.viewGameType === GameType.SUBGAME2) {
            //   //每局的锁定图标
        ...
        showDialogWin(dialogInfo, done) {
          var phoenixV2DialogWinViewModel = new (_crd && PhoenixV2DialogWinViewModel === void 0 ? (_reportPossibleCrUseOfPhoenixV2DialogWinViewModel({
            error: Error()
        ...
        openRule() {
          var rulePanelViewMode = new (_crd && PhoenixV2RulePanelViewModel === void 0 ? (_reportPossibleCrUseOfPhoenixV2RulePanelViewModel({
            error: Error()
...
//# sourceMappingURL=212d5b6341888a9185595ab0b5e9f9421c7e8290.js.map