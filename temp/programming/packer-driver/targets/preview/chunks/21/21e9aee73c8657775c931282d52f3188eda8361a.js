System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Label, Node, sp, Sprite, tween, UITransform, Vec3, BaseComponent, IconEffectType, sourceManageSeletor, winShowViewModel, SkeletonAnimationPlayer, _dec, _class, _crd, ccclass, property, Starlight_RollerIcon;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c8443nN4K1BSKBdirKko9+2", "Starlight_RollerIcon", undefined);
      ...
      _export("Starlight_RollerIcon", Starlight_RollerIcon = (_dec = ccclass('Starlight_RollerIcon'), _dec(_class = class Starlight_RollerIcon extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          if (key === "iconData") {
            if (this.props.iconData) {
              ...
              var iconNode; // if (this.props.iconData.LargeIcon) {
        ...
        palyScatter(isActive, callBack) {
          // Scatter闪动
          this.propertyNode.props_iconWrap.getChildByName("iconNode_skeleton").active = true;
          this.propertyNode.props_iconWrap.getChildByName("iconNode_sprite").active = false;
          this.propertyNode.props_iconWrap.getChildByName("iconNode_skeleton").getComponent(sp.Skeleton).setSkin(this.props.iconData.uiData.skin ? this.props.iconData.uiData.skin : 'default');
          var i = 0;
          var ani = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
            error: Error()
          }), SkeletonAnimationPlayer) : SkeletonAnimationPlayer)(this.propertyNode.props_iconWrap.getChildByName("iconNode_skeleton").getComponent(sp.Skeleton), this.props.iconData.uiData.animationArr[isActive ? 1 : 0], true, () => {
            i++;
        ...
        playallPurpose(callBack) {
          ...
          var ani = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
            ...
            // 获取起始和目标的世界坐标
            var startWorldPos = this.propertyNode.props_label_rate_num.worldPosition;
            ...
            var node = instantiate(this.propertyNode.props_label_rate_num); // 将节点添加到目标节点所在的父节点
...
//# sourceMappingURL=21e9aee73c8657775c931282d52f3188eda8361a.js.map