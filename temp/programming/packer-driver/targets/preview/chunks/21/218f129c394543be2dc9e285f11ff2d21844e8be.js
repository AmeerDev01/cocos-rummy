System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b4600pTvoxMv6AhaXpHHG5S", "SocketProxy", undefined);
      ...
      _export("SocketProxy", SocketProxy = class SocketProxy extends (_crd && BaseProxy === void 0 ? (_reportPossibleCrUseOfBaseProxy({
        ...
        onmessage(ev) {
          ...
          var heartbeat = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).gameCode + ":-" + SKT_MAG_TYPE.HEART_BEAT;
          var jackpot = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).gameCode + ":-" + SKT_MAG_TYPE.JACKPOT_TOTAL;
          ...
          if (evData.success) {
            ...
            sktMsgListener.dispath(typeCode, evData.data || undefined);
          } else {
        ...
        sendSktMessage(msgType, data) {
          if (msgType !== SKT_MAG_TYPE.HEART_BEAT && msgType !== SKT_MAG_TYPE.JACKPOT_TOTAL) {
            console.log("send: ", (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
            }), config) : config).gameCode, msgType, data);
          }
        ...
        calculateTheBalanceStatus() {
          var gold = this.repository.rollerLaunchResult.dl.si[0].balanceAfterSettlement;
        ...
        sendLaunch() {
          ...
          if (bl) {
            ...
            this.sendSktMessage(SKT_MAG_TYPE.LAUNCH, {
              ...
              "freeGamePositionId": (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
                error: Error()
        ...
        getTransferGameInfo() {
          return {
            ...
            targetList: () => {
              var _linesDir = this.repository.rollerLaunchResult.dl.si[0].winningPosition;
            ...
            /**获取需要停靠的图标 */
            getDockIcon: () => {
              var lineList; // const lines: number[][] = this.repository.rollerLaunchResult.dl.si[0].fixedChessboardIcon || []
            ...
            gameType: i => {
              ...
              if (i === 0) {
                // 当前游戏
                return this.repository.rollerLaunchResult.dl.si[0].indexGameType;
              }

              if (i === 1) {
                // 下一把游戏
                return this.repository.rollerLaunchResult.dl.si[0].nextGameType;
              }

              return this.repository.rollerLaunchResult.dl.si[0].indexGameType;
            },
            getIconStay: () => {// return this.repository.rollerLaunchResult.dl.si[0].iconStay
            },
        ...
        connectCallback() {
          sktMsgListener.add(SKT_MAG_TYPE.AUTH, 'proxy', data => {
            ...
            if (data.gameType === SubGameType.MAIN) {
              ...
              this.sendNotification((_crd && CommandDefine === void 0 ? (_reportPossibleCrUseOfCommandDefine({
                ...
                gameType: 1,
                freeGameCount: data.freeGameCount
              }, (_crd && RollerMediatorConst === void 0 ? (_reportPossibleCrUseOfRollerMediatorConst({
                error: Error()
              }), RollerMediatorConst) : RollerMediatorConst).INIT_ROLLER_PANEL);
          ...
          sktMsgListener.add(SKT_MAG_TYPE.LAUNCH, 'proxy', data => {
            ...
            (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
              error: Error()
            }), getBgProxy) : getBgProxy)().getCurrentGame() === SubGameType.MAIN && this.sendNotification((_crd && BgMediatorConst === void 0 ? (_reportPossibleCrUseOfBgMediatorConst({
              error: Error()
        ...
        setGameInfo() {
          var gameTypePre = this.getTransferGameInfo().gameType(0);
          var gameTypeNew = this.getTransferGameInfo().gameType(1);
          (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
        ...
        initGameData(data) {
          Object.assign(this.repository.rollerLaunchResult.dl.si[0], data); // 设置游戏次数

          (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().setGameCount(data.freeGameCount);
          (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().setGameTotalNumber(data.totalFreeGameCount);
          (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().setFreeGamePositionId(data.phoenixFreeGameLine);
          this.sendNotification((_crd && BgMediatorConst === void 0 ? (_reportPossibleCrUseOfBgMediatorConst({
            error: Error()
          }), BgMediatorConst) : BgMediatorConst).UPDATE_USER_GOLD, {
          ...
          (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().setCurrentGame((_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().getLastGame());
        }
...
//# sourceMappingURL=218f129c394543be2dc9e285f11ff2d21844e8be.js.map