  ...
  return {
    ...
    execute: function () {
      ...
      _export("calCardPoint", calCardPoint = (value1, value2) => {
        var sum = value1.upFace + value1.downFace + value2.upFace + value2.downFace;
        return sum % 10;
      });
      ...
      _export("getOptimalCardGroup", getOptimalCardGroup = cardItems => {
        // 找出所有组合
        var newArr = permutations(cardItems).map(v => {
          var arr = v;
          var cardItems = [arr.shift(), arr.shift()];
          var sum = calNum(cardItems);
          var cardGroup = {
            cardItems,
            sum: sum
          };
...
//# sourceMappingURL=7898f691e6212816589bfd04596cc33c34579260.js.map