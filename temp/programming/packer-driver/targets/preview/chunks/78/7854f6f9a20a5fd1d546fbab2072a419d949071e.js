System.register(["__unresolved_0", "cc", "__unresolved_1", "redux-act", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "912b8j+DH9MYo5nNIiL8d/K", "roller", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GXFCV2_UPDATE_ROLLER_STATUS]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GXFCV2_UPDATE_SPEED_STATUS]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GXFCV2_INIT_ROLLER]: (state, payload) => {
          return {
...
//# sourceMappingURL=7854f6f9a20a5fd1d546fbab2072a419d949071e.js.map