System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfGodWealth_roller(extras) {
    _reporterNs.report("GodWealth_roller", "../components/GodWealth_roller", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/GodWealth_roller", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/GodWealth_roller", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ee49bmakxxJgroQBBXHDS+w", "RollerViewModel", undefined);
...
//# sourceMappingURL=bf5788c3d8d5f61eea7aa90f1cef2891b0e75c93.js.map