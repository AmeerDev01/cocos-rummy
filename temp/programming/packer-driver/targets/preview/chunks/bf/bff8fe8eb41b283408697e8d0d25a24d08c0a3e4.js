System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20", "__unresolved_21", "__unresolved_22"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ViewModel, StoreInject, ModalBox, global, lang, addToastAction, UseSetOption, config, cacheData, clearCacheData, egyptv2_Audio, sourceManageSeletor, SKT_MAG_TYPE, sktInstance, sktMsgListener, bundlePkgName, PrefabPathDefine, getStore, changeGame, setAutoLauncherInfo, updateGold, updateJackpotAmount, updateJackpotDatas, updatePositionId, updateWinloss, updateRollerStatus, AutoLauncherType, GameType, RollerStatus, calBetAmount, isAuto, isSubGameToSubGame, verifyBetResultData, EgyptV2DialogWinViewModel, EgyptV2FoolerViewModel, EgyptV2HeaderViewModel, EgyptV2RollerPanelViewModel, EgyptV2RulePanelViewModel, EffectType, SoundPathDefine, _dec, _class, _crd, EgyptV2MainViewModel;
  ...
  function _reportPossibleCrUseOfEgyptV2_Main(extras) {
    _reporterNs.report("EgyptV2_Main", "../components/EgyptV2_Main", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/EgyptV2_Main", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/EgyptV2_Main", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfEgyptV2DialogWinViewModel(extras) {
    _reporterNs.report("EgyptV2DialogWinViewModel", "./EgyptV2DialogWinViewModel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfEgyptV2FoolerViewModel(extras) {
    _reporterNs.report("EgyptV2FoolerViewModel", "./EgyptV2FoolerViewModel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfEgyptV2HeaderViewModel(extras) {
    _reporterNs.report("EgyptV2HeaderViewModel", "./EgyptV2HeaderViewModel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfEgyptV2RollerPanelViewModel(extras) {
    _reporterNs.report("EgyptV2RollerPanelViewModel", "./EgyptV2RollerPanelViewModel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfEgyptV2RulePanelViewModel(extras) {
    _reporterNs.report("EgyptV2RulePanelViewModel", "./EgyptV2RulePanelViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EgyptV2DialogWinViewModel = _unresolved_17.default;
    }, function (_unresolved_18) {
      EgyptV2FoolerViewModel = _unresolved_18.default;
    }, function (_unresolved_19) {
      EgyptV2HeaderViewModel = _unresolved_19.default;
    }, function (_unresolved_20) {
      EgyptV2RollerPanelViewModel = _unresolved_20.default;
    }, function (_unresolved_21) {
      EgyptV2RulePanelViewModel = _unresolved_21.default;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "70b31ezvF5AyKQHQ7pv+PF3", "EgyptV2MainViewModel", undefined);

      __checkObsolete__(['Vec3']);

      EgyptV2MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        error: Error()
      }), StoreInject) : StoreInject)((_crd && getStore === void 0 ? (_reportPossibleCrUseOfgetStore({
        error: Error()
      }), getStore) : getStore)()), _dec(_class = class EgyptV2MainViewModel extends (_crd && ViewModel === void 0 ? (_reportPossibleCrUseOfViewModel({
        error: Error()
      }), ViewModel) : ViewModel) {
        ...
        begin() {
          this.headerViewModel = new (_crd && EgyptV2HeaderViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2HeaderViewModel({
            error: Error()
          }), EgyptV2HeaderViewModel) : EgyptV2HeaderViewModel)().mountViewNode(this.comp.getHeader()).connect();
          this.headerViewModel.setEvent({
            quitGame: () => {
              this.onQuitGame();
            }
          });
          this.footerViewModel = new (_crd && EgyptV2FoolerViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2FoolerViewModel({
            error: Error()
          }), EgyptV2FoolerViewModel) : EgyptV2FoolerViewModel)().mountViewNode(this.comp.getFooter()).connect();
          this.rollerPanelViewModel = new (_crd && EgyptV2RollerPanelViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2RollerPanelViewModel({
            error: Error()
          }), EgyptV2RollerPanelViewModel) : EgyptV2RollerPanelViewModel)().mountViewNode(this.comp.getRoller()).connect();
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            var localLeftCount = this.comp.props.gameTypeInfo.leftCount;
            var leftCount = si.freeCount;
            var nextLeftCount = undefined;
            var isDelay = false; // 小游戏切到小游戏时，暂不改变切换状态
            // 为了让玩家延时看到剩余的次数，特殊处理
        ...
        showDialogWin(dialogInfo, done) {
          var egyptV2DialogWinViewModel = new (_crd && EgyptV2DialogWinViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2DialogWinViewModel({
            error: Error()
          }), EgyptV2DialogWinViewModel) : EgyptV2DialogWinViewModel)().mountView((_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
        ...
        openRule() {
          var rulePanelViewMode = new (_crd && EgyptV2RulePanelViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2RulePanelViewModel({
            error: Error()
          }), EgyptV2RulePanelViewModel) : EgyptV2RulePanelViewModel)().mountView((_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFile((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
        ...
        playBgMusic() {
          (_crd && egyptv2_Audio === void 0 ? (_reportPossibleCrUseOfegyptv2_Audio({
            error: Error()
          }), egyptv2_Audio) : egyptv2_Audio).stop();
          ...
          if (this.comp.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            ...
            (_crd && egyptv2_Audio === void 0 ? (_reportPossibleCrUseOfegyptv2_Audio({
              error: Error()
            }), egyptv2_Audio) : egyptv2_Audio).play((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
              error: Error()
      ...
      _export("default", EgyptV2MainViewModel);
...
//# sourceMappingURL=bff8fe8eb41b283408697e8d0d25a24d08c0a3e4.js.map