        ...
        begin() {
          ...
          this.setEvent({
            ...
            allRollStop: () => {
              ...
              var flicherBaoHeArr = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
                error: Error()
              }), dataTransfer) : dataTransfer)((_crd && DataKeyType === void 0 ? (_reportPossibleCrUseOfDataKeyType({
                error: Error()
              ...
              var flicherBaoHeTask = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                error: Error()
              }), Task) : Task)(done => {
              ...
              if ((_crd && gameBoardViewModel === void 0 ? (_reportPossibleCrUseOfgameBoardViewModel({
                ...
                if (this.gameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
                  ...
                  this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                    ...
                    var winnerDialog = this.showSmallWin(done);
...
//# sourceMappingURL=6d29e4f278d965420e6aa6686be27df63c853a26.js.map