System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, UITransform, Size, Prefab, instantiate, Vec3, tween, Mask, BaseComponent, AudioManager, SoundList, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Egypt_Roller;
  ...
  function _reportPossibleCrUseOfEgypt_Icon(extras) {
    _reporterNs.report("Egypt_Icon", "./Egypt_Icon", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "185932xHEJOCrRrhLU6qfSK", "Egypt_Roller", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Node', 'Label', 'UITransform', 'Size', 'Prefab', 'instantiate', 'Vec3', 'Layout', 'tween', 'log', 'Mask']);
      ...
      _export("Egypt_Roller", Egypt_Roller = (_dec = ccclass('Egypt_Roller'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = class Egypt_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "icon2", _descriptor3, this);

          _initializerDefineProperty(this, "RollerLayOut2", _descriptor4, this);
        ...
        bindUI() {
          ...
          for (var i = 0; i < this.rollerData.portraitNum; i++) {
            ...
            icon.getComponent("Egypt_Icon").setFace(this.rollerData.data[index]);
        ...
        startRoll(stopIndex, isSpeed) {
          ...
          this.RollerLayOut.children.forEach(icon => {
            icon.getComponent("Egypt_Icon").setEffect(0);
          });
        ...
        joinIcon() {
          ...
          this.RollerLayOut.addChild(icon);
          icon.getComponent("Egypt_Icon").setFace(this.rollerData.data[this.lastJoinIconIndex]);
        ...
        addDockIcon(targetArr) {
          ...
          targetArr.forEach((item, index) => {
            try {
              var icon = instantiate(this.icon2);
              icon.getComponent("Egypt_Icon").hiddenAmounts(item[2]);
        ...
        setIconEffect(mode, target, allState) {
          ...
          if (mode === 'index') {
            this.RollerLayOut.children.forEach(icon => {
              var comp = icon.getComponent("Egypt_Icon");
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "icon2", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "RollerLayOut2", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=6d6f22d83eb1a814dc23b41c814814df13adf97f.js.map