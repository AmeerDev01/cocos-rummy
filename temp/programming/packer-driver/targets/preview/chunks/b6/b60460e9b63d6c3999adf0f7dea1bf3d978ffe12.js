      ...
      BoxPanelViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            if (!error) {
              ...
              var awardInfo = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
                error: Error()
              }), dataTransfer) : dataTransfer)((_crd && DataKeyType === void 0 ? (_reportPossibleCrUseOfDataKeyType({
                error: Error()
              ...
              var _loop = function _loop(key) {
                if (key === "BONUS") {
                  ...
                  awardBoxItem && _this.setProps({
                    openDoBoxData: {
                      boxId: _this.openWaitingBoxId,
          ...
          this.setEvent({
            ...
            updateTimesHandler: (times, jackPotTypeName) => {
              ...
              if (jackPotTypeName !== undefined) {
                var props = instantiate(this.jackpot.comp.props);
        ...
        manualBetHandler() {
          if ((_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
            ...
            for (var i = 0, l = this.comp.awardBoxMap.length; i < l; i++) {
              var awardBox = this.comp.awardBoxMap[i];
...
//# sourceMappingURL=b60460e9b63d6c3999adf0f7dea1bf3d978ffe12.js.map