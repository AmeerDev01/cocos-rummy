      ...
      _export("GodWealthV2_Roller", GodWealthV2_Roller = (_dec = ccclass('GodWealthV2_Roller'), _dec(_class = class GodWealthV2_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        setBeetleAmount(icon) {
          ...
          if (lockIconDatas.length === 0) {
            ...
            var amount = Math.ceil(Math.random() * betAmount);
          ...
          if (lockIconData) {
            var _amount = lockIconData.amount >= 10000 ? lockIconData.amount : lockIconData.amount;
        ...
        playOneScatterAnimation() {
          ...
          for (var i = 0; i < this.showIconCount; i++) {
            ...
            if (this.node && this.node.isValid && (_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
              ...
              var rollIndex = (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
                error: Error()
              ...
              var isLoop = Object.keys(freeGame).length > 0 ? true : false; // this.scatterNum = mainViewModel.rollerPanelViewModel.comp.getScatterCount(rollIndex);
        ...
        addLockIcon(isPlayAnimation) {
          ...
          lockValues.forEach(v => {
            var godWealthV2Icon = this.lockIcons.find(iconv => iconv.getIconIndex() === v.index);
        ...
        buildSingleRollerIcon(index, pos, icon) {
          var viewModel = new (_crd && GodWealthV2SingleIconRollerViewModel === void 0 ? (_reportPossibleCrUseOfGodWealthV2SingleIconRollerViewModel({
            error: Error()
        ...
        getBaoHeParticleNode() {
          ...
          for (var i = 0; i < this.showIconCount; i++) {
            ...
            if (this.isSubGame2SpecialIcon(element.getId())) {
              var ParticleNode = element.getParticleNode();
...
//# sourceMappingURL=46c796a5f096f6154adc033fa00f116c0e7e14fe.js.map