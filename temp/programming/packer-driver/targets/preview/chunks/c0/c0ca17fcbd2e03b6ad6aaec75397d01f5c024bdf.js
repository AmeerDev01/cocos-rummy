  ...
  return {
    ...
    execute: function () {
      ...
      _export("dragon_SlotPanel", dragon_SlotPanel = (_dec = ccclass('dragon_SlotPanel'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class dragon_SlotPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindUI() {
          var left = this._nodes['God_tk_left'].getChildByName('Charge_order').children;

          var center = this._nodes['God_tk_center'].getChildByName('Charge_order').children;

          var right = this._nodes['God_tk_right'].getChildByName('Charge_order').children;
        ...
        spitfire(data) {
          var RinghtAnger_dragon = this._nodes['RinghtAnger_dragon'];
          var God_tk_right = this._nodes['God_tk_right'];
          var God_tk_left = this._nodes['God_tk_left'];
          var God_tk_center = this._nodes['God_tk_center'];
          RinghtAnger_dragon.active = true;
          this._nodes['Ringht_dragon'].active = false;
          var spine = RinghtAnger_dragon.getComponent(sp.Skeleton);
        ...
        initJACKPOT(jackPotData) {
          ...
          var sprList = (_crd && getBgProxy === void 0 ? (_reportPossibleCrUseOfgetBgProxy({
            error: Error()
          }), getBgProxy) : getBgProxy)().getSpriteFrames();
          jackPotData.forEach(item => {
            var headImgUrl = "head_circle_" + item.avatarIndex;
            var spr = sprList.find(item => {
              return item.name == headImgUrl;
            });
            var node = instantiate(this.JackPotItem);
        ...
        setGod_MAJOR(mini, major) {
          var startNumberMini = parseInt(this.miniLabel.string.replace(/,/g, ""));
          var startNumberMajor = parseInt(this.majorLabel.string.replace(/,/g, ""));
        ...
        set_jack_total(num) {
          var startNumberMajor = parseInt(this.jackTotal.string.replace(/,/g, ""));
...
//# sourceMappingURL=c0ca17fcbd2e03b6ad6aaec75397d01f5c024bdf.js.map