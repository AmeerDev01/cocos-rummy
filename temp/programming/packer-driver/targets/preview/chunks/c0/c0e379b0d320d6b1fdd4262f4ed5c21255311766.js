  ...
  return {
    ...
    execute: function () {
      ...
      _export("Hall_VipMain", Hall_VipMain = (_dec = ccclass('Hall_VipMain'), _dec(_class = class Hall_VipMain extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initVipToggle() {
          var maxVipLevel = (_crd && vipMap === void 0 ? (_reportPossibleCrUseOfvipMap({
            error: Error()
          }), vipMap) : vipMap).length;
          var userVipLevel = this.props.memberInfo.vipLevel;
          ...
          (_crd && vipMap === void 0 ? (_reportPossibleCrUseOfvipMap({
            ...
            var vipLevel = v[0];
            var vipToggleItem = instantiate(this.propertyNode.props_vip_toggle_item);
            ...
            var isChecked = vipLevel === userVipLevel + 1; // 默认显示为下一个等级
        ...
        updateLevelBar() {
          ...
          var userTotalRechange = this.getUserTotalRechange();
          var vipLevel = this.props.memberInfo.vipLevel;
          var vipLevelExperience = this.props.memberInfo.vipLevelExperience; // 当前经验值 / 下一个等级需要的经验值 得到当前等级到下一个等级的一个百分比
          ...
          var percent = vipLevel < maxVipLevel ? vipLevelExperience / (_crd && vipMap === void 0 ? (_reportPossibleCrUseOfvipMap({
            error: Error()
          }), vipMap) : vipMap).find(v => v[0] === vipLevel + 1)[1] * 0.5 : 0;
          var barValue = vipLevel < maxVipLevel ? (vipLevel === 0 ? 0 : 0.5) + percent : 1;
          var locateNode = this.propertyNode.props_node_locate;
          var locateInitPosition = this.locateInitPosition;
          var bar = this.propertyNode.props_pro_levelbar.getComponent(ProgressBar);
          ...
          tween(bar).to(0.5, {
            ...
            onUpdate: () => {
              var barWidth = bar.barSprite.getComponent(UITransform).width;
        ...
        updateDiamondIcon(vipLevel) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.propertyNode.props_diamond_icon.getComponent(Sprite).spriteFrame = (yield (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              error: Error()
            }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync(iconFile, SpriteFrame)).source;
            _this.propertyNode.props_me_vip_level_label.getComponent(Label).string = vipLevel + "";
          })();
        }
        /**更新top的等级文字描述 */
        ...
        updateRemindInfo() {
          ...
          var nextLevel = this.props.memberInfo.vipLevel + 1;
          ...
          var vipInfo = (_crd && vipMap === void 0 ? (_reportPossibleCrUseOfvipMap({
            error: Error()
          }), vipMap) : vipMap).find(v => v[0] === nextLevel);
          var experience = vipInfo[1] - this.props.memberInfo.vipLevelExperience;
...
//# sourceMappingURL=c0e379b0d320d6b1fdd4262f4ed5c21255311766.js.map