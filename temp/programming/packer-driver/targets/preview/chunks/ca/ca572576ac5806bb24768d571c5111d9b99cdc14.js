System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, SpriteFrame, assetManager, instantiate, PrefabDefine, BaseMediator, AudioManager, getBgProxy, global, addToastAction, setSubGameRunState, SubGameRunState, config, LoaderMediator, _crd, LoaderViewType;
  ...
  function _reportPossibleCrUseOfdragon_Loader(extras) {
    _reporterNs.report("dragon_Loader", "../Component/dragon_Loader", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "0b77dxK2x9D9YCs9hElDDn8", "LoaderMediator", undefined);

      __checkObsolete__(['Prefab', 'Script', 'TypeScript', 'SpriteFrame', 'assetManager', 'instantiate', 'resources']);
        ...
        constructor(mediatorName, viewComponent) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              assetManager.loadBundle("dragon", /*#__PURE__*/_asyncToGenerator(function* (err, _bundle) {
                // 首先贴入加载框面板
                try {
                ...
                _bundle.load(panel.path, Prefab, (progress, total) => {
                  ...
                  var loaderScript = node.getComponent("dragon_Loader");
...
//# sourceMappingURL=ca572576ac5806bb24768d571c5111d9b99cdc14.js.map