      ...
      _export("Hall_BankPanel", Hall_BankPanel = (_dec = ccclass('Hall_BankPanel'), _dec(_class = class Hall_BankPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_btn_sure_verify.on(Node.EventType.TOUCH_END, () => {
            var str = this.propertyNode.props_intput_phone_phoneNum.getComponent(EditBox).string;
            var isToadyAutoLogin = this.propertyNode.props_Toggle_bank_goin.getComponent(Toggle).isChecked;
          ...
          this.propertyNode.props_set_btn_sure.on(Node.EventType.TOUCH_END, () => {
            var str = this.propertyNode.props_intput_sandi_pwd.getComponent(EditBox).string;
            var str2 = this.propertyNode.props_intput_bank_set_pwd.getComponent(EditBox).string;
            new (_crd && InputValidator === void 0 ? (_reportPossibleCrUseOfInputValidator({
              error: Error()
...
//# sourceMappingURL=94a6cba24edbb9be2d3e24f4b4d88d91394c262e.js.map