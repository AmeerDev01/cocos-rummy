  ...
  return {
    ...
    execute: function () {
      ...
      _export("phoenix_SlotPanel", phoenix_SlotPanel = (_dec = ccclass('phoenix_SlotPanel'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = class phoenix_SlotPanel extends (_crd && phoenix_BaseComponent === void 0 ? (_reportPossibleCrUseOfphoenix_BaseComponent({
        ...
        setLost(total) {
          var node = this.node.getChildByName('spr_smallGame_multipleBg').getChildByName('Label_smallGame_multiple').getComponent(Label);
        ...
        hideSlot(isMain, isSlow, done) {
          var slotListPanelNode = this.node.getChildByName("slotListPanel");
          var upBgNode = this.node.getChildByName("spr_phoenix_upBg");
          var slotBgNode = this.getSlotBgNode(isMain);
...
//# sourceMappingURL=fd1d8d8fa4f0ccf1e5d7faf308faca39ec89279e.js.map