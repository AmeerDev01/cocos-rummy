System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "74690f1RKtN4rrOB7o/Bj7i", "Thor_AwardBox", undefined);
      ...
      _export("Thor_AwardBox", Thor_AwardBox = (_dec = ccclass('Thor_AwardBox'), _dec(_class = class Thor_AwardBox extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
            ...
            window.setTimeout(() => {
              ...
              var particleTask = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                ...
                if (!this.propertyNode || !this.node) {
                  ...
                  return;
                } //thor_Audio.playOneShot(SoundPathDefine.FRUIT_UP)
          ...
          if (key === "levelUp") {
            window.setTimeout(() => {
              //thor_Audio.playOneShot(SoundPathDefine.LEVEV_UP)
              this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                error: Error()
              }), Task) : Task)(done => {
                if (!this.propertyNode || !this.node) {
          ...
          if (key === "times") {
            window.setTimeout(() => {
              //thor_Audio.playOneShot(SoundPathDefine.GET_COIN)
              //确保资源被替换之后
              this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                error: Error()
              }), Task) : Task)(done => {
...
//# sourceMappingURL=fd0f3021c9722437840328f6f6127ad037107634.js.map