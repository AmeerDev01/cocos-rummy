  ...
  return {
    ...
    execute: function () {
      ...
      _export("Bullet", Bullet = class Bullet {
        ...
        initEnv(bulConfig, bSize, batteryManager, sourceManage, fishNetManager, scaleRatio) {
        ...
        init(info) {
          ...
          var bulletItem = this.bulletConfig[info.id];
          this.bulletObj = null;
        ...
        getBondingBox() {
          ...
          for (var k in this.bondingBox) {
            var v = this.bondingBox[k];
            if (!v) continue;
            var newA = 0;
            var newB = 0;
        ...
        update(dt) {
          ...
          var refPos = this.refectPos;
          var objPos = this.objPos;
          var curX = refPos.x + linePos.x;
          var curY = refPos.y + linePos.y;
          ...
          var distance = this.moveV * this.runSeconds;
          ...
          if (isDrawBondingBox) {
            ...
            for (var key in this.bondingBox) {
              var v = this.bondingBox[key];
              if (!v) continue;
...
//# sourceMappingURL=51aeb78644545770d9a26130496e2026de00890d.js.map