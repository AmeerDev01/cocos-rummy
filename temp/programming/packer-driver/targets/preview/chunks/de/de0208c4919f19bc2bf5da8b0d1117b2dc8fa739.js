System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e03d7oV5mFFc75/m7p9UGcr", "SocketRepository", undefined);
      ...
      wsEnv = {
        isTest: false,
        online: {
          socketIp: "ws://54.251.66.82:15005/ws",
          "token": sys.localStorage.getItem("token"),
          "gameId": 7,
          "roomId": "1672958541691883522"
        },
        local1: {
          socketIp: "ws://192.168.110.180:15005/ws",
        ...
        local2: {
          socketIp: "ws://192.168.110.218:15005/ws",
          ...
          if (wsEnv.isTest) {
            ...
            return new Promise((reslove, reject) => {
              (_crd && initConfig === void 0 ? (_reportPossibleCrUseOfinitConfig({
                ...
                var item = response.gameConfig.find(item => item.id === env.gameId);
...
//# sourceMappingURL=de0208c4919f19bc2bf5da8b0d1117b2dc8fa739.js.map