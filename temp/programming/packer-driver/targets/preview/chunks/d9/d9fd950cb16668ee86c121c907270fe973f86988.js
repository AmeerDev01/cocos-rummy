System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DialogType, BgMediatorConst, RollerMediatorConst, SubGameType, config, getBgProxy, getSocketProxy, BaseCommand, AudioManager, SceneBgMusic, SoundList, UseSetOption, BgCommand, _crd, BgCommandConst;
  ...
  function _reportPossibleCrUseOfDialogType(extras) {
    _reporterNs.report("DialogType", "../Component/Egypt_DialogWin", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      RollerMediatorConst = _unresolved_4.RollerMediatorConst;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "8f40f0amLFJmbiPiPUA/Wf3", "BgCommand", undefined);
      ...
      _export("BgCommand", BgCommand = class BgCommand extends (_crd && BaseCommand === void 0 ? (_reportPossibleCrUseOfBaseCommand({
        ...
        constructor() {
          ...
          this.listExecute = [{
            ...
            handler(notification) {
              ...
              if (nextGame !== -1) {
                ...
                var gameTypeNew = nextGame; // 播放飞水果动画,2秒的时候悄悄切换界面
                ...
                window.setTimeout(() => {
                  ...
                  window.setTimeout(() => {
                    if (gameTypeNew === (_crd && SubGameType === void 0 ? (_reportPossibleCrUseOfSubGameType({
                      ...
                      this.sendNotification((_crd && BgMediatorConst === void 0 ? (_reportPossibleCrUseOfBgMediatorConst({
                        error: Error()
                      }), BgMediatorConst) : BgMediatorConst).TOGGLESSCROLLINGPANELS, {
                        gameType: 0,
                        done
          ...
          // },
          {
            ...
            handler(notification) {
              ...
              var _keepTime = keepTime || 2500; //获取奖励类型
        ...
        updateBetAmount(order) {
          ...
          (_crd && UseSetOption === void 0 ? (_reportPossibleCrUseOfUseSetOption({
            error: Error()
          }), UseSetOption) : UseSetOption).Instance().setGameOption("egypt", {
            betTarget: str
          });
...
//# sourceMappingURL=d9fd950cb16668ee86c121c907270fe973f86988.js.map