      ...
      _export("Common_GiftUser", Common_GiftUser = (_dec = ccclass('Common_GiftUser'), _dec(_class = class Common_GiftUser extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_gift_on_off.on(Toggle.EventType.TOGGLE, e => {
            var key = "gift_" + this.props.memberId;
        ...
        getPlayNumber() {
          var toggles = this.propertyNode.props_play_number.children;
        ...
        bindUI() {
          var toggle = this.propertyNode.props_play_number.children.find(v => v.name === "toggle_" + this.playCount);
        ...
        initIconConfig() {
          ...
          GIFT_ICON_CONFIG.forEach(v => {
            var iconNode = instantiate(this.propertyNode.props_btn_gift_box);
...
//# sourceMappingURL=d9971710f4ef7edccc9af240c3e253165b1df046.js.map