    ...
    execute: function () {
      ...
      _export("DragonV2topValue", DragonV2topValue = (_dec = ccclass('DragonV2topValue'), _dec(_class = class DragonV2topValue extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        flashbox(done) {
          ...
          var mini_numerSpecial = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
            error: Error()
          ...
          var major_numerSpecial = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
            error: Error()
          ...
          var jackpot_numberSpecial = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
            error: Error()
        ...
        setTamako(num) {
          ...
          if (num == 5) {
            ...
            var mini = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
              error: Error()
            ...
            var major = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
              error: Error()
            ...
            var jackpot = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
              error: Error()
          ...
          this.useState((key, value) => {
            new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
              ...
              if (this.node && this.node.isValid) {
                ...
                this.mini_numer.getChildByName('number').getComponent(Label).string = _value.formatAmountWithCommas();
              }
            }).start();
          }, ["miniVal"]);
          this.useState((key, value) => {
            new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
              ...
              if (this.node && this.node.isValid) {
                var _value2 = Number(num.toFixed(0));

                this.major_numer.getChildByName('number').getComponent(Label).string = _value2.formatAmountWithCommas();
              }
            }).start();
          }, ["majorVal"]);
          this.useState((key, value) => {
            new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
              ...
              if (this.node && this.node.isValid) {
                var _value3 = Number(num.toFixed(0));

                this.jackpot_number.getChildByName('number').getComponent(Label).string = _value3.formatAmountWithCommas();
              }
            }).start();
          }, ["grandVal"]);
        }
...
//# sourceMappingURL=913b6739f5556e0ffc8630229b65de7c8298386a.js.map