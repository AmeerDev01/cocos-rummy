      ...
      _export("Hall_LoginDialog", Hall_LoginDialog = (_dec = ccclass('Hall_LoginDialog'), _dec(_class = class Hall_LoginDialog extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          (_crd && initDropDownBox === void 0 ? (_reportPossibleCrUseOfinitDropDownBox({
            ...
            renderItem: record => {
              var templateBtu = instantiate(this.propertyNode.props_ScrollView_areaNum_pwd.getComponent(ScrollView).content.children[0]);
          ...
          (_crd && initDropDownBox === void 0 ? (_reportPossibleCrUseOfinitDropDownBox({
            ...
            renderItem: record => {
              var templateBtu = instantiate(this.propertyNode.props_ScrollView_areaNum_phone.getComponent(ScrollView).content.children[0]);
              templateBtu.getChildByName("Label").getComponent(Label).string = record;
              return templateBtu;
            },
            chooseItem: _ref2 => {
          ...
          this.propertyNode.props_btn_send_vercode.on(Node.EventType.TOUCH_END, () => {
            var phoneNumber = this.propertyNode.props_intput_phone_phoneNum_phone.string;
        ...
        login() {
          var loginData = this.state.showLoginType === LoginType.PASSWORD ? {
...
//# sourceMappingURL=10ecf22740be34c5e55f099b229198d22d06210a.js.map