  ...
  return {
    ...
    execute: function () {
      ...
      _export("GodWealthV2Icon", GodWealthV2Icon = class GodWealthV2Icon {
        ...
        setAmount(amount) {
          var miniNum = (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
          }), mainViewModel) : mainViewModel).comp.miniNum;
          var majorNum = (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
...
//# sourceMappingURL=93a652d47091c5c88db62df1bc7e15cb611b3dcb.js.map