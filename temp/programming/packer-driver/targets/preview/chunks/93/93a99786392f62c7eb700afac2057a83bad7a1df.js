System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, instantiate, SpriteFrame, PrefabDefine, BaseMediator, AudioManager, getBgProxy, global, addToastAction, setSubGameRunState, SubGameRunState, GodWealth_config, LoaderMediator, _crd, LoaderViewType;
  ...
  function _reportPossibleCrUseOfGodWealth_Loader(extras) {
    _reporterNs.report("GodWealth_Loader", "../Component/GodWealth_Loader", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfGodWealth_config(extras) {
    _reporterNs.report("GodWealth_config", "../GodWealth_config", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GodWealth_config = _unresolved_9.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "deacfLnOvNDNqGNv+tcktWC", "LoaderMediator", undefined);
        ...
        constructor(mediatorName, viewComponent) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              assetManager.loadBundle("godWealth", /*#__PURE__*/_asyncToGenerator(function* (err, _bundle) {
                // 首先贴入加载框面板
                try {
                ...
                _bundle.load(panel.path, Prefab, (progress, total) => {
                  ...
                  (_crd && global === void 0 ? (_reportPossibleCrUseOfglobal({
                    error: Error()
                  }), global) : global).setSubGameGate((_crd && GodWealth_config === void 0 ? (_reportPossibleCrUseOfGodWealth_config({
                    error: Error()
                  }), GodWealth_config) : GodWealth_config).gameId, progress / total);
                }, (err, prefab) => {
                  if (!(_crd && global === void 0 ? (_reportPossibleCrUseOfglobal({
                    error: Error()
                  }), global) : global).isAllowOpenSubGame((_crd && GodWealth_config === void 0 ? (_reportPossibleCrUseOfGodWealth_config({
                    error: Error()
                  }), GodWealth_config) : GodWealth_config).gameId)) return;
                  (_crd && global === void 0 ? (_reportPossibleCrUseOfglobal({
                    error: Error()
                  }), global) : global).hallDispatch((_crd && setSubGameRunState === void 0 ? (_reportPossibleCrUseOfsetSubGameRunState({
                    error: Error()
                  ...
                  var loaderScript = node.getComponent("GodWealth_Loader");
...
//# sourceMappingURL=93a99786392f62c7eb700afac2057a83bad7a1df.js.map