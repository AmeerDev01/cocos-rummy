System.register(["__unresolved_0", "cc", "__unresolved_1", "redux-act"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "eccaafuK4NBgpLquz94Y1SB", "game", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_CHANGE_CURRGAMETYPE]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_CHANGE_VIEW_GAME]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_GAMEMODE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_UPDATE_BALANCE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_CHANGE_PROFIT]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_BETTINGINFORMATION]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_APOSTILLE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_ISHASTEN]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_MULTIPLETOTAL]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_MINIGAMECOUNT]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_ROLEATTACK]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_CHANGE_AUTO_LAUNCHER_TYPE]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_UPDATE_SUBGAME_TIMES]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_GAMEFREEGAMETOTALMULTIPLIER]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_SUBGAME_TIMES]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_UPDATE_JACKPOT_AMOUNT]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_WAITING]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_AUTO_LAUNCH]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_SET_AUTO_LAUNCHED_TIMES]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).THOR_RESET_STORE]: (state, payload) => {
...
//# sourceMappingURL=7982049a84f80ffb9527538ca0c23edc25310636.js.map