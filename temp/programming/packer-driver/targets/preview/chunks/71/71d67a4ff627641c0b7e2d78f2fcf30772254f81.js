System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "53ec6X6MVdJDY3uadveiNBy", "phoenix_roller", undefined);
      ...
      _export("phoenix_roller", phoenix_roller = (_dec = ccclass('phoenix_roller'), _dec(_class = class phoenix_roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          ...
          if (key === "iconYuanBaoEffectData") {
            ...
            for (var _i = 0, _l = this.displayIconList.length; _i < _l; _i++) {
              /**index是图标从下往上的序列号 */
              var _index = _i;
              var _item = this.displayIconList[_index];

              if (this.props.iconYuanBaoEffectData.iconEffectArr.indexOf(_index) !== -1) {
                _item.setProps({
          ...
          if (key === "iconFreeGameEffectData") {
            ...
            for (var _i2 = 0, _l2 = this.displayIconList.length; _i2 < _l2; _i2++) {
              /**index是图标从下往上的序列号 */
              var _index2 = _i2;
              var _item2 = this.displayIconList[_index2];

              if (this.props.iconFreeGameEffectData.iconEffectArr.indexOf(_index2) !== -1) {
                _item2.setProps({
        ...
        joinIcon() {
          //下一个要加入的图标
          var iconData = this.props.rollerType.iconQueue[this.nextJoinIconIndex]; // 进入小游戏凤凰图标资源更改
...
//# sourceMappingURL=71d67a4ff627641c0b7e2d78f2fcf30772254f81.js.map