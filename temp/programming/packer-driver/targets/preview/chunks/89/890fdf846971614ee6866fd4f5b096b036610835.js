System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, tween, UIOpacity, UITransform, Vec3, BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, dragon_RulesPanel;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "33a5a/HaLtESoLZ94PAnD9A", "dragon_RulesPanel", undefined);
      ...
      _export("dragon_RulesPanel", dragon_RulesPanel = (_dec = ccclass('dragon_RulesPanel'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class dragon_RulesPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
...
//# sourceMappingURL=890fdf846971614ee6866fd4f5b096b036610835.js.map