System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, ViewModel, StoreInject, getStore, SKT_MAG_TYPE, sktInstance, gameCacheData, _dec, _class, _crd, ccclass, property, UsersViewModel;

  function _reportPossibleCrUseOfDragonTiger_users(extras) {
    _reporterNs.report("DragonTiger_users", "../components/DragonTiger_users", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/DragonTiger_users", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/DragonTiger_users", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f8882JRgLtOzKnhGiwgvaTp", "DragonTigerUsersViewModel", undefined);
...
//# sourceMappingURL=04178422d9fc1e47052552548e25623dde59cbaa.js.map