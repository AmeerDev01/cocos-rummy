    ...
    execute: function () {
      ...
      GxfcV2MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        showDialogWin(dialogInfo, done) {
          var gxfcv2DialogWinViewModel = new (_crd && GxfcV2DialogWinViewModel === void 0 ? (_reportPossibleCrUseOfGxfcV2DialogWinViewModel({
            error: Error()
        ...
        openRule() {
          var rulePanelViewMode = new (_crd && GxfcV2RulePanelViewModel === void 0 ? (_reportPossibleCrUseOfGxfcV2RulePanelViewModel({
            error: Error()
...
//# sourceMappingURL=1e62cd612e3741244e6d6a8faffe7288c7a019b3.js.map