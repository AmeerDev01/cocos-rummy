System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  function restructureCard(array, newCard) {
    ...
    var C = newCard.map(num => {
      var item = array.find(obj => obj.cardNum === num);
    ...
    ;
    var maxIndices = (C[0].cardSum + C[1].cardSum) % 10;
    var mimIndices = (C[2].cardSum + C[3].cardSum) % 10; // if(sumSixIndex>=4){
    // 	result=0
    // }
    // if(sameIndex>=4){
    // 	result=1
      ...
      _export("Bandar_card_banker", Bandar_card_banker = (_dec = ccclass('Bandar_card_banker'), _dec(_class = class Bandar_card_banker extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          if (key === "farmhouse") {
            if (value.cur && Object.keys(value.cur).length != 0) {
              window.setTimeout(() => {
                ...
                var item = this.props.allCardType[0];
          ...
          if (key === "bankerPoker") {
            ...
            var allCard = (_crd && sendViewModel === void 0 ? (_reportPossibleCrUseOfsendViewModel({
              error: Error()
        ...
        playAnimation() {
          /**翻牌 */
          var task1 = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
            error: Error()
          }), Task) : Task)(done => {
          ...
          var task2 = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
            error: Error()
          }), Task) : Task)(done => {
            this.propertyNode.props_banker_all_card.children.forEach(item => {
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
          ...
          var task3 = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
            error: Error()
          }), Task) : Task)(done => {
        ...
        changeCardInfo(bankerPoker) {
          ...
          bankerPoker.forEach((item, index) => {
            ...
            var itemCardNum = sumCard(itemCard.up, itemCard.down);
            var cardP = {
              cardNum: item,
              cardSum: itemCardNum,
              up: itemCard.up,
        ...
        changeCardPosition() {
          var banker = restructureCard(this.newCardPo, (_crd && gameCacheData === void 0 ? (_reportPossibleCrUseOfgameCacheData({
            error: Error()
...
//# sourceMappingURL=ed2897c7239110a4a40d509acf6ccd394af2c0c1.js.map