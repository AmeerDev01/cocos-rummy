      ...
      _export("BackgroundScene", BackgroundScene = class BackgroundScene {
        ...
        createView(view, parent, textureConfig) {
          ...
          var _loop = function _loop() {
            var v = view[k];
            var config = textureConfig[v.src_id];

            if (config) {
              if (config.stype === 1) {
                //animation
                var spr = (_crd && createAnimationNode === void 0 ? (_reportPossibleCrUseOfcreateAnimationNode({
                  error: Error()
                }), createAnimationNode) : createAnimationNode)(_this.sourceManage, parent, config, true, true); // spr.setPosition(this.convertToNodeSpaceAR(v.pos))
                ...
                //pic
                var _spr = (_crd && createSpriteNode === void 0 ? (_reportPossibleCrUseOfcreateSpriteNode({
                  error: Error()
                }), createSpriteNode) : createSpriteNode)(_this.sourceManage, parent, config.file); // spr.setPosition(this.convertToNodeSpaceAR(v.pos))


                _spr.setWorldPosition(new Vec3(v.pos.x, v.pos.y));
              }
            }
          };
        ...
        init(state, cutSeconds, scInfo, bgmConfig, textureConfig, sceneSize, musicEffectPlayer) {
          ...
          var musicSrc = bgmConfig[scInfo.bk_mus_id];
          ...
          var bkSrc = textureConfig[scInfo.bk_pic_id].file;
...
//# sourceMappingURL=64e467af6ce16d2ea1aeaed27e10332c37af9154.js.map