  ...
  return {
    ...
    execute: function () {
      ...
      _export("Qiuqiu_Mine", Qiuqiu_Mine = (_dec = ccclass('Qiuqiu_Mine'), _dec(_class = class Qiuqiu_Mine extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        updateWinloss() {
          var winloss = this.props.winloss;
        ...
        genCardItem() {
          var cardLength = this.props.cards.length;
        ...
        genHandCardItem(isShow) {
          ...
          var cardItems = this.props.cards.map(v => (_crd && genCardItem === void 0 ? (_reportPossibleCrUseOfgenCardItem({
            error: Error()
        ...
        createCardView(cardItem, parentNode, isShow) {
          if (isShow === void 0) {
            isShow = false;
          }
        ...
        updateDealCard() {
          var dealCardCount = this.props.dealCardCount;
          ...
          var viewModel = this.cardViewModels[dealCardCount - 1];
          if (!viewModel) return;
        ...
        showRightNum() {
          var sum = this.calNum(this.rightCardItems);
          this.scheduleOnce(() => {
        ...
        getHandCardPosition(index) {
          var viewModel = this.cardViewModels[index - 1];
...
//# sourceMappingURL=6aa3ffe5e8c742e68efed412f37474e50028e3b7.js.map