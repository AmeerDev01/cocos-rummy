  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioMgr", AudioMgr = class AudioMgr {
        ...
        playOneShot(sound, volume, isReplace) {
          if (volume === void 0) {
            volume = 1.0;
          }
          ...
          var source = this.sourceManage.getFile(sound).source;
          ...
          if (source instanceof AudioClip) {
            ...
            var bundler = this.sourceManage.bundle;
        ...
        playSound(clip) {
          var audioSource = clip.getDuration() > 1 ? this._longSoundSource : this._shortSoundSource;
...
//# sourceMappingURL=7c437c348ad49dc81aa10b1cc03bdb4152ee7d34.js.map