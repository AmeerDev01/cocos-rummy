System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "fb6efb+L6lDCLeOKJp7IZym", "Thor_Footer", undefined);
      ...
      _export("Thor_Footer", Thor_Footer = (_dec = ccclass('Thor_Footer'), _dec(_class = class Thor_Footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        getBetListByLevel() {
          var level = +JSON.parse(sys.localStorage.getItem("thor")).lv;
        ...
        bindUI() {
          ...
          this.useState((key, value) => {
            ...
            if (key === "baseBetAmountTarget") {
              var raise = this.props.apostille ? 5 : 0; // this.propertyNode.props_Label_down_oneBet.string = `${config.linesQueueNum + raise}×${value.cur.value}`
...
//# sourceMappingURL=daf724d2937220554abb2d965bc5d8a3c36bc5ea.js.map