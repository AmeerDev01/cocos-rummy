      ...
      _export("Bandar_history", Bandar_history = (_dec = ccclass('Bandar_history'), _dec(_class = class Bandar_history extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        createHistoryTr(tren) {
          ...
          tren.forEach((item, index) => {
            ...
            if (index === 0) {
              ...
              var spr_allMark = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              ...
              var _spr_allMark = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("spr_allMark", historyItem);

              _spr_allMark.getComponent(Sprite).spriteFrame = item.semua > 0 ? this.getWinLossSpriteFrame(item.semua) : this.getWinLossSpriteFrame(1);
              _spr_allMark.active = item.semua > 0;
            }

            historyItem.setPosition(0, -34 - index * 53);
            var black = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            }), getNodeByNameDeep) : getNodeByNameDeep)("spr_history_black", historyItem).getComponent(Sprite);
            var red = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            }), getNodeByNameDeep) : getNodeByNameDeep)("spr_history_red", historyItem).getComponent(Sprite);
            var plum = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            }), getNodeByNameDeep) : getNodeByNameDeep)("spr_history_plum", historyItem).getComponent(Sprite);
            var diamond = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
        ...
        createHistorySta(statistik) {
          statistik.forEach((item, index) => {
            var num = index + 1;
            var label_winRate = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            ...
            var label_winMatches = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            ...
            var label_loseMatches = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            ...
            var tingkatNum = (item.tingkat * 100).toFixed(2);
        ...
        createHistoryRok(roker) {
          for (var key in roker) {
            var item = roker[key];
            var label_num = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            ...
            var label_num_win = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            }), getNodeByNameDeep) : getNodeByNameDeep)("label_num_win", (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
            }), getNodeByNameDeep) : getNodeByNameDeep)("spr_userRefresh_" + key, this.node));
            var label_num_lose = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
              error: Error()
...
//# sourceMappingURL=b275ee4f0fdf2ae4a5124996b1d73ce9ce22e867.js.map