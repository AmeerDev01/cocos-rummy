    ...
    execute: function () {
      ...
      _export("Fish_Getnewwwep", Fish_Getnewwwep = (_dec = ccclass('Fish_Getnewwwep'), _dec(_class = class Fish_Getnewwwep extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initBatteryList() {
          ...
          for (var key in this.props.batterySkinConfig) {
            var element = this.props.batterySkinConfig[key];
            this.createBattery(element);
          }
        }

        createBattery(skinConfig) {
          var itemNode = instantiate(this.propertyNode.props_img_side);
          var batteryNode;

          if (skinConfig.id === 0) {
            var texture = this.props.textureConfig[skinConfig.src];
            var spriteName = String(texture.pattern).format(1);
          ...
          var isLock = this.props.vipLevel < skinConfig.vip;
...
//# sourceMappingURL=b2c63644d9c0e1af96aeba2b7319709d3c9ccfea.js.map