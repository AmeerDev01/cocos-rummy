System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, sys, ViewModel, StoreInject, getStore, AutoLauncherViewModel, starlight_Audio, sourceManageSeletor, PrefabPathDefine, EffectType, BaseViewModel, SKT_MAG_TYPE, sktInstance, beginRollAction, setSmallBox, dataTransfer, DataKeyType, AutoLauncherType, GameType, changeAutoLauncherType, changeIsHasten, changeProfit, changebetAmount, setAutoLaunchedTimes, setShowAuthLaunch, setWaiting, SoundPathDefine, global, lang, addToastAction, _dec, _class, _crd, FooterViewModel;
  ...
  function _reportPossibleCrUseOfStarlight_Footer(extras) {
    _reporterNs.report("Starlight_Footer", "../components/Starlight_Footer", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/Starlight_Footer", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/Starlight_Footer", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1551732vD9Ng5D/v0AhG7CM", "FooterViewModel", undefined);

      __checkObsolete__(['Node', 'Animation', 'sys']);
          ...
          this.setEvent({
            ...
            closeAutoLauncher: isClear => {
              ...
              isClear && this.dispatch((_crd && setAutoLaunchedTimes === void 0 ? (_reportPossibleCrUseOfsetAutoLaunchedTimes({
                error: Error()
              }), setAutoLaunchedTimes) : setAutoLaunchedTimes)(0)); // isClear && this.dispatch(setRollSpeed(1));
...
//# sourceMappingURL=e90713f18d88b6a20b0f853119113261656cf2aa.js.map