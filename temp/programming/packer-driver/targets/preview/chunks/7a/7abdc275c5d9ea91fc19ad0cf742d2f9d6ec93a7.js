  ...
  return {
    ...
    execute: function () {
      ...
      _export("Task", Task = class Task {
        ...
        subscribeDone(key, handler, isClear) {
          if (isClear === void 0) {
            isClear = false;
          }
        ...
        forceComplete(isDoneExecute) {
          if (isDoneExecute === void 0) {
            isDoneExecute = true;
          }
      ...
      */
      ...
      _export("default", TaskScheduler = class TaskScheduler {
        ...
        start() {
          ...
          var _task = this.asyncQueue.shift();
         ...
         */
        joinqQueue(task, sync, autoDestroy) {
          if (sync === void 0) {
            sync = false;
          }

          if (autoDestroy === void 0) {
            autoDestroy = true;
          }
...
//# sourceMappingURL=7abdc275c5d9ea91fc19ad0cf742d2f9d6ec93a7.js.map