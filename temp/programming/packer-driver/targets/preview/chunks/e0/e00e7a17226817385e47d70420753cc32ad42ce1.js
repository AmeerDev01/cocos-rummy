      ...
      _export("Fruit777_Roller", Fruit777_Roller = (_dec = ccclass('Fruit777_Roller'), _dec(_class = class Fruit777_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          ...
          if (key === "iconEffectData") {
            ...
            this.speed = 0;
            var displayIconListInside = this.displayIconList.filter(i => i.viewNode.position.y > -this.getRollerHeight(true));

            for (var i = 0, l = displayIconListInside.length; i < l; i++) {
              /**index是图标从下往上的序列号 */
              var index = i;
              var item = displayIconListInside[index];
        ...
        move() {
          ...
          var lastChild = this.propertyNode.props_roller.children[this.propertyNode.props_roller.children.length - 1];
          ...
          if (lastChild.position.y < -(lastChild.getComponent(UITransform).height / 2)) {
            ...
            if (this.props.rollerType.stopIconIndex === this.lastInsertIconViewModel.comp.props.iconData.queueIndex) {
              ...
              var geidArr = this.getIconStopSet();
        ...
        moveIcon() {
          ...
          this.propertyNode.props_roller.children.forEach((child, i) => {
            var viewModel = this.displayIconList.find(i => i.viewNode.uuid === child.uuid);
            var {
              x,
              y,
              z
        ...
        getIconStopSet() {
          var l = this.propertyNode.props_roller.children.length;
          var gridArr = [];
          var start_y = 0;

          for (var i = l - 1; i >= 0; i--) {
            var nodeHeight = this.propertyNode.props_roller.children[i].getComponent(UITransform).height;
...
//# sourceMappingURL=e00e7a17226817385e47d70420753cc32ad42ce1.js.map