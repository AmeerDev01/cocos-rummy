    ...
    execute: function () {
      ...
      _export("SkillItemLine", SkillItemLine = class SkillItemLine {
        ...
        runLine(info, textureConfig) {
          var srcConfig = textureConfig[info.src_id];
        ...
        getSideByPos(pos1, pos2) {
          var side = 0; // let sp = { x = pos2.x - pos1.x, y = pos2.y - pos1.y, }

          var sp = new Vec3(pos2.x - pos1.x, pos2.y - pos1.y);
        ...
        getAngleByPos(pos1, pos2) {
          var angle = 0;
          var side = this.getSideByPos(pos1, pos2);
        ...
        setPosAndRotate(info) {
          ...
          var size = this.uiRoot.getComponent(UITransform); // 计算两点间的距离

          var pos_dis = sqrt(pow(info.pos1.x - info.pos2.x, 2) + pow(info.pos1.y - info.pos2.y, 2));
          ...
          var angle = this.getAngleByPos(info.pos1, info.pos2); // this.uiRoot.angle = 360 - angle;
...
//# sourceMappingURL=cf0150bb61732ede718e42204b41096eee1f3c4d.js.map