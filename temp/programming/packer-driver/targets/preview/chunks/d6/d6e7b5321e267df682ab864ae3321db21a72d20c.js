System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, sp, BaseComponent, sourceManageSeletor, Task, TaskSchedulerDefault, StepNumber, SkeletonAnimationPlayer, _dec, _class, _crd, ccclass, property, GodWealth_dialogWin;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7e05bUXRspBWbXTxi4FZZl8", "GodWealth_dialogWin", undefined);

      __checkObsolete__(['_decorator', 'Button', 'Component', 'Label', 'Node', 'Skeleton', 'sp', 'tween', 'Vec3']);
      ...
      _export("GodWealth_dialogWin", GodWealth_dialogWin = (_dec = ccclass('GodWealth_dialogWin'), _dec(_class = class GodWealth_dialogWin extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          if (key === "winning") {
            ...
            if (value.cur) {
              var titleSkeleton = this.propertyNode.props_cs_bw.getComponent(sp.Skeleton);
            ...
            if (this.props.winning.id === 4) {
              ...
              (_crd && TaskSchedulerDefault === void 0 ? (_reportPossibleCrUseOfTaskSchedulerDefault({
                ...
                new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
                  ...
                  this.scheduleOnce(() => {
                    this.numberStop = true;
                    this.events.killSelfHandler(); //数字展示完了之后，再停留1秒钟
...
//# sourceMappingURL=d6e7b5321e267df682ab864ae3321db21a72d20c.js.map