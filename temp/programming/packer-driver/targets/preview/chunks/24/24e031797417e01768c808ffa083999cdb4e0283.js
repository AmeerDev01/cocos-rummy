  ...
  return {
    ...
    execute: function () {
      ...
      _export("Yxx_HistoryMax", Yxx_HistoryMax = (_dec = ccclass('Yxx_HistoryMax'), _dec(_class = class Yxx_HistoryMax extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        createResult(result, index, isAdd) {
          if (isAdd === void 0) {
            isAdd = false;
          }
          ...
          var resultListNode = groupNode.getChildByName("result_list");
        ...
        collectResultCount(result) {
          ...
          var counts = new Array(7).fill(0).map(() => 0);
...
//# sourceMappingURL=24e031797417e01768c808ffa083999cdb4e0283.js.map