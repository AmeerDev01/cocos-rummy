System.register(["__unresolved_0", "cc", "__unresolved_1", "redux-act", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dfe5cFtnHFNDLK+1TMYhqHk", "roller", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_BEGIN_ROLL]: (state, payload) => {
          var rollerMap = (_crd && copy === void 0 ? (_reportPossibleCrUseOfcopy({
            error: Error()
          }), copy) : copy)(state.rollerMap);

          if (payload.rollerIndex !== -1) {
            var rollData = rollerMap[payload.rollerIndex];
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_INIT_ROLL]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_SET_STOP_ROLL]: (state, payload) => {
          var rollerMap = (_crd && copy === void 0 ? (_reportPossibleCrUseOfcopy({
            error: Error()
          }), copy) : copy)(state.rollerMap);
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_END_ROLLING]: (state, payload) => {
          var rollerMap = (_crd && copy === void 0 ? (_reportPossibleCrUseOfcopy({
            error: Error()
          }), copy) : copy)(state.rollerMap);
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_SET_FLICKER]: (state, payload) => {
          return _extends({}, state, {
            iconEffectData: {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_SET_ROUNT_END]: (state, payload) => {
          return _extends({}, state, {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_SET_ROLL_SMALLBOX]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).STARLIGHT_SET_ROLL_SPEED]: (state, payload) => {
          var rollerMap = (_crd && copy === void 0 ? (_reportPossibleCrUseOfcopy({
            error: Error()
          }), copy) : copy)(state.rollerMap);
...
//# sourceMappingURL=75f9febbc9d1c0f9354431d1f5b3e0b246e976a7.js.map