System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Toggle, Button, BaseComponent, EffectType, getEffectByType, changeAutoLauncherType, setShowAuthLaunch, AutoLauncherType, setRollSpeed, _dec, _class, _crd, ccclass, property, Starlight_AuthLauncher;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1a1f9AtZyVGtpMf9CWsrzuS", "Starlight_AuthLauncher", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Node', 'Animation', 'ToggleContainer', 'Toggle', 'Button']);
      ...
      _export("Starlight_AuthLauncher", Starlight_AuthLauncher = (_dec = ccclass('Starlight_AuthLauncher'), _dec(_class = class Starlight_AuthLauncher extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
...
//# sourceMappingURL=af387bb6a676b04ed5d76d5a49b6b6e534d49d16.js.map