        ...
        begin() {
          this.setEvent({
            rotaryStarting: (type, data) => {
              ...
              if (type == 2) {
                var _givePanel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                  error: Error()
                  ...
                  onClosePanel: () => {
                    _givePanel.unMount((_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                      error: Error()
                    }), EffectType) : EffectType).EFFECT2);
                  },
                  setCount: num => {
...
//# sourceMappingURL=16d6c63e558f161d5b19b16807691a812c523c06.js.map