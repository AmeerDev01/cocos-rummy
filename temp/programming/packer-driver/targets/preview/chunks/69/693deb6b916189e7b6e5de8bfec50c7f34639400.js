      ...
      _export("Hall_Upgrade", Hall_Upgrade = (_dec = ccclass('Hall_Upgrade'), _dec(_class = class Hall_Upgrade extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_btn_sure.node.on(Node.EventType.TOUCH_END, () => {
            var memberName = this.propertyNode.props_intput_akun.string.trim();
            var password = this.propertyNode.props_intput_sandi.string.trim();
            var password_re = this.propertyNode.props_intput_kSandi.string.trim();
...
//# sourceMappingURL=693deb6b916189e7b6e5de8bfec50c7f34639400.js.map