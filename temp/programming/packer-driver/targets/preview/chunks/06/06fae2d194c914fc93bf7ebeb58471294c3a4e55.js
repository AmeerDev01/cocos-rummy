      ...
      _export("Hall_GiftBag", Hall_GiftBag = (_dec = ccclass('Hall_GiftBag'), _dec(_class = class Hall_GiftBag extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_btn_left.on(Node.EventType.TOUCH_END, () => {
            var index = this.propertyNode.props_PageView_gift_bag.getCurrentPageIndex();
          ...
          this.propertyNode.props_btn_right.on(Node.EventType.TOUCH_END, () => {
            ...
            var count = this.propertyNode.props_PageView_gift_bag.content.children.filter(i => i.active).length;
            var index = this.propertyNode.props_PageView_gift_bag.getCurrentPageIndex();
        ...
        bindUI() {
          ...
          this.useState((key, value) => {
            ...
            this.state.giftList.filter(i => i.separatePage === 1).forEach((item, index) => {
              var node = instantiate(this.propertyNode.props_page_template_item);
        ...
        updateCountdownLabel(timeLabel, targetDate) {
          ...
          var times = (targetDate.getTime() - currentDate.getTime()) / 1000; // times是剩余时间总的秒数

          var h = parseInt(times / 60 / 60 + ''); //时

          var remainHours = h < 10 ? '0' + h : h;
          var m = parseInt(times / 60 % 60 + ''); //分

          var remainMinutes = m < 10 ? '0' + m : m;
          var s = parseInt(times % 60 + ''); // 秒

          var remainSeconds = s < 10 ? '0' + s : s;
          var remainTimeStr = remainHours + ":" + remainMinutes + ":" + remainSeconds;
...
//# sourceMappingURL=06fae2d194c914fc93bf7ebeb58471294c3a4e55.js.map