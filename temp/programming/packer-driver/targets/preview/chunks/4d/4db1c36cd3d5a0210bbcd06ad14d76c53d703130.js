        ...
        listenerUserJoinOrQuit() {
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            if (data.gameType === (_crd && GameStatus === void 0 ? (_reportPossibleCrUseOfGameStatus({
              ...
              ;
              var cardRoll = cardViewModel.comp.getPropertyNode().props_note_card_roll;
              var cardBack = cardViewModel.comp.getPropertyNode().props_node_card_back;
              ...
              if (data.newQiuQiuLotteryVo.greenType) {
                _greenType = data.newQiuQiuLotteryVo.greenType;
              } else {
                _greenType = 0;
              }

              if (data.newQiuQiuLotteryVo.blueType) {
                _blueType = data.newQiuQiuLotteryVo.blueType;
              } else {
                _blueType = 0;
              }

              if (data.newQiuQiuLotteryVo.redType) {
                _redType = data.newQiuQiuLotteryVo.redType;
              } else {
                _redType = 0;
              }

              var _cardType = {
                greenType: _greenType,
                blueType: _blueType,
                redType: _redType
              };
              this.dispatch((_crd && changeTwinNumAction === void 0 ? (_reportPossibleCrUseOfchangeTwinNumAction({
                error: Error()
              }), changeTwinNumAction) : changeTwinNumAction)(_twinNum));
              cardViewModel.comp.playWinBg(_twinNum, _cardType);
              betAreaViewModel.comp.playWinAnimation(data.newQiuQiuLotteryVo.winType);
              this.dispatch((_crd && changeCardTypeAction === void 0 ? (_reportPossibleCrUseOfchangeCardTypeAction({
                error: Error()
              }), changeCardTypeAction) : changeCardTypeAction)(_cardType));
            } else if (data.gameType === (_crd && GameStatus === void 0 ? (_reportPossibleCrUseOfGameStatus({
              error: Error()
...
//# sourceMappingURL=4db1c36cd3d5a0210bbcd06ad14d76c53d703130.js.map