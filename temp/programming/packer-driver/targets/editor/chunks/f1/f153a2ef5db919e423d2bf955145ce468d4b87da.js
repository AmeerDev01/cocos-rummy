      ...
      RoomChooseViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        clickEnterGame(roomInfo) {
          ...
          if (roomInfo.lower <= gold && gold <= (_crd && getRoomUpper === void 0 ? (_reportPossibleCrUseOfgetRoomUpper({
            ...
            if (!roomInfo) {
              let content = (_crd && lang === void 0 ? (_reportPossibleCrUseOflang({
                error: Error()
        ...
        enterGame(data) {
          ...
          const onComplate = () => {
            data.list.forEach(item => {
              ...
              const player = (_crd && genPlayer === void 0 ? (_reportPossibleCrUseOfgenPlayer({
                error: Error()
        ...
        reconnectHandle(data) {
          ...
          selfPlayer.tableId = data.tableId;
          let deskStatus = this.convertDeskStatus(data.gameStage); // 发牌数量
...
//# sourceMappingURL=f153a2ef5db919e423d2bf955145ce468d4b87da.js.map