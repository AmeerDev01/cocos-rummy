        ...
        useProps(key, value) {
          ...
          if (key === "iconEffect") {
            ...
            if (isActive) {
              ...
              const t = tween(uiOpacity).to(0.4, {
                opacity: 255
              }).to(0.4, {
                opacity: 0
              });
          ...
          if (key === "iconFreeGameEffect") {
            ...
            iconNodeSprite.getComponent(sp.Skeleton).updateRenderer(); // iconNodeSprite.getComponent(sp.Skeleton).skeletonData = sourceManageSeletor().getFile(SkeletalPathDefine.TUBIAO_SKELETON).source;
...
//# sourceMappingURL=e0e7785a822a00eae9e4675f8264b698e6d069fc.js.map