    ...
    execute: function () {
      ...
      _export("PhoenixV2_Roller", PhoenixV2_Roller = (_dec = ccclass('PhoenixV2_Roller'), _dec(_class = class PhoenixV2_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        playYuanBaoWinIcon(index) {
          ...
          this.scheduleOnce(() => {
            if (this.node.isValid) {
              const icon = this.iconArr[index]; // 如果是元宝第1列 第5列中奖
        ...
        playOneScatterAnimation() {
          ...
          for (let i = 0; i < this.showIconCount; i++) {
            const element = this.iconArr[i]; // const freeGame = cacheData.rollerLaunchResult && cacheData.rollerLaunchResult.dl.si[0].freeGame;
        ...
        playOneYuanBaoAnimation(isWin = false) {
          for (let i = 0; i < this.showIconCount; i++) {
            const element = this.iconArr[i];
        ...
        getWildLiZiNode() {
          const amountNodes = [];
          const nodes = []; // console.log(" this.iconArr111", this.iconArr);
          // console.log("this.columnIndex111",this.columnIndex);

          for (let i = 0; i < this.showIconCount; i++) {
            const element = this.iconArr[i];
            const isWinIcon = this.isWinIconPhoenix((_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
              error: Error()
        ...
        isWinIconPhoenix(rollerLaunchResult, index) {
          const wp = rollerLaunchResult && rollerLaunchResult.dl.si[0].winningPosition; // console.log("phoenixCount111",rollerLaunchResult.dl.si[0].otherGameAttributesVo.phoenixCount);

          const result = []; // let iconIndexs;
        ...
        getYuanBaoYinBiNode() {
          ...
          for (let i = 0; i < this.showIconCount; i++) {
            ...
            if (element.getId() === (_crd && IconId === void 0 ? (_reportPossibleCrUseOfIconId({
              ...
              const yinBINode = element.getYinBiNode(); // console.log("yinBINode",yinBINode);
              ...
              const isYuanBaoWinIcon = this.isYuanBaoWinIcon((_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
                error: Error()
...
//# sourceMappingURL=cca0207efb2dbf82372346b0b252eff27940551f.js.map