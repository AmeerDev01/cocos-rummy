    ...
    execute: function () {
      ...
      Hot = class Hot {
        ...
        _onUpdateFinished() {
          ...
          let searchPaths = native.fileUtils.getSearchPaths(); // this.log.string += "=>searchPaths2:" +searchPaths

          let newPaths = this._assetsMgr.getLocalManifest().getSearchPaths(); // this.log.string += "=>newPaths:" + newPaths
        ...
        init(manifest, opt) {
          ...
          let localManifest = this._assetsMgr.getLocalManifest(); // log.string += "showSearchPath--"
...
//# sourceMappingURL=ad5671ebe0cf1a18045255a3b8f28c48d6b04c15.js.map