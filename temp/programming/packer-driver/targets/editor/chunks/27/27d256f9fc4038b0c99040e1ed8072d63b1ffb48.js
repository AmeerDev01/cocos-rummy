System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ViewModel, StoreInject, getStore, AutoLauncherType, GameType, footerViewModel, changeAutoLauncherType, setAutoLaunchedTimes, setShowAuthLaunch, dataTransfer, DataKeyType, setRollSpeed, _dec, _class, _crd, autoLauncherTypeWithTimes, AutoLauncherViewModel;
  ...
  function _reportPossibleCrUseOfStarlight_AuthLauncher(extras) {
    _reporterNs.report("Starlight_AuthLauncher", "../components/Starlight_AuthLauncher", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/Starlight_AuthLauncher", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/Starlight_AuthLauncher", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      changeAutoLauncherType = _unresolved_6.changeAutoLauncherType;
      setAutoLaunchedTimes = _unresolved_6.setAutoLaunchedTimes;
      setShowAuthLaunch = _unresolved_6.setShowAuthLaunch;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f0052Ao+y9Ly6E7WZUWIaY2", "AutoLauncherViewModel", undefined);
      ...
      _export("autoLauncherTypeWithTimes", autoLauncherTypeWithTimes = {
        ...
        [(_crd && AutoLauncherType === void 0 ? (_reportPossibleCrUseOfAutoLauncherType({
          error: Error()
        }), AutoLauncherType) : AutoLauncherType).LAMIT_FAST]: 10000,
        [(_crd && AutoLauncherType === void 0 ? (_reportPossibleCrUseOfAutoLauncherType({
          error: Error()
      ...
      AutoLauncherViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          (_crd && footerViewModel === void 0 ? (_reportPossibleCrUseOffooterViewModel({
            error: Error()
          }), footerViewModel) : footerViewModel).comp.schedule(() => {
...
//# sourceMappingURL=27d256f9fc4038b0c99040e1ed8072d63b1ffb48.js.map