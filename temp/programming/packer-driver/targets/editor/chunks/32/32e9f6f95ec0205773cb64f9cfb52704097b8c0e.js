System.register(["__unresolved_0", "cc", "__unresolved_1", "redux-act", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "68a6buC6a5EPZcYQ7kqIcrG", "roller", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_BEGIN_ROLL]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_INIT_ROLL]: (state, payload) => {
          // const _state = instantiate(state)
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_SET_STOP_ROLL]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_END_ROLLING]: (state, payload) => {
          // const _state = instantiate(state)
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_SET_FLICKER]: (state, payload) => {
          return { ...state,
            iconEffectData: {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_SET_ROUNT_END]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_SET_ROLL_SPEED]: (state, payload) => {
          const _state = instantiate(state);
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_SET_YUANBAO_FLICKER]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DFDC_SET_FREEGAME_FLICKER]: (state, payload) => {
          return { ...state,
...
//# sourceMappingURL=32e9f6f95ec0205773cb64f9cfb52704097b8c0e.js.map