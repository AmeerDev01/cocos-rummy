System.register(["__unresolved_0", "cc", "redux-act", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "06fb5ya8pZFyYqfTTkYDA7V", "roller", undefined);
      ...
      _export("ActionTypes", ActionTypes = /*#__PURE__*/function (ActionTypes) {
        ActionTypes["GODWEALTHV2_UPDATE_ROLLER_STATUS"] = "GODWEALTHV2_UPDATE_ROLLER_STATUS";
        ActionTypes["GODWEALTHV2_UPDATE_SPEED_STATUS"] = "GODWEALTHV2_UPDATE_SPEED_STATUS";
        ActionTypes["GODWEALTHV2_INIT_ROLLER"] = "GODWEALTHV2_INIT_ROLLER";
        return ActionTypes;
      }({}));
      /**定义action的payLoad类型 */
      ...
      _export("updateRollerStatus", updateRollerStatus = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.GODWEALTHV2_UPDATE_ROLLER_STATUS, rollerStatus => {
        return {
          rollerStatus
        };
      }));
      ...
      _export("updateSpeedStatus", updateSpeedStatus = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.GODWEALTHV2_UPDATE_SPEED_STATUS, isSpeed => {
        return {
          isSpeed
        };
      }));
      ...
      _export("initRoller", initRoller = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.GODWEALTHV2_INIT_ROLLER, () => {
        return {
          initState
        };
      }));
...
//# sourceMappingURL=be87f83252f56f114a1b6c0e6acafecf1a0acd2a.js.map