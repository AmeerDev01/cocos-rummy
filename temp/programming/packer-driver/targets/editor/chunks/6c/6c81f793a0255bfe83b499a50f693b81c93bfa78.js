System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Color, Label, Node, Toggle, BaseComponent, setAutoLauncherInfo, setBetDropDownList, updateDialogInfo, updatePositionId, updateSubGameAnimationPlayInfo, updateRollerStatus, updateSpeedStatus, AutoLauncherType, calBetAmount, DialogType, GameType, isAuto, RollerStatus, config, StepNumber, cacheData, phoenixV2_Audio, mainViewModel, SoundPathDefine, StepNumberV2, global, _dec, _class, _crd, ccclass, property, PhoenixV2_Footer;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5ef6aoOkyNGjYvpXwupZu5G", "PhoenixV2_Footer", undefined);
      ...
      _export("PhoenixV2_Footer", PhoenixV2_Footer = (_dec = ccclass('PhoenixV2_Footer'), _dec(_class = class PhoenixV2_Footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        updateStartButtonAutoType() {
          ...
          if (!this.isMain()) {
            ...
            stopBgNode.active = false; // props_sg_free.active=true;
        ...
        bindUI() {
          ...
          (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
          }), mainViewModel) : mainViewModel).setFreeNumPos(this.node.parent.getChildByName('props_sg_free').worldPosition);
        }
        ...
        getStartBtnNode() {
          return this.propertyNode.props_startButton;
        }
...
//# sourceMappingURL=6c81f793a0255bfe83b499a50f693b81c93bfa78.js.map