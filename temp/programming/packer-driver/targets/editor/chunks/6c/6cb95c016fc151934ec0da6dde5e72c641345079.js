System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfEgyptV2RollerViewModel(extras) {
    _reporterNs.report("EgyptV2RollerViewModel", "../viewModel/EgyptV2RollerViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EgyptV2RollerViewModel = _unresolved_5.default;
      ...
      egyptv2_Audio = _unresolved_10.egyptv2_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "28f99WBPgRDIZz75NxEoYDo", "EgyptV2_RollerPanel", undefined);
      ...
      _export("EgyptV2_RollerPanel", EgyptV2_RollerPanel = (_dec = ccclass('EgyptV2_RollerPanel'), _dec(_class = class EgyptV2_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        initRoller() {
          for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            const roller = new (_crd && EgyptV2RollerViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2RollerViewModel({
              error: Error()
            }), EgyptV2RollerViewModel) : EgyptV2RollerViewModel)().mountViewNode(column).appendTo(this.propertyNode.props_column_list).connect();
        ...
        startRoll() {
          ...
          const isMainGame = this.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).MAIN;
        ...
        stopRollAll(isManualStop = false, sendBetTime, rollerLaunchResult) {
          if (this.inStop) {
            return;
          }
        ...
        rollEndHandle(rollerLaunchResult) {
          ...
          const winLine = this.startPlayWinIcon((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).normalRollOption.winIconFlickerTime, () => {}, rollerLaunchResult); // 最开始就看是否有太阳神图标
        ...
        checkNextLeftCount() {
          const nextLeftCount = this.props.gameTypeInfo.nextLeftCount; // 在转动结束之后如果发现下一局的剩余局数有值，就变更一次

          if (this.isSubGame2() && nextLeftCount >= 0) {
            this.dispatch((_crd && changeGame === void 0 ? (_reportPossibleCrUseOfchangeGame({
              error: Error()
            }), changeGame) : changeGame)({ ...this.props.gameTypeInfo,
        ...
        playWinAudio() {
          if (this.isWinWild()) {
            (_crd && egyptv2_Audio === void 0 ? (_reportPossibleCrUseOfegyptv2_Audio({
              ...
              error: Error()
            }), SoundPathDefine) : SoundPathDefine).wild);
          } else {
            (_crd && egyptv2_Audio === void 0 ? (_reportPossibleCrUseOfegyptv2_Audio({
              error: Error()
            }), egyptv2_Audio) : egyptv2_Audio).playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
              error: Error()
            }), SoundPathDefine) : SoundPathDefine).haveCoin);
          }
        }

        updateWinloss(rollerLaunchResult) {
          const si = rollerLaunchResult.dl.si[0]; // 本局输赢
        ...
        playBigWinHandle(bigWinConfig, auto, isSubGameLastPoint, rollerLaunchResult) {
          ...
          let isEnterSubGame2 = false; // 进入小游戏2时不播放大奖
            ...
            if (this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
              ...
              if (this.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
                ...
                this.playBeeteFlyAmount(() => {
                  this.updateWinloss(rollerLaunchResult); // 飞完之后间隔1秒再继续
        ...
        playBeetleAnimation(isSubGameLastPoint, rollerLaunchResult) {
          let count = 0;
        ...
        playBeeteFlyAmount(done) {
          ...
          const endPos = this.node.parent.getComponent(UITransform).convertToNodeSpaceAR((_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
        ...
        playBeeteFlyAmountToSunGod(done) {
          if (!this.isSubGame2()) {
            done && done();
            return;
          }

          let sunGodIcons = this.getWinSunGodIconNode();
        ...
        eachSunGodIcon(index, sunGodIcons, done) {
          ...
          this.playAmountToSunGodCourse(nodes, sunGodIcon, 0, (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).subGameRollOption.beetleFlyTime, endPos, () => {
            index++;
        ...
        playAmountToSunGodCourse(nodes, sunGoldIcon, index, beetleFlyTime, endPos, done) {
          ...
          this.node.parent.addChild(cloneNode);
          cloneNode.setPosition(startPos); // 播放音效

          (_crd && egyptv2_Audio === void 0 ? (_reportPossibleCrUseOfegyptv2_Audio({
            error: Error()
          }), egyptv2_Audio) : egyptv2_Audio).playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
            error: Error()
          }), SoundPathDefine) : SoundPathDefine).sunGodNum);
          tween(cloneNode).to(beetleFlyTime, {
            position: endPos
          }).call(() => {
            cloneNode.destroy();
        ...
        playParticle2D(startPos, endPos, parentNode) {
          const particleNode = instantiate((_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
        ...
        stopRoll(i, callBack, rollerLaunchResult) {
          ...
          const rollerComp = this.rollerViewModelArr[i]; // const stopIconIndex = Math.floor(Math.random() * config.iconRollerQueue[i].length);
          // 获得停下来的数据

          const stopIconIndex = rollerLaunchResult.dl.si[0].rollerId[i];
          const scatterCount = this.getScatterCount(i, rollerLaunchResult); // 下一个列是否有边框

          const nextColmunIsBorder = this.getScatterCount(i + 1, rollerLaunchResult) >= 2; // console.log("scatterCount", scatterCount, i, stopIconIndex);
        ...
        getScatterCount(endColumnIndex, rollerLaunchResult) {
          ...
          for (let i = 0; i < endColumnIndex; i++) {
            let iconIndex = rollerId[i];
            const queue = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
            }), config) : config).iconRollerQueue[i];

            for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
            }), config) : config).normalRollOption.showIconCount; i++) {
...
//# sourceMappingURL=6cb95c016fc151934ec0da6dde5e72c641345079.js.map