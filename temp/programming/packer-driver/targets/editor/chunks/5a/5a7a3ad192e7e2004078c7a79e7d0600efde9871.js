      ...
      _export("PhoenixV2_RollerPanel", PhoenixV2_RollerPanel = (_dec = ccclass('PhoenixV2_RollerPanel'), _dec(_class = class PhoenixV2_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initRoller() {
          for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            const roller = new (_crd && PhoenixV2RollerViewModel === void 0 ? (_reportPossibleCrUseOfPhoenixV2RollerViewModel({
              error: Error()
        ...
        rollEndHandle(rollerLaunchResult) {
          ...
          let winLine = 0;
          let yuanBaoLine = this.showYuanBaoIcon((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
        ...
        updateWinloss(rollerLaunchResult, amount) {
          const si = rollerLaunchResult && rollerLaunchResult.dl.si[0]; // 本局输赢
        ...
        playWildAnimation(done) {
          ...
          if (amountNodes.length > 0) {
            amountNodes.forEach((n, i) => {
              ...
              let count = 0; // const skeletonPlayer = new SkeletonAnimationPlayer(skeleton, "animation", true, () => { 
              // 	count++
              // 	if (count >= 2) {
        ...
        executeWinIcon(index, lines, wp, linePlayTime, done) {
          ...
          const labelNode = (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
...
//# sourceMappingURL=5a7a3ad192e7e2004078c7a79e7d0600efde9871.js.map