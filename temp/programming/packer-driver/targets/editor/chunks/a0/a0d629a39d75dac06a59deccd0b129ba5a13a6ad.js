System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Toggle, BaseComponent, UseSetOption, bandar_Audio, playBtnClick, playMainBg, _dec, _class, _crd, ccclass, property, Bandar_set;
  ...
  function _reportPossibleCrUseOfbandar_Audio(extras) {
    _reporterNs.report("bandar_Audio", "../index", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      bandar_Audio = _unresolved_4.bandar_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ff2503AP/pNdKZj2ItvCU3A", "Bandar_set", undefined);
      ...
      _export("Bandar_set", Bandar_set = (_dec = ccclass('Bandar_set'), _dec(_class = class Bandar_set extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        bindEvent() {
          ...
          this.propertyNode.props_toggle_music.on('toggle', toggle => {
            ...
            toggle.target.getComponent(Toggle).isChecked ? (_crd && playMainBg === void 0 ? (_reportPossibleCrUseOfplayMainBg({
              error: Error()
            }), playMainBg) : playMainBg)() : (_crd && bandar_Audio === void 0 ? (_reportPossibleCrUseOfbandar_Audio({
              error: Error()
            }), bandar_Audio) : bandar_Audio).pause();
          }, this);
...
//# sourceMappingURL=a0d629a39d75dac06a59deccd0b129ba5a13a6ad.js.map