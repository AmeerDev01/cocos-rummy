System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20", "__unresolved_21", "__unresolved_22", "__unresolved_23", "__unresolved_24", "__unresolved_25"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      changeAnimationStatus = _unresolved_12.changeAnimationStatus;
      ...
      GameBoardViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          ...
          this.setEvent({
            ...
            changeAnimationStatus: animationStatus => {
              this.dispatch((_crd && changeAnimationStatus === void 0 ? (_reportPossibleCrUseOfchangeAnimationStatus({
                error: Error()
              }), changeAnimationStatus) : changeAnimationStatus)(animationStatus));
            },
        ...
        listenerUserJoinOrQuit() {
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            const myHead = (_crd && convertHeadType === void 0 ? (_reportPossibleCrUseOfconvertHeadType({
              error: Error()
            ...
            const results = data.results.map(v => (_crd && convertResult === void 0 ? (_reportPossibleCrUseOfconvertResult({
              error: Error()
            }), convertResult) : convertResult)(v));
            const gameType = (_crd && convertGameStatus === void 0 ? (_reportPossibleCrUseOfconvertGameStatus({
              error: Error()
            }), convertGameStatus) : convertGameStatus)(data.gameType);
            const isNotBet = (_crd && GameStatus === void 0 ? (_reportPossibleCrUseOfGameStatus({
              error: Error()
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            this.dispatch((_crd && changeAnimationStatus === void 0 ? (_reportPossibleCrUseOfchangeAnimationStatus({
              error: Error()
            }), changeAnimationStatus) : changeAnimationStatus)((_crd && AnimationStatus === void 0 ? (_reportPossibleCrUseOfAnimationStatus({
              error: Error()
        ...
        genSeats() {
          const seatNumber = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
        ...
        refactorSeat() {
          const myHead = this.comp.props.myHead; // 默认是在旁观位置
        ...
        listenerBet() {
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            const betType = (_crd && convertBetType === void 0 ? (_reportPossibleCrUseOfconvertBetType({
              error: Error()
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            const seats = this.comp.props.seats.filter(v => v.userId === data.receiveMemberId); // 如果展示座位上有两个相同人，就同时送两次
...
//# sourceMappingURL=43e5cfef3fefb563bdb955da09205235fe9281f3.js.map