      ...
      _export("ThorV2_Main", ThorV2_Main = (_dec = ccclass('ThorV2_Main'), _dec(_class = class ThorV2_Main extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_btn_rate.on(Button.EventType.CLICK, () => {
            const gameModeType = this.props.gameModeType === (_crd && GameModeType === void 0 ? (_reportPossibleCrUseOfGameModeType({
              error: Error()
        ...
        updateEndStatus(isUpdateGold = true) {
        ...
        addWinIconItem() {
          ...
          if (iconConfig.smallName) {
            const spriteFrame = (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              error: Error()
        ...
        updateWinloss(value, done = undefined) {
        ...
        showOrHideNode(nodePanel, isShow, hideOp = 0) {
        ...
        updateFreeAmount() {
          ...
          let betAmount = (_crd && calBetAmount === void 0 ? (_reportPossibleCrUseOfcalBetAmount({
            error: Error()
        ...
        updateGameModeType(value) {
          ...
          const isWin = value.cur === (_crd && GameModeType === void 0 ? (_reportPossibleCrUseOfGameModeType({
            error: Error()
          }), GameModeType) : GameModeType).buyToWin;
        ...
        changeRollerStatusHandle() {
          const disable = this.props.rollerStatus !== (_crd && RollerStatus === void 0 ? (_reportPossibleCrUseOfRollerStatus({
            error: Error()
          }), RollerStatus) : RollerStatus).END;
          const isDisableBuyMini = disable || this.props.gameModeType === (_crd && GameModeType === void 0 ? (_reportPossibleCrUseOfGameModeType({
            error: Error()
          }), GameModeType) : GameModeType).buyToWin;
...
//# sourceMappingURL=433f3d263c0c4f0e2e7f691c14d2b71ecda4e796.js.map