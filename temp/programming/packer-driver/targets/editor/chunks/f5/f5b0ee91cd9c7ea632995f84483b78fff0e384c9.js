System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, Animation, BaseComponent, global, BuyType, StepNumber, godWealthV2_Audio, mainViewModel, SoundPathDefine, StepNumberV2, _dec, _class, _crd, ccclass, property, GodWealthV2_Header;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      godWealthV2_Audio = _unresolved_6.godWealthV2_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "50dc32BRdtOTqBR+gQHb3so", "GodWealthV2_Header", undefined);

      __checkObsolete__(['_decorator', 'EventTouch', 'Label', 'Node', 'Animation']);
      ...
      _export("GodWealthV2_Header", GodWealthV2_Header = (_dec = ccclass('GodWealthV2_Header'), _dec(_class = class GodWealthV2_Header extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
          ...
          if (this.node && this.node.isValid) {
            if (key === 'gold') {
              if (this.init) {
                ...
                const stepNumber = new (_crd && StepNumber === void 0 ? (_reportPossibleCrUseOfStepNumber({
                  error: Error()
...
//# sourceMappingURL=f5b0ee91cd9c7ea632995f84483b78fff0e384c9.js.map