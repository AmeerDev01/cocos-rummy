        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              const rollerComp = this.wrapView.getChildByName("slotListPanel").getComponent("dragon_RollerPanel");
            ...
            handler(notification) {
              const dragon_SlotPanel = this.wrapView.getComponent("dragon_SlotPanel");
            ...
            handler(notification) {
              ...
              if (this.wrapView && this.wrapView.components) {
                ...
                const slotPanel = (_this$wrapView = this.wrapView) == null ? void 0 : _this$wrapView.getComponent("dragon_SlotPanel");
            ...
            handler(notification) {
              ...
              setTimeout(() => {
                const rollerComp = this.wrapView.getComponent(_crd && dragon_SlotPanel === void 0 ? (_reportPossibleCrUseOfdragon_SlotPanel({
                  error: Error()
...
//# sourceMappingURL=37e23fddd251cc65affed627d2d15fbd3b9eb06a.js.map