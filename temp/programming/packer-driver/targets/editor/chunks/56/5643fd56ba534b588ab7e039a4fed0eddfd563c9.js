    ...
    execute: function () {
      ...
      _export("default", RollerMediator = class RollerMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              const rollerComp = this.wrapView.getChildByName("slotListPanel").getComponent("GodWealth_RollerPanel");
            ...
            handler(notification) {
              ...
              if (this.wrapView && this.wrapView.components) {
                ...
                const slotPanel = (_this$wrapView = this.wrapView) == null ? void 0 : _this$wrapView.getComponent("GodWealth_SlotPanel");
            ...
            handler(notification) {
              ...
              if (this.wrapView && this.wrapView.components) {
                ...
                const slotPanel = (_this$wrapView2 = this.wrapView) == null ? void 0 : _this$wrapView2.getComponent("GodWealth_SlotPanel");
        ...
        listenerEvent() {
          ...
          const slotPanel = (_this$wrapView3 = this.wrapView) == null ? void 0 : _this$wrapView3.getComponent("GodWealth_SlotPanel");
...
//# sourceMappingURL=5643fd56ba534b588ab7e039a4fed0eddfd563c9.js.map