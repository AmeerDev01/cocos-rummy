  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", Crash_HttpManager = class Crash_HttpManager {
        ...
        send(protocol, args) {
          let timeOut = (_crd && Crash_GameConfig === void 0 ? (_reportPossibleCrUseOfCrash_GameConfig({
            error: Error()
        ...
        httpSend(protocol, timeOut, args) {
          ...
          let xhr = new XMLHttpRequest(); // let token: string = DataManager.getInstance().getUserInfo().getToken() || "";
...
//# sourceMappingURL=ab8d8bf147e1bf86e39b7f5d15fca33ee7db098a.js.map