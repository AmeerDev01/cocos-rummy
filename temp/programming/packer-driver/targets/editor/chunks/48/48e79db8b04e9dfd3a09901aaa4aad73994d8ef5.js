    ...
    execute: function () {
      ...
      _export("Domino_MainBoard", Domino_MainBoard = (_dec = ccclass('Domino_MainBoard'), _dec(_class = class Domino_MainBoard extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        beginDistributeCards() {
          ...
          const cardPanelNode = instantiate((_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
        ...
        flyCard(cardPanelNode, cardNode, endPostiton, seatIndex) {
          ...
          const duration = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).dealAnimeSpeed;
        ...
        addCard(cardItem, symbol, isOutline, isHide = true) {
          let lastViews = symbol < 0 ? this.rightViews : this.leftViews;
          let lastView = symbol < 0 ? this.rightLastCardView : this.leftLastCardView;
          let x = 0;
          let y = 0;
          let cardPosition = cardItem.upFace === cardItem.downFace ? (_crd && CardPosition === void 0 ? (_reportPossibleCrUseOfCardPosition({
            error: Error()
          ...
          let cellCount = 0; // 纵向结束格子数

          let vericalEndCellCount = 0; // 第二行格子数

          let secondLineCellCount = 0; // 是否拐弯处
          ...
          const prefabPath = (_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          ...
          if (this.middleCardView) {
            ...
            if (lastView) {
              ...
              let xOffset = -(laseWidth / 2 + cardWidth / 2) * symbol; // 拐弯之后的y与纵向对齐
        ...
        moveOutCardArea(y, isAnima = true) {
        ...
        calCellCount(views, startIndex, endIndex = 0) {
        ...
        getMidVerticalPoint(fromPos, toPos, offsetAngin = 0) {
          ...
          let angle = 90 - this.calAngle(fromPos, toPos); // 把偏移的角度换算成弧度
...
//# sourceMappingURL=48e79db8b04e9dfd3a09901aaa4aad73994d8ef5.js.map