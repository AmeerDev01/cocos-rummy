      ...
      _export("GxfcV2_RollerPanel", GxfcV2_RollerPanel = (_dec = ccclass('GxfcV2_RollerPanel'), _dec(_class = class GxfcV2_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initRoller() {
          for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            const roller = new (_crd && GxfcV2RollerViewModel === void 0 ? (_reportPossibleCrUseOfGxfcV2RollerViewModel({
              error: Error()
        ...
        endRoll(sendBetTime) {
          ...
          this.scheduleOnce(() => {
            ...
            if (!(_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
              ...
              const ColumnIndex = (_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
                error: Error()
        ...
        rollEndHandle(rollerLaunchResult) {
          ...
          let winLine; // 最开始就看是否需要延展金wild同列图标，播放动画
        ...
        playJinFaAnimation(rollerLaunchResult, done) {
          ...
          const freeWildRollerId = rollerLaunchResult.dl.si[0].freeWildRollerId;
          let count = 0;
        ...
        stopWildRoll(i, callBack, rollerLaunchResult) {
          ...
          // const time = this.getIsSpeed() ? 0 : 0.2;
          // // const isEnd = i >= this.rollerViewModelArr.length - 1;
          const rollerComp = this.rollerViewModelArr[i]; // // 获得停下来的数据

          const stopIconIndex = rollerLaunchResult.dl.si[0].rollerId[i]; // const scatterCount = this.getScatterCount(i, rollerLaunchResult);
          // // 下一个列是否有边框
        ...
        executeWinIcon(index, lines, wp, linePlayTime, done) {
          ...
          let winIconArr = []; // console.log("index",index);
          ...
          winIconArr.forEach(v => {
            ...
            const wildRollerId = (_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
              error: Error()
            }), cacheData) : cacheData).rollerLaunchResult.dl.si[0].freeWildRollerId;
...
//# sourceMappingURL=124b5762a72cabc4a2167d6590941e9443002e3b.js.map