    ...
    execute: function () {
      ...
      _export("FishLabelFntManager", FishLabelFntManager = class FishLabelFntManager {
        ...
        play(spos, number, id, mul) {
          let fObj = this.objectPool.getObject((_crd && ObjectClassType === void 0 ? (_reportPossibleCrUseOfObjectClassType({
            error: Error()
...
//# sourceMappingURL=05f7dbfb430975f79f7b917d9a68de04b9ddef87.js.map