  ...
  return {
    ...
    execute: function () {
      ...
      _export("Hall_Baseboard", Hall_Baseboard = (_dec = ccclass('Hall_Baseboard'), _dec(_class = class Hall_Baseboard extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        closeSubGame(isPre = false) {
          if (!this.props.openGameInfo) return;
          this.openGameId = 0;
          const gameId = this.props.openGameInfo.gameId; // effect1(this.propertyNode.props_subGameBoard).out(false).then(() => { })
        ...
        addToast(toastObj) {
          ...
          const props_toast = instantiate(toastObj.type === (_crd && ToastType === void 0 ? (_reportPossibleCrUseOfToastType({
            error: Error()
...
//# sourceMappingURL=c6485f960e875419d929d3bd3bb5faa7a1eccf18.js.map