      ...
      _export("default", Guide = class Guide {
        ...
        creatorBg() {
          return new Promise((resovle, reject) => {
            (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              ...
              error: Error()
            }), PrefabPathDefine) : PrefabPathDefine)._GUIDE_PANEL, Prefab).then(({
              source
            }) => {
        ...
        begin() {
          this.creatorBg().then(bgNode => {
            ...
            const position = (_crd && getNodePositionInCanvas === void 0 ? (_reportPossibleCrUseOfgetNodePositionInCanvas({
              error: Error()
...
//# sourceMappingURL=84294d63343319395f667770f0707f3d9c0faf71.js.map