System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, tween, UIOpacity, Vec3, BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, DialogType, Egypt_DialogWin;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "73051u+fsFG2osjaba6XYE8", "Egypt_DialogWin", undefined);
      ...
      _export("Egypt_DialogWin", Egypt_DialogWin = (_dec = ccclass('Egypt_DialogWin'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class Egypt_DialogWin extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
...
//# sourceMappingURL=44c675c104edcd0807e36276114e0055de8c3d17.js.map