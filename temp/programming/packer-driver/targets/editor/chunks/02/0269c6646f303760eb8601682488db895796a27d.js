System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, bandar_Audio, mainGameViewModel, startUp, removeInstance, global, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      bandar_Audio = _unresolved_2.bandar_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e9cbdGnOxFH6YkaHYpsxZvG", "StartUp", undefined);
      ...
      _export("default", boardNode => {
        ...
        return () => {
          if (!(_crd && mainGameViewModel === void 0 ? (_reportPossibleCrUseOfmainGameViewModel({
            ...
            (_crd && bandar_Audio === void 0 ? (_reportPossibleCrUseOfbandar_Audio({
              error: Error()
...
//# sourceMappingURL=0269c6646f303760eb8601682488db895796a27d.js.map