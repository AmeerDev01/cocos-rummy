      ...
      _export("Bandar_card_user", Bandar_card_user = (_dec = ccclass('Bandar_card_user'), _dec(_class = class Bandar_card_user extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          ...
          if (key === "heartNum") {
            if (value.cur && Object.keys(value.cur).length != 0) {
              ...
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_usercard_type", this.userCard[1]).getComponent(Sprite).spriteFrame = item > 2 ? (_crd && getSpecialCard === void 0 ? (_reportPossibleCrUseOfgetSpecialCard({
                error: Error()
              }), getSpecialCard) : getSpecialCard)(item) : (_crd && getSpecialCard === void 0 ? (_reportPossibleCrUseOfgetSpecialCard({
                error: Error()
              }), getSpecialCard) : getSpecialCard)(3);
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_usercard_type", this.userCard[1]).active = item > 2;
              ; //这里是特殊奖
              ...
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_label_carduser_winnum", this.userCard[1]).active = item > 2 ? false : value.cur.win === 1;
          ...
          if (key === "sakuraNum") {
            if (value.cur && Object.keys(value.cur).length != 0) {
              ...
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_usercard_type", this.userCard[2]).getComponent(Sprite).spriteFrame = item > 2 ? (_crd && getSpecialCard === void 0 ? (_reportPossibleCrUseOfgetSpecialCard({
                error: Error()
              }), getSpecialCard) : getSpecialCard)(item) : (_crd && getSpecialCard === void 0 ? (_reportPossibleCrUseOfgetSpecialCard({
                error: Error()
              }), getSpecialCard) : getSpecialCard)(3);
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_usercard_type", this.userCard[2]).active = item > 2; //这里是特殊奖
              ...
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_label_carduser_winnum", this.userCard[2]).active = item > 2 ? false : value.cur.win === 1;
          ...
          if (key === "blockNum") {
            if (value.cur && Object.keys(value.cur).length != 0) {
              ...
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_usercard_type", this.userCard[3]).getComponent(Sprite).spriteFrame = item > 2 ? (_crd && getSpecialCard === void 0 ? (_reportPossibleCrUseOfgetSpecialCard({
                error: Error()
              }), getSpecialCard) : getSpecialCard)(item) : (_crd && getSpecialCard === void 0 ? (_reportPossibleCrUseOfgetSpecialCard({
                error: Error()
              }), getSpecialCard) : getSpecialCard)(3);
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_usercard_type", this.userCard[3]).active = item > 2;
              ; //这里是特殊奖
              ...
              (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                error: Error()
              }), getNodeByNameDeep) : getNodeByNameDeep)("props_label_carduser_winnum", this.userCard[3]).active = item > 2 ? false : value.cur.win === 1;
          ...
          if (key === "gameStatus") {
            if (value.cur === (_crd && GameStatus === void 0 ? (_reportPossibleCrUseOfGameStatus({
              ...
              this.areaInfo.forEach((item, index) => {
                let poker = instantiate((_crd && sourceManageSelector === void 0 ? (_reportPossibleCrUseOfsourceManageSelector({
                  error: Error()
                ...
                let pokerPosition = new Vec3(0, 0, 1); // let	pokerPosition = getNodePositionInCanvas(this.node);
        ...
        createCard(parentNode, type, cardInfos) {
          ...
          cardInfo.forEach((item, index) => {
            ...
            let itemCardNum = (_crd && sumCard === void 0 ? (_reportPossibleCrUseOfsumCard({
              error: Error()
        ...
        playAnimation() {
          ...
          this.userCard.forEach((itemCard, index) => {
            ...
            this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
              ...
              let bankerItem = (_crd && restructureCard === void 0 ? (_reportPossibleCrUseOfrestructureCard({
                error: Error()
              ...
              bankerItem.newArray.forEach((item, i) => {
                ...
                tween(item.card).to(0.6, {
                  ...
                  if (!isBet) {
                    /**若用户下注 区域下ui节点展示情况*/
                    let rateNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                      error: Error()
                    }), getNodeByNameDeep) : getNodeByNameDeep)("label_userbet_rate", itemCard);
                    let winNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                      error: Error()
                    }), getNodeByNameDeep) : getNodeByNameDeep)("label_userbet_win", itemCard);
                    let loseNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
                      error: Error()
                    }), getNodeByNameDeep) : getNodeByNameDeep)("label_userbet_lose", itemCard);
                    let rate = this.props.allCardRate[index] - 1; // console.log("this.props.memberBet[index + 1]",this.props.memberBet[index + 1],index + 1);

                    let winLoseNum = this.props.memberBet[index + 1] * rate; // console.log("winLoseNum",winLoseNum);
...
//# sourceMappingURL=00c2f5e1a7f3675c8dcd733366c66d6179c0b8ee.js.map