System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, listenerFactoy, LoaderPanelViewModel, global, lang, SubGameRunState, subGameList, addToastAction, setSubGameRunState, AudioMgr, setActiveAudio, config, socketConnect, removeInstance, godWealthV2FileMap, bundlePkgName, PrefabPathDefine, fruitStore, getStore, GodWealthV2MainViewModel, resetStore, initRoller, _crd, sourceManageMap, bundleGodWealthV2, mainViewModel, godWealthV2_Audio, sourceManageSeletor, NORMAL_MAG_TYPE, msgListener, initTimeoutId, startUp, stopGame;
  ...
  function _reportPossibleCrUseOfgodWealthV2FileMap(extras) {
    _reporterNs.report("godWealthV2FileMap", "./sourceDefine", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfGodWealthV2MainViewModel(extras) {
    _reporterNs.report("GodWealthV2MainViewModel", "./viewModel/GodWealthV2MainViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      godWealthV2FileMap = _unresolved_11.default;
      ...
      GodWealthV2MainViewModel = _unresolved_14.default;
    }, function (_unresolved_15) {
      resetStore = _unresolved_15.resetStore;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "a3915BC6fdARLfqRW98VKlg", "index", undefined);

      __checkObsolete__(['AssetManager', 'Node', 'Prefab', 'assetManager']);

      sourceManageMap = [];

      _export("bundleGodWealthV2", bundleGodWealthV2 = null);
      ...
      _export("startUp", startUp = rootNode => {
        ...
        assetManager.loadBundle(_crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
          ...
          _export("bundleGodWealthV2", bundleGodWealthV2 = bundle);

          bundleGodWealthV2.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("godWealthV2_Audio", godWealthV2_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(godWealthV2_Audio); // 默认给10秒进入游戏超时处理，有时候socket连接成功之后，服务器没有发送进入房间 消息，导致卡住
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  (_crd && getStore === void 0 ? (_reportPossibleCrUseOfgetStore({
                    error: Error()
                  }), getStore) : getStore)().dispatch((_crd && resetStore === void 0 ? (_reportPossibleCrUseOfresetStore({
                    error: Error()
                  }), resetStore) : resetStore)(0));
                  (_crd && getStore === void 0 ? (_reportPossibleCrUseOfgetStore({
                    error: Error()
                  ...
                  _export("mainViewModel", mainViewModel = new (_crd && GodWealthV2MainViewModel === void 0 ? (_reportPossibleCrUseOfGodWealthV2MainViewModel({
                    error: Error()
                  }), GodWealthV2MainViewModel) : GodWealthV2MainViewModel)(() => {
            ...
            loaderviweModel.comp.startLoad([bundle], [...(_crd && godWealthV2FileMap === void 0 ? (_reportPossibleCrUseOfgodWealthV2FileMap({
              error: Error()
            }), godWealthV2FileMap) : godWealthV2FileMap)]);
          });
        });
      });
...
//# sourceMappingURL=b86e7295233666e9ff996752dd0c93aada1466e9.js.map