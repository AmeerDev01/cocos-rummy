  ...
  return {
    ...
    execute: function () {
      ...
      _export("GxfcV2Icon", GxfcV2Icon = class GxfcV2Icon {
        ...
        playScatterWin(parentNode, done, loop = false) {
          const offset = new Vec3(this.iconConfig.distance[0], this.iconConfig.distance[1]);
          ...
          let count = 0;
          const skeletonPlayer = new (_crd && SkeletonAnimationPlayer === void 0 ? (_reportPossibleCrUseOfSkeletonAnimationPlayer({
            error: Error()
...
//# sourceMappingURL=73c6254f9f37ec4f57fe3e2fd3d822a3b48c9c17.js.map