  ...
  function updateWinUsers(node) {
    ...
    (_crd && gameCacheData === void 0 ? (_reportPossibleCrUseOfgameCacheData({
      ...
      winChild.forEach((v, i) => {
        if (index === i) {
          let goldNum = (_crd && formatNumber === void 0 ? (_reportPossibleCrUseOfformatNumber({
            error: Error()
        ...
        useProps(key, value) {
          if (key === "winGold") {
            ...
            if (value.cur === 0) {
              ...
              let goldNum = Math.abs(value.cur).formatAmountWithCommas();
...
//# sourceMappingURL=a1eb2eb891ca0bf22409fb7d1d3f365479bb7ade.js.map