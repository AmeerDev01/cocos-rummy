        ...
        useProps(key, value) {
          ...
          if (key === "iconEffectData") {
            this.rollerViewModelMap.forEach((roller, index) => {
              ...
              const iconEffectArr = this.props.iconEffectData.coord.filter(i => i[0] === index).map(i => i[1]); // console.log("iconEffectArr",iconEffectArr);
...
//# sourceMappingURL=bd5f303aac63358aba96cdc7335764dc52f11b10.js.map