      ...
      _export("Hall_PcMainPanel", Hall_PcMainPanel = (_dec = ccclass('Hall_PcMainPanel'), _dec(_class = class Hall_PcMainPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        useProps(key, value) {
          if (key === "memberInfo") {
            ...
            let levelItem = (_crd && levelMap === void 0 ? (_reportPossibleCrUseOflevelMap({
              error: Error()
        ...
        bindUI() {
          ...
          this.useState(async (key, value) => {
            ...
            this.propertyNode.props_layout_bag.active = value.cur === 5; //返水界面

            if (value.cur === 6) {
              !BackWaterVM && (BackWaterVM = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                error: Error()
              }), BaseViewModel) : BaseViewModel)("Hall_PC_BackWater").mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
                error: Error()
              }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
                error: Error()
              }), PrefabPathDefine) : PrefabPathDefine).PC_BACK_WATER, Prefab)).source).appendTo(this.node));
          ...
          const hotUpdateVersion = (_crd && UseSetOption === void 0 ? (_reportPossibleCrUseOfUseSetOption({
            error: Error()
        ...
        async openEditNickName() {
          const changeNickNameViewModel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
          }), BaseViewModel) : BaseViewModel)("Hall_ChangeNickName").mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._PC_CHANGE_NICKNAME, Prefab)).source).appendTo(this.node, {
...
//# sourceMappingURL=520691e3b4058b41f66fc52a51632fe77fc2d925.js.map