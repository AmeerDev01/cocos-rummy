      ...
      _export("Fish_Test", Fish_Test = (_dec = ccclass('Fish_Test'), _dec(_class = class Fish_Test extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          (_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            ...
            const fishInfo = (_crd && fishConfig === void 0 ? (_reportPossibleCrUseOffishConfig({
              error: Error()
          ...
          this.propertyNode.props_scale.on(Toggle.EventType.TOGGLE, e => {
            const scale = e.isChecked ? view.getVisibleSize().width / (_crd && fishCommondConfig === void 0 ? (_reportPossibleCrUseOffishCommondConfig({
              error: Error()
...
//# sourceMappingURL=3d81cff925bdcd0756d518dc5cddc6cf66f5dc30.js.map