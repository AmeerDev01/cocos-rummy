        ...
        begin() {
          ...
          this.setEvent({
            ...
            allRollStop: () => {
              ...
              const flicherYuanBaoArr = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
                error: Error()
              }), dataTransfer) : dataTransfer)((_crd && DataKeyType === void 0 ? (_reportPossibleCrUseOfDataKeyType({
                error: Error()
              ...
              const yuanBaoTask = new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                error: Error()
              }), Task) : Task)(done => {
...
//# sourceMappingURL=8faf031bb8c67cfccfa0d226678224e590571902.js.map