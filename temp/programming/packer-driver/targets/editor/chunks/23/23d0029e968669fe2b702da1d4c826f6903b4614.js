    ...
    execute: function () {
      ...
      MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        initObjectPool() {
          ...
          for (const k in _crd && fishBullteConfig === void 0 ? (_reportPossibleCrUseOffishBullteConfig({
            error: Error()
          }), fishBullteConfig) : fishBullteConfig) {
            const v = (_crd && fishBullteConfig === void 0 ? (_reportPossibleCrUseOffishBullteConfig({
              error: Error()
          ...
          for (const k in _crd && fishNetConfig === void 0 ? (_reportPossibleCrUseOffishNetConfig({
            error: Error()
          }), fishNetConfig) : fishNetConfig) {
            const v = (_crd && fishNetConfig === void 0 ? (_reportPossibleCrUseOffishNetConfig({
              error: Error()
            }), fishNetConfig) : fishNetConfig)[k];
            this.objectPool.newSomeObject((_crd && ObjectClassType === void 0 ? (_reportPossibleCrUseOfObjectClassType({
              error: Error()
            }), ObjectClassType) : ObjectClassType).type_fish_net, v.id, 5); //预分配鱼网对象
          } // --注册金币
          ...
          for (const k in _crd && fishGoldConfig === void 0 ? (_reportPossibleCrUseOffishGoldConfig({
            error: Error()
          }), fishGoldConfig) : fishGoldConfig) {
            const v = (_crd && fishGoldConfig === void 0 ? (_reportPossibleCrUseOffishGoldConfig({
              error: Error()
            }), fishGoldConfig) : fishGoldConfig)[k];
            this.objectPool.newSomeObject((_crd && ObjectClassType === void 0 ? (_reportPossibleCrUseOfObjectClassType({
              error: Error()
            }), ObjectClassType) : ObjectClassType).type_fish_gold, v.id, 20); //预分配金币对象
          } // --注册鱼数字对象
          ...
          for (const k in _crd && fishLabelFntConfig === void 0 ? (_reportPossibleCrUseOffishLabelFntConfig({
            error: Error()
          }), fishLabelFntConfig) : fishLabelFntConfig) {
            const v = (_crd && fishLabelFntConfig === void 0 ? (_reportPossibleCrUseOffishLabelFntConfig({
              error: Error()
            }), fishLabelFntConfig) : fishLabelFntConfig)[k];
            this.objectPool.newSomeObject((_crd && ObjectClassType === void 0 ? (_reportPossibleCrUseOfObjectClassType({
              error: Error()
            }), ObjectClassType) : ObjectClassType).type_fish_fnt, v.id, 20); //预分配字体对象
          }
        }
        ...
        fishDeath(player_id, fshid, score) {
          let bat_obj = this.batteryManager.getBatteryByPlayerId(player_id);
          let fsh_obj = this.fishManager.getFishObjById(fshid);
        ...
        fishLstDeath(player_id, lst) {
          ...
          for (let i = 0; i < lst.length; i++) {
            ...
            if (i > 0) {
              let fsh_obj = this.fishManager.getFishObjById(lst[i].fishId);
              let first_obj = this.fishManager.getFishObjById(fsh_id);
...
//# sourceMappingURL=23d0029e968669fe2b702da1d4c826f6903b4614.js.map