System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, tween, UIOpacity, Vec3, phoenix_BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, DialogType, phoenix_DialogWin;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f233b2UnMpPCJYPQtPUAon6", "phoenix_DialogWin", undefined);

      __checkObsolete__(['_decorator', 'Label', 'Node', 'tween', 'UIOpacity', 'Vec3']);
      ...
      _export("phoenix_DialogWin", phoenix_DialogWin = (_dec = ccclass('phoenix_DialogWin'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class phoenix_DialogWin extends (_crd && phoenix_BaseComponent === void 0 ? (_reportPossibleCrUseOfphoenix_BaseComponent({
        error: Error()
...
//# sourceMappingURL=d1094f55052157f72e6eae0898620dd4c90a98de.js.map