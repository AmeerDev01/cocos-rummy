System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, fruitStore, bundlePkgName, PrefabPathDefine, LoaderPanelViewModel, fruit777FileMap, SubGameRunState, subGameList, socketConnect, HeaderViewModel, FooterViewModel, GameBoardViewModel, listenerFactoy, AudioMgr, SoundPathDefine, UseSetOption, setActiveAudio, config, global, setSubGameRunState, _crd, sourceManageMap, bundlePhoenix, gameBoardViewModel, footerViewModel, headerViewModel, phoenix_Audio, sourceManageSeletor, NORMAL_MAG_TYPE, msgListener, startUp, playMainBg, playGame1Bg, playGame2Bg, playBtnClick, getCoin, playShellEnd, playLing, playTurn, playMaxCoin, playMinCoin, playFastRoller, playBiu, playChooseCardIn, playChooseCard, playAddNum;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "0d7f3nwJ29Eg5PsJS2C3uE3", "index", undefined);

      __checkObsolete__(['AssetManager', 'Node', 'Prefab', 'assetManager', 'sys']);

      sourceManageMap = [];

      _export("bundlePhoenix", bundlePhoenix = null);

      _export("sourceManageSeletor", sourceManageSeletor = (bundleName = 'PHOENIX111') => sourceManageMap.find(i => i.bundle.name === bundleName));
      ...
      _export("startUp", startUp = rootNode => {
        ...
        assetManager.loadBundle(_crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
          ...
          _export("bundlePhoenix", bundlePhoenix = bundle);

          bundlePhoenix.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("phoenix_Audio", phoenix_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(phoenix_Audio); // hallConfig.gameConfig.find(item => item.name === "phoenix")
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  loaderviweModel.unMount().then(() => {
                    ...
                    phoenix_Audio.play((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
                      error: Error()
      ...
      */
      ...
      _export("playBtnClick", playBtnClick = () => {
        phoenix_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
      ...
      _export("playChooseCardIn", playChooseCardIn = () => {
        phoenix_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).CHOOSE_CARD_IN);
      });
      /** 卡片选中成功*/
...
//# sourceMappingURL=9fa9f303080f8364dcf003cb757fb3446bd8eee4.js.map