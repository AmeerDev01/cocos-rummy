        ...
        showWinning() {
          if (!this.winningList.length) {
            ...
            try {
              ...
              const node = instantiate(this.propertyNode.props_zhongjiangbox_template); //如果处于字游戏中，就在最上层弹出，如果在大厅，就在中层弹出

              const wrapNode = (_crd && baseBoardView === void 0 ? (_reportPossibleCrUseOfbaseBoardView({
                error: Error()
              ...
              const _tween = tween(node).to(0.3, {
...
//# sourceMappingURL=fc26379f56fef1b6d7e2dc4d8743edfc172da8c7.js.map