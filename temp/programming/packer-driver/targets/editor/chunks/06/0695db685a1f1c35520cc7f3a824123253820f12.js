  ...
  return {
    ...
    execute: function () {
      ...
      _export("Qiuqiu_Opponent", Qiuqiu_Opponent = (_dec = ccclass('Qiuqiu_Opponent'), _dec(_class = class Qiuqiu_Opponent extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        updateDealCard() {
          const dealCardCount = this.props.opType !== (_crd && OperationType === void 0 ? (_reportPossibleCrUseOfOperationType({
            error: Error()
        ...
        updateCards() {
          ...
          if (this.props.results.length === 0) {
            ...
            this.showCardNum();
            const cardItems = this.props.results.map(v => (_crd && genCardItem === void 0 ? (_reportPossibleCrUseOfgenCardItem({
              error: Error()
...
//# sourceMappingURL=0695db685a1f1c35520cc7f3a824123253820f12.js.map