System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, listenerFactoy, LoaderPanelViewModel, global, lang, SubGameRunState, subGameList, addToastAction, setSubGameRunState, AudioMgr, setActiveAudio, config, socketConnect, removeInstance, phoenixV2FileMap, bundlePkgName, PrefabPathDefine, SoundPathDefine, fruitStore, getStore, PhoenixV2MainViewModel, initGameStore, initRoller, _crd, sourceManageMap, bundlePhoenixV2, mainViewModel, phoenixV2_Audio, sourceManageSeletor, NORMAL_MAG_TYPE, msgListener, initTimeoutId, startUp, stopGame;
  ...
  function _reportPossibleCrUseOfphoenixV2FileMap(extras) {
    _reporterNs.report("phoenixV2FileMap", "./sourceDefine", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfPhoenixV2MainViewModel(extras) {
    _reporterNs.report("PhoenixV2MainViewModel", "./viewModel/PhoenixV2MainViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      phoenixV2FileMap = _unresolved_11.default;
      bundlePkgName = _unresolved_11.bundlePkgName;
    }, function (_unresolved_12) {
      PrefabPathDefine = _unresolved_12.PrefabPathDefine;
    }, function (_unresolved_13) {
      SoundPathDefine = _unresolved_13.SoundPathDefine;
    }, function (_unresolved_14) {
      fruitStore = _unresolved_14.default;
      getStore = _unresolved_14.getStore;
    }, function (_unresolved_15) {
      PhoenixV2MainViewModel = _unresolved_15.default;
    }, function (_unresolved_16) {
      initGameStore = _unresolved_16.initGameStore;
    }, function (_unresolved_17) {
      initRoller = _unresolved_17.initRoller;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "7e391toq4dKcIpiC8rO7rm7", "index", undefined);

      __checkObsolete__(['AssetManager', 'Node', 'Prefab', 'assetManager']);

      sourceManageMap = [];

      _export("bundlePhoenixV2", bundlePhoenixV2 = null);
      ...
      _export("startUp", startUp = rootNode => {
        ...
        assetManager.loadBundle(_crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
          ...
          _export("bundlePhoenixV2", bundlePhoenixV2 = bundle);

          bundlePhoenixV2.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("phoenixV2_Audio", phoenixV2_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(phoenixV2_Audio); // 默认给10秒进入游戏超时处理，有时候socket连接成功之后，服务器没有发送进入房间 消息，导致卡住
                ...
                initTimeoutId = window.setTimeout(() => {
                  ...
                  phoenixV2_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
                    error: Error()
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  _export("mainViewModel", mainViewModel = new (_crd && PhoenixV2MainViewModel === void 0 ? (_reportPossibleCrUseOfPhoenixV2MainViewModel({
                    error: Error()
                  }), PhoenixV2MainViewModel) : PhoenixV2MainViewModel)(() => {
            ...
            loaderviweModel.comp.startLoad([bundle], [...(_crd && phoenixV2FileMap === void 0 ? (_reportPossibleCrUseOfphoenixV2FileMap({
              error: Error()
            }), phoenixV2FileMap) : phoenixV2FileMap)]);
          });
        });
      });
...
//# sourceMappingURL=40888f9d72f7de1f79e6443075ef0cc6b3f06a22.js.map