    ...
    execute: function () {
      ...
      _export("Qiuqiu_Test", Qiuqiu_Test = (_dec = ccclass('Qiuqiu_Test'), _dec(_class = class Qiuqiu_Test extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        deal() {
          ...
          const pokers = this.randomCard(3).map(v => (_crd && genCardItem === void 0 ? (_reportPossibleCrUseOfgenCardItem({
            error: Error()
        ...
        randomIndex() {
          const indexs = (_crd && roomChooseViewModel === void 0 ? (_reportPossibleCrUseOfroomChooseViewModel({
            error: Error()
...
//# sourceMappingURL=754c550c44dd0ad48317339d2a42274268e3f239.js.map