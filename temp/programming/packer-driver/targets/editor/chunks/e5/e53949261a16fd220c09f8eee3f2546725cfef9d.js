System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Node, sp, BaseComponent, StepNumber, AutoLauncherType, DialogType, GameType, isAuto, getNodeByNameDeep, config, StepNumberV2, egyptv2_Audio, SoundPathDefine, _dec, _class, _crd, ccclass, property, EgyptV2_DialogWin;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      egyptv2_Audio = _unresolved_8.egyptv2_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ca6a6zKMxhI7aL7iqYiYqcM", "EgyptV2_DialogWin", undefined);
      ...
      _export("EgyptV2_DialogWin", EgyptV2_DialogWin = (_dec = ccclass('EgyptV2_DialogWin'), _dec(_class = class EgyptV2_DialogWin extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        bindEvent() {
          ...
          const buttonNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          }), getNodeByNameDeep) : getNodeByNameDeep)("Ok_Botton", this.propertyNode.props_freeSettlement);
        ...
        showFreeEntry() {
          ...
          labelNode.active = this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME1;
          (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          }), getNodeByNameDeep) : getNodeByNameDeep)("props_entry_In_Free_Spins", this.propertyNode.props_freeEntry).active = this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME1;
          (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          }), getNodeByNameDeep) : getNodeByNameDeep)("props_beetle", this.propertyNode.props_freeEntry).active = this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME2;
          (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
          }), getNodeByNameDeep) : getNodeByNameDeep)("props_hasbeen", this.propertyNode.props_freeEntry).active = this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME2; // 如果是自动模式，就等待关闭窗口
        ...
        showFreeSettlement() {
          ...
          this.propertyNode.props_In_Free_Spins.active = this.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME1;
          this.propertyNode.props_in_beetle.active = this.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME2;
        }
        ...
        onDestroy() {
          (_crd && egyptv2_Audio === void 0 ? (_reportPossibleCrUseOfegyptv2_Audio({
            error: Error()
          }), egyptv2_Audio) : egyptv2_Audio).longStop();
        }
...
//# sourceMappingURL=e53949261a16fd220c09f8eee3f2546725cfef9d.js.map