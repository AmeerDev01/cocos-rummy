System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("createAnimationNode", createAnimationNode = (sourceManage, parentNode, src_cfg, isPlay, isLoop, done = undefined) => {
        const source = sourceManage.getFile(getFileName(src_cfg.file)).source;
      ...
      _export("createAnimation", createAnimation = (animationNode, spriteAtlas, src_cfg, isPlay, isLoop, done = undefined) => {
      ...
      _export("addAnimation", addAnimation = (sourceManage, animationNode, src_cfg, isPlay, isLoop, done = undefined) => {
        const spriteAtlas = sourceManage.getFile(getFileName(src_cfg.file)).source;
...
//# sourceMappingURL=363f42088c3f2ef07d33d2be5d9f655108ecd8a5.js.map