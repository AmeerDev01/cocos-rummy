  ...
  return {
    ...
    execute: function () {
      ...
      _export("Bandar_bet_history", Bandar_bet_history = (_dec = ccclass('Bandar_bet_history'), _dec(_class = class Bandar_bet_history extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        createNewResult(parentNode, resultItem, isTween = true) {
          const children = parentNode.children; // let position=children[1].getPosition();
        ...
        createResult(parentNode, resultItem, isTween = true) {
...
//# sourceMappingURL=36704147a6a0233b5c259858eec6a178a16787d8.js.map