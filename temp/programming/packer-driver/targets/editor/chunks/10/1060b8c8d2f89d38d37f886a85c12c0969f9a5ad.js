    ...
    execute: function () {
      ...
      _export("SocketProxy", SocketProxy = class SocketProxy extends (_crd && BaseProxy === void 0 ? (_reportPossibleCrUseOfBaseProxy({
        ...
        onmessage(ev) {
          ...
          const heartbeat = `${(_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).gameCode}:-${SKT_MAG_TYPE.HEART_BEAT}`;
          const jackpot = `${(_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
        ...
        getTransferGameInfo() {
          return {
            ...
            /**获取需要停靠的图标 */
            getDockIcon: () => {
              let lineList; // const lines: number[][] = this.repository.rollerLaunchResult.dl.si[0].fixedChessboardIcon || []
...
//# sourceMappingURL=1060b8c8d2f89d38d37f886a85c12c0969f9a5ad.js.map