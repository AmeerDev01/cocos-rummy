        ...
        begin() {
          ...
          this.setEvent({
            ...
            setPasswordHandler: async () => {
              const resetPasswordViewModel = new (_crd && ResetPasswordViewModel === void 0 ? (_reportPossibleCrUseOfResetPasswordViewModel({
                error: Error()
              }), ResetPasswordViewModel) : ResetPasswordViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
                error: Error()
                ...
                error: Error()
              }), PrefabPathDefine) : PrefabPathDefine)._LOGIN_SET_PASSWORD, Prefab)).source).appendTo(this.parentNode, {
...
//# sourceMappingURL=e76649d510ebce84c51abe5162de85f96fa9da20.js.map