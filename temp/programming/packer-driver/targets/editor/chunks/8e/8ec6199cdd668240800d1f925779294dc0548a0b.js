System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfEgyptV2MainViewModel(extras) {
    _reporterNs.report("EgyptV2MainViewModel", "./viewModel/EgyptV2MainViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EgyptV2MainViewModel = _unresolved_15.default;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "0da0cVPeppM8ZjWKfPrVvX8", "index", undefined);
          ...
          bundleEgyptv2.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("egyptv2_Audio", egyptv2_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(egyptv2_Audio); // 默认给10秒进入游戏超时处理，有时候socket连接成功之后，服务器没有发送进入房间 消息，导致卡住
                ...
                initTimeoutId = window.setTimeout(() => {
                  ...
                  egyptv2_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
                    error: Error()
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  _export("mainViewModel", mainViewModel = new (_crd && EgyptV2MainViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2MainViewModel({
                    error: Error()
                  }), EgyptV2MainViewModel) : EgyptV2MainViewModel)(() => {
...
//# sourceMappingURL=8ec6199cdd668240800d1f925779294dc0548a0b.js.map