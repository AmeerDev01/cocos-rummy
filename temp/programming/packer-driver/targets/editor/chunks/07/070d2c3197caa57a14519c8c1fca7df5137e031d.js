System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Label, sp, UITransform, Widget, BaseComponent, iconConfig, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _crd, ccclass, property, dragon_Icon;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "273f5QaiEdOEq7UKB1RzEJN", "dragon_Icon", undefined);
      ...
      _export("dragon_Icon", dragon_Icon = (_dec = ccclass('dragon_Icon'), _dec2 = property(Node), _dec3 = property(sp.SkeletonData), _dec4 = property(sp.SkeletonData), _dec5 = property(sp.SkeletonData), _dec6 = property(sp.SkeletonData), _dec7 = property(sp.SkeletonData), _dec8 = property(sp.SkeletonData), _dec9 = property(sp.SkeletonData), _dec10 = property(sp.SkeletonData), _dec11 = property(sp.SkeletonData), _dec12 = property(sp.SkeletonData), _dec13 = property(sp.SkeletonData), _dec14 = property(sp.SkeletonData), _dec15 = property(Node), _dec(_class = (_class2 = class dragon_Icon extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        setFace(iconId) {
          ...
          this.face.setScale(this.iconConfig.scale[0], this.iconConfig.scale[1]); // this.effectBorder.active = true
        }
...
//# sourceMappingURL=070d2c3197caa57a14519c8c1fca7df5137e031d.js.map