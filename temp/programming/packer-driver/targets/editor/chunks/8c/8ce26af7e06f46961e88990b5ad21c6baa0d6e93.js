    ...
    execute: function () {
      ...
      _export("default", RollerMediator = class RollerMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              const rollerComp = this.wrapView.getChildByName("slotListPanel").getComponent("phoenix_RollerPanel");
            ...
            handler(notification) {
              ...
              const slotPanel = (_this$wrapView = this.wrapView) == null ? void 0 : _this$wrapView.getComponent("phoenix_SlotPanel");
            ...
            handler(notification) {
              ...
              const slotPanel = this.wrapView.getComponent("phoenix_SlotPanel"); // slotPanel.lostHidden(state)
            ...
            handler(notification) {
              ...
              const finalEnd = () => {
                ...
                const win = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                  error: Error()
              ...
              const done = cb => {
                this.taskScheduler.joinqQueue(new (_crd && Task === void 0 ? (_reportPossibleCrUseOfTask({
                  ...
                  if (fbp.getLastGame() == (_crd && SubGameType === void 0 ? (_reportPossibleCrUseOfSubGameType({
                    ...
                    const slotPanel = this.wrapView.getComponent("phoenix_SlotPanel");
                    slotPanel.setLost(OtherGameAttributesVo.phoenixMagnification);
                    let getNumberOfRounds = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                      error: Error()
              ...
              this.stopRollHandle = (isManualStop = false) => {
                ...
                rollerComp && rollerComp.stopAllRoll(isManualStop, () => {
                  ...
                  if (!targetList || !targetList.length) {
                      ...
                      const yuanBaoSpecialEffect = (_crd && getSocketProxy === void 0 ? (_reportPossibleCrUseOfgetSocketProxy({
                        error: Error()
            ...
            handler(notification) {
              ...
              const slotPanel = (_this$wrapView2 = this.wrapView) == null ? void 0 : _this$wrapView2.getComponent("phoenix_SlotPanel");
        ...
        listenerEvent() {
          ...
          const slotPanel = (_this$wrapView3 = this.wrapView) == null ? void 0 : _this$wrapView3.getComponent("phoenix_SlotPanel"); // slotPanel.btn_jackPot.on(Node.EventType.TOUCH_END, () => {
...
//# sourceMappingURL=8ce26af7e06f46961e88990b5ad21c6baa0d6e93.js.map