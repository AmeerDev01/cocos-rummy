    ...
    execute: function () {
      ...
      GiftUserViewModel = class GiftUserViewModel extends (_crd && ViewModel === void 0 ? (_reportPossibleCrUseOfViewModel({
        ...
        static flyGift(parent, fromMemberId, toMemberId, startPos, endPos, value) {
          ...
          const sourceFile = (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)("common").getFile((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          ...
          const source = (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
        ...
        static getIconConfig(value) {
          const iconConfig = (_crd && GIFT_ICON_CONFIG === void 0 ? (_reportPossibleCrUseOfGIFT_ICON_CONFIG({
            error: Error()
...
//# sourceMappingURL=910e98fffea8eeefb89f40c9f97dac0c5200c402.js.map