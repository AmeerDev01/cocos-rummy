System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfGodWealthV2RollerViewModel(extras) {
    _reporterNs.report("GodWealthV2RollerViewModel", "../viewModel/GodWealthV2RollerViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GodWealthV2RollerViewModel = _unresolved_5.default;
      ...
      godWealthV2_Audio = _unresolved_10.godWealthV2_Audio;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "df755gskwVOk7kL96mBFFsN", "GodWealthV2_RollerPanel", undefined);
      ...
      _export("GodWealthV2_RollerPanel", GodWealthV2_RollerPanel = (_dec = ccclass('GodWealthV2_RollerPanel'), _dec(_class = class GodWealthV2_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        initRoller() {
          for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            const roller = new (_crd && GodWealthV2RollerViewModel === void 0 ? (_reportPossibleCrUseOfGodWealthV2RollerViewModel({
              error: Error()
            }), GodWealthV2RollerViewModel) : GodWealthV2RollerViewModel)().mountViewNode(column).appendTo(this.propertyNode.props_column_list).connect();
        ...
        stopRollAll(isManualStop = false) {
          if (this.inStop) {
            return;
          }
        ...
        rollEndHandle() {
          const magnification = (_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
            error: Error()
          }), cacheData) : cacheData).rollerLaunchResult.dl.si[0].magnification;
          const bigWinConfig = this.getBigWinConfig(magnification); // 是否小游戏最后一局
        ...
        playWildAudio() {
          ...
          } else {// godWealthV2_Audio.playOneShot(SoundPathDefine.haveCoin)
          }
        }
        ...
        updateRollerStatusEnd(bigWinConfig, auto, isSubGameLastPoint) {
          ...
          if (!isEnterSubGame2 && bigWinConfig) {
                ...
                if (this.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
                  ...
                  if (this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
                    ...
                    (_crd && godWealthV2_Audio === void 0 ? (_reportPossibleCrUseOfgodWealthV2_Audio({
                      ...
                      error: Error()
                    }), SoundPathDefine) : SoundPathDefine).LING, 1.0, false);
            ...
            this.scheduleOnce(() => {
              ...
              const winloss = this.isSubGame2() && isSubGameLastPoint ? si.freeGameAmount : si.tw; // 中大奖提示框
        ...
        playBeetleAnimation(done) {
          ...
          const endPos = this.node.getComponent(UITransform).convertToNodeSpaceAR((_crd && mainViewModel === void 0 ? (_reportPossibleCrUseOfmainViewModel({
            error: Error()
          ...
          (_crd && godWealthV2_Audio === void 0 ? (_reportPossibleCrUseOfgodWealthV2_Audio({
            ...
            error: Error()
          }), SoundPathDefine) : SoundPathDefine).SUN_GOD, 1.0, false);
        ...
        stopRoll(i, callBack) {
          const isSpeed = this.isManualStop ? true : this.props.isSpeed; // 这里调停止滚动的速度

          const time = this.getIsSpeed() ? 0 : 0.2;
          const isEnd = i >= this.rollerViewModelArr.length - 1;
          this.isAllEnd = i >= this.rollerViewModelArr.length - 1; // console.log("iiiiiiii",i);

          this.rollIndex = i;
          const rollerComp = this.rollerViewModelArr[i]; // const stopIconIndex = Math.floor(Math.random() * config.iconRollerQueue[i].length);
          // 获得停下来的数据

          const stopIconIndex = (_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
            error: Error()
          }), cacheData) : cacheData).rollerLaunchResult.dl.si[0].rollerId[i];
          const scatterCount = this.getScatterCount(i); // 下一个列是否有边框

          const nextColmunIsBorder = this.getScatterCount(i + 1) >= 2; // console.log("scatterCount", scatterCount, i, stopIconIndex);
        ...
        getScatterCount(endColumnIndex) {
          ...
          const rollerId = (_crd && cacheData === void 0 ? (_reportPossibleCrUseOfcacheData({
            error: Error()
...
//# sourceMappingURL=ffa292eeaa95d27f65fdab91867b2ac5218bc03e.js.map