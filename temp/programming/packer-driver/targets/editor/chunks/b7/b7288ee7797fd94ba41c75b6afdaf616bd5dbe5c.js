System.register(["__unresolved_0", "cc", "__unresolved_1", "redux-act", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4ffdag8PUtPur/wlHh0If37", "roller", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DRAGONV2_UPDATE_ROLLER_STATUS]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DRAGONV2_UPDATE_SPEED_STATUS]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).DRAGONV2_INIT_ROLLER]: (state, payload) => {
          return {
...
//# sourceMappingURL=b7288ee7797fd94ba41c75b6afdaf616bd5dbe5c.js.map