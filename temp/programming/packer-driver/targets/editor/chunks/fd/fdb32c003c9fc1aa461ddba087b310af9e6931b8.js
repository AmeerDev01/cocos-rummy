      ...
      _export("Qiuqiu_Card", Qiuqiu_Card = (_dec = ccclass('Qiuqiu_Card'), _dec(_class = class Qiuqiu_Card extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        openCard(isAnima) {
          if (isAnima) {
            ...
            const t1 = tween(this.propertyNode.props_beimian).to(0.2, {
              scale: new Vec3(0, 1)
            });
            const t2 = tween(this.propertyNode.props_spr_handcard_bg).to(0.2, {
              scale: new Vec3(1, 1)
            });
            t1.call(() => {
              t2.start();
...
//# sourceMappingURL=fdb32c003c9fc1aa461ddba087b310af9e6931b8.js.map