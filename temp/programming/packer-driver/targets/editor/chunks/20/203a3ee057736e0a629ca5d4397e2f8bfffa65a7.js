System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "03a19KUXsJPgr0G3wmHB0of", "LoaderCommand", undefined);
        ...
        constructor(...args) {
          ...
          this.listExecute = [{
            ...
            handler(notification) {
              //获取所有的mediator的资源传过去
              const sourceList = [...this.facade.retrieveMediator((_crd && MediatorDefine === void 0 ? (_reportPossibleCrUseOfMediatorDefine({
                error: Error()
                ...
                data: sourceList,
                  ...
                  this.facade.retrieveProxy((_crd && ProxyDefine === void 0 ? (_reportPossibleCrUseOfProxyDefine({
                    ...
                    this.sendNotification((_crd && CommandDefine === void 0 ? (_reportPossibleCrUseOfCommandDefine({
                      ...
                      error: Error()
                    }), BgCommandConst) : BgCommandConst).AUTH); // this.sendNotification(CommandDefine.ROLLER, { gameType: SubGameType.MAIN }, RollerMediatorConst.INIT_ROLLER_PANEL)
...
//# sourceMappingURL=203a3ee057736e0a629ca5d4397e2f8bfffa65a7.js.map