    ...
    execute: function () {
      ...
      MainBoardViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          ...
          this.listenerSocket();
          const setPanel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
        ...
        initSeat() {
          for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            if (i === 0) {
              ...
              const opponentViewModel = new (_crd && OpponentViewModel === void 0 ? (_reportPossibleCrUseOfOpponentViewModel({
                error: Error()
        ...
        isGameIn() {
          ...
          const notGameIn = this.comp.props.deskStatus === (_crd && DeskStatus === void 0 ? (_reportPossibleCrUseOfDeskStatus({
            error: Error()
        ...
        setPlayerSeatIndex(player) {
          ...
          const seatIndex = this.myChairId < player.chairId ? player.chairId - this.myChairId : (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
        ...
        listenerSocket() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            const values = data.pokers.map(v => (_crd && convertCardValue === void 0 ? (_reportPossibleCrUseOfconvertCardValue({
              error: Error()
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            let balances = [];
            data.forEach(v => {
              const player = (_crd && getPlayer === void 0 ? (_reportPossibleCrUseOfgetPlayer({
                error: Error()
              }), getPlayer) : getPlayer)(this.comp.props.playerMap, v.memberId);
              let cards = v.pokers ? v.pokers.map(poker => (_crd && convertCardValue === void 0 ? (_reportPossibleCrUseOfconvertCardValue({
                error: Error()
        ...
        beginGameBetAnte() {
          this.comp.props.playerMap.filter(v => v && v.gameData.isGame).forEach(v => {
            const gold = v.glodAmount - (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
            }), config) : config).afee;
            this.dispatch((_crd && playerBet === void 0 ? (_reportPossibleCrUseOfplayerBet({
              error: Error()
        ...
        getNextSeatIndex(lastIndex, count = 0) {
          ...
          const nextIndex = lastIndex + 1 >= (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
        ...
        startCountdown(count, isStart = true) {
...
//# sourceMappingURL=28b00a9e6d1049e6c0ee6c34b34854a4365be9af.js.map