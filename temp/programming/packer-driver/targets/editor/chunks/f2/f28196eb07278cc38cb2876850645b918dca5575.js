System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function createEqualityComparator({
    ...
    return function comparator(a, b, state) {
      ...
      const constructor = a.constructor; // Checks are listed in order of commonality of use-case:
  ...
  function createEqualityComparatorConfig({
    ...
    if (circular) {
      const areArraysEqual = (_crd && createIsCircular === void 0 ? (_reportPossibleCrUseOfcreateIsCircular({
        error: Error()
      }), createIsCircular) : createIsCircular)(config.areArraysEqual);
      const areMapsEqual = (_crd && createIsCircular === void 0 ? (_reportPossibleCrUseOfcreateIsCircular({
        error: Error()
      }), createIsCircular) : createIsCircular)(config.areMapsEqual);
      const areObjectsEqual = (_crd && createIsCircular === void 0 ? (_reportPossibleCrUseOfcreateIsCircular({
        error: Error()
      }), createIsCircular) : createIsCircular)(config.areObjectsEqual);
      const areSetsEqual = (_crd && createIsCircular === void 0 ? (_reportPossibleCrUseOfcreateIsCircular({
        error: Error()
...
//# sourceMappingURL=f28196eb07278cc38cb2876850645b918dca5575.js.map