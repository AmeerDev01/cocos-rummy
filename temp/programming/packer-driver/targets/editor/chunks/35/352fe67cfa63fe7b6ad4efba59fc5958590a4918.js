  ...
  return {
    ...
    execute: function () {
      ...
      _export("EgyptV2_Main", EgyptV2_Main = (_dec = ccclass('EgyptV2_Main'), _dec(_class = class EgyptV2_Main extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        buildJackpotItem(jackpotData, isCopy = true) {
          if (!jackpotData) {
            return;
          }
          ...
          const headNode = (_crd && getNodeByNameDeep === void 0 ? (_reportPossibleCrUseOfgetNodeByNameDeep({
            error: Error()
        ...
        updateJackpotAmount(updatePositionId, value) {
          ...
          if ((_crd && calBetAmount === void 0 ? (_reportPossibleCrUseOfcalBetAmount({
            ...
            if (updatePositionId) {
              ...
              if (value.pre) {
                const amountInfoBegin = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                  error: Error()
              ...
              const amountInfoEnd = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
              ...
              this.propertyNode.props_Label_jackpot.string = ((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                error: Error()
              }), config) : config).winning[3].minRate * amountInfoEnd.value).formatAmountWithCommas();
            }
...
//# sourceMappingURL=352fe67cfa63fe7b6ad4efba59fc5958590a4918.js.map