  ...
  return {
    ...
    execute: function () {
      ...
      _export("ThorV2Icon", ThorV2Icon = class ThorV2Icon {
        ...
        playWin(parentNode, roundIndex = 0, timeScale = 1, isBorder = true, loop = false, callback = undefined) {
        ...
        playWinSound() {
          let soundStr = (_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
            error: Error()
        ...
        playAmount(parentNode, amount) {
          ...
          const str = amount.formatAmountWithCommas(); // this.props_win_number.removeFromParent();
...
//# sourceMappingURL=7924a3be905eea13cb8b71cbde070a3024fb9c70.js.map