    ...
    execute: function () {
      ...
      MainPanelViewModel = class MainPanelViewModel extends (_crd && ViewModel === void 0 ? (_reportPossibleCrUseOfViewModel({
        ...
        begin() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            this.dispatch((_crd && setMemberInfo === void 0 ? (_reportPossibleCrUseOfsetMemberInfo({
              error: Error()
            }), setMemberInfo) : setMemberInfo)({ ...data
            }));
          ...
          if (!this.winningBoxVM) {
            (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              ...
              error: Error()
            }), PrefabPathDefine) : PrefabPathDefine)._WINNING_BOX, Prefab).then(({
              source
            }) => {
          ...
          this.setEvent({
            ...
            onOpenMailPanel: async () => {
              const mailBoxViewModel = new (_crd && MailBoxViewModel === void 0 ? (_reportPossibleCrUseOfMailBoxViewModel({
                error: Error()
              }), MailBoxViewModel) : MailBoxViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
                error: Error()
              }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
                error: Error()
              }), PrefabPathDefine) : PrefabPathDefine)._HELL_MAIL, Prefab)).source).appendTo(this.viewNode, {
            ...
            onOpenWithdrawalPanel: () => {
              const withdrawalViewModel = new (_crd && WithdrawalViewModel === void 0 ? (_reportPossibleCrUseOfWithdrawalViewModel({
                error: Error()
            ...
            onOpenService: async () => {
              this.serviceVm = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                error: Error()
                ...
                onClosePanel: () => {
                  this.serviceVm.unMount((_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                    error: Error()
                  }), EffectType) : EffectType).EFFECT2);
                }
              }).setProps({
                openUrl: `${(_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                  error: Error()
                }), config) : config).customerUrl}?nc=${this.comp.props.nickName}`
              });
            }
          });
          const isGuide = sys.os === sys.OS.ANDROID && (_crd && getPackageName === void 0 ? (_reportPossibleCrUseOfgetPackageName({
            error: Error()
          ...
          if (isGuide) {
            (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
              ...
              const appDownLoadVM = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                error: Error()
        ...
        async openBindPhone(nodeWrap) {
          const bindPhoneViewModel = new (_crd && BindPhoneViewModel === void 0 ? (_reportPossibleCrUseOfBindPhoneViewModel({
            error: Error()
          }), BindPhoneViewModel) : BindPhoneViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._HELL_BIND_PHONE, Prefab)).source).appendTo(nodeWrap || this.parentNode, {
            effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
              error: Error()
            }), EffectType) : EffectType).EFFECT1,
            isModal: true
        ...
        async openUpgradePanel(nodeWrap, closeHandler) {
          ...
          const upgradeViewModel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
          }), BaseViewModel) : BaseViewModel)('Hall_Upgrade').mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._HELL_UPGRADE, Prefab)).source).appendTo(nodeWrap || this.parentNode, {
            effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
              error: Error()
            }), EffectType) : EffectType).EFFECT1,
            isModal: true
        ...
        async openChangePassword(nodeWrap) {
          const changePwdViewModel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
          }), BaseViewModel) : BaseViewModel)('Hall_ChangePassword').mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._HELL_CHANGE_PASSWORD, Prefab)).source).appendTo(nodeWrap || this.parentNode, {
            effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
              error: Error()
            }), EffectType) : EffectType).EFFECT1,
            isModal: true
        ...
        async openAwardPanel(closeHandler) {
        ...
        openShop(defaultBuyType = (_crd && BuyType === void 0 ? (_reportPossibleCrUseOfBuyType({
          error: Error()
        }), BuyType) : BuyType).COIN, nodeWrap, closeHandler) {
          this.isOpenShop = true;
          const shopViewModel = new (_crd && ShopViewModel === void 0 ? (_reportPossibleCrUseOfShopViewModel({
            error: Error()
        ...
        async openBank(nodeWrap) {
          ...
          const bankViewModel = new (_crd && BankViewModel === void 0 ? (_reportPossibleCrUseOfBankViewModel({
            error: Error()
          }), BankViewModel) : BankViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
        ...
        async openSign(nodeWrap, closeHandler) {
          ...
          // 	}).connect()
          // })
          const signInViewModel = new (_crd && SignInViewModel === void 0 ? (_reportPossibleCrUseOfSignInViewModel({
            error: Error()
          }), SignInViewModel) : SignInViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._HELL_SIGN_IN, Prefab)).source).appendTo(nodeWrap || this.parentNode, {
            effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
              error: Error()
            }), EffectType) : EffectType).EFFECT1,
            isModal: true
        ...
        async openVipUp(nodeWrap) {
          new (_crd && VipUpViewModel === void 0 ? (_reportPossibleCrUseOfVipUpViewModel({
            error: Error()
          }), VipUpViewModel) : VipUpViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._HELL_VIP_UP, Prefab)).source).appendTo(nodeWrap || this.parentNode, {
            isModal: true
          }).connect();
        }
        ...
        async openVipMain(nodeWrap) {
          new (_crd && VipMainViewModel === void 0 ? (_reportPossibleCrUseOfVipMainViewModel({
            error: Error()
          }), VipMainViewModel) : VipMainViewModel)().mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
            error: Error()
          }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
          }), PrefabPathDefine) : PrefabPathDefine)._HELL_VIP_MAIN, Prefab)).source).appendTo(nodeWrap || this.parentNode, {
            effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
              error: Error()
            }), EffectType) : EffectType).EFFECT1,
            isModal: true
        ...
        openReliefPanel() {
          if ((_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            (_crd && fetcher === void 0 ? (_reportPossibleCrUseOffetcher({
              ...
              if (data !== -1) {
                const reLiefPanel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                  error: Error()
                }), BaseViewModel) : BaseViewModel)('Hall_ReliefPanel').mountView((await (_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
                  error: Error()
                }), sourceManageSeletor) : sourceManageSeletor)().getFileAsync((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
                  error: Error()
                }), PrefabPathDefine) : PrefabPathDefine)._HELL_RE_LIEF, Prefab)).source).appendTo(this.parentNode, {
                  effectType: (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
                    error: Error()
                  }), EffectType) : EffectType).EFFECT1,
                  isModal: true
        ...
        bingFcmToken() {
          ...
          const memberId = this.comp.props.memberId; // 加盐密钥

          const salt = "HuGe:UBGFlKh3DcU5uO76";
          const token = (_crd && getFirebaseToken === void 0 ? (_reportPossibleCrUseOfgetFirebaseToken({
            error: Error()
          }), getFirebaseToken) : getFirebaseToken)();
          const keys = (_crd && md5 === void 0 ? (_reportPossibleCrUseOfmd({
            error: Error()
...
//# sourceMappingURL=7045f4850e4dee73a60a010d8d4731e1a7360d04.js.map