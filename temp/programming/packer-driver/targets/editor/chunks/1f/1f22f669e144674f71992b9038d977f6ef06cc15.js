      ...
      _export("DragonV2_RollerPanel", DragonV2_RollerPanel = (_dec = ccclass('DragonV2_RollerPanel'), _dec(_class = class DragonV2_RollerPanel extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        initRoller() {
          for (let i = 0; i < (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            ...
            const roller = new (_crd && DragonV2RollerViewModel === void 0 ? (_reportPossibleCrUseOfDragonV2RollerViewModel({
              error: Error()
        ...
        updateRollerStatusEnd(bigWinConfig, auto, isSubGameLastPoint) {
          ...
          let isEnterSubGame2 = false; // 是否小游戏2，包含下一次游戏

          const isSubGame2 = this.props.gameTypeInfo.viewGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          ...
          let isNextSubGame2 = this.props.gameTypeInfo.currGameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            error: Error()
          }), GameType) : GameType).SUBGAME2;
...
//# sourceMappingURL=1f22f669e144674f71992b9038d977f6ef06cc15.js.map