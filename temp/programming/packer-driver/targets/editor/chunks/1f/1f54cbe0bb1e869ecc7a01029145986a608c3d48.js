System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, listenerFactoy, LoaderPanelViewModel, global, lang, SubGameRunState, subGameList, addToastAction, setSubGameRunState, AudioMgr, setActiveAudio, config, socketConnect, removeInstance, gxfcV2FileMap, bundlePkgName, PrefabPathDefine, SoundPathDefine, fruitStore, getStore, GxfcV2MainViewModel, initGameStore, initRoller, _crd, sourceManageMap, bundleGxfcV2, mainViewModel, GxfcV2_Audio, sourceManageSeletor, NORMAL_MAG_TYPE, msgListener, initTimeoutId, startUp, stopGame;
  ...
  function _reportPossibleCrUseOfgxfcV2FileMap(extras) {
    _reporterNs.report("gxfcV2FileMap", "./sourceDefine", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfGxfcV2MainViewModel(extras) {
    _reporterNs.report("GxfcV2MainViewModel", "./viewModel/GxfcV2MainViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      gxfcV2FileMap = _unresolved_11.default;
      ...
      GxfcV2MainViewModel = _unresolved_15.default;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5ff48SRNYhPpLYpsi5xlHt7", "index", undefined);

      __checkObsolete__(['AssetManager', 'Node', 'Prefab', 'assetManager']);

      sourceManageMap = [];

      _export("bundleGxfcV2", bundleGxfcV2 = null);
      ...
      _export("startUp", startUp = rootNode => {
        ...
        assetManager.loadBundle(_crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
          ...
          _export("bundleGxfcV2", bundleGxfcV2 = bundle);

          bundleGxfcV2.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("GxfcV2_Audio", GxfcV2_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(GxfcV2_Audio); // 默认给10秒进入游戏超时处理，有时候socket连接成功之后，服务器没有发送进入房间 消息，导致卡住
                ...
                initTimeoutId = window.setTimeout(() => {
                  ...
                  GxfcV2_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
                    error: Error()
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  _export("mainViewModel", mainViewModel = new (_crd && GxfcV2MainViewModel === void 0 ? (_reportPossibleCrUseOfGxfcV2MainViewModel({
                    error: Error()
                  }), GxfcV2MainViewModel) : GxfcV2MainViewModel)(() => {
            ...
            loaderviweModel.comp.startLoad([bundle], [...(_crd && gxfcV2FileMap === void 0 ? (_reportPossibleCrUseOfgxfcV2FileMap({
              error: Error()
            }), gxfcV2FileMap) : gxfcV2FileMap)]);
          });
        });
      });
      ...
      _export("stopGame", stopGame = () => {
        ...
        GxfcV2_Audio && GxfcV2_Audio.remove();
...
//# sourceMappingURL=1f54cbe0bb1e869ecc7a01029145986a608c3d48.js.map