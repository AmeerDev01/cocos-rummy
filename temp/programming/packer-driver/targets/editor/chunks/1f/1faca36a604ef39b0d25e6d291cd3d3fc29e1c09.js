        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              assetManager.loadBundle("egypt", async (err, _bundle) => {
                // 首先贴入加载框面板
                try {
                ...
                _bundle.load(panel.path, Prefab, (progress, total) => {
                  ...
                  const loaderScript = node.getComponent("Egypt_Loader");
...
//# sourceMappingURL=1faca36a604ef39b0d25e6d291cd3d3fc29e1c09.js.map