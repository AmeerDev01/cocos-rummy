    ...
    execute: function () {
      ...
      _export("Fruit777_Footer", Fruit777_Footer = (_dec = ccclass('Fruit777_Footer'), _dec(_class = class Fruit777_Footer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindUI() {
          ...
          this.useState((key, value) => {
            this.propertyNode.props_Label_down_oneBet.string = `${value.cur.value} × ${(_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
              error: Error()
...
//# sourceMappingURL=6480d89ee74ea13a5d54c634b1bf41faf8552020.js.map