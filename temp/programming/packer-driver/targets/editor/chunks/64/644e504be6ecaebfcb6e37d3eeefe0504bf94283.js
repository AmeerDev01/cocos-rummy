System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, config, SkeletalPathDefine, SpriteFramePathDefine, _crd, RollerStatus, IconEffectType, DirectionType, IconSizeType, GameType, AutoLauncherType, DialogType, JactpotType, IconId, getAutoCount, getWild, updateWildSprite, isLimit, isSubGameToSubGame, isAuto, verifyBetResultData, calBetAmount, getColumnLockIconArr;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SkeletalPathDefine = _unresolved_3.SkeletalPathDefine;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "681d9V/YW1Flp6V1gpoDTNW", "type", undefined);
      ...
      _export("DialogType", DialogType = /*#__PURE__*/function (DialogType) {
        ...
        DialogType["YUAN_BAO_WIN"] = "YUAN_BAO_WIN";
        return DialogType;
      }({}));
      /**弹窗信息 */
      ...
      _export("getWild", getWild = id => {
        if (id === 0) {
          ...
          return {
            fileName: (_crd && SpriteFramePathDefine === void 0 ? (_reportPossibleCrUseOfSpriteFramePathDefine({
              error: Error()
            }), SpriteFramePathDefine) : SpriteFramePathDefine).icon_wildG1,
            skeletonName: (_crd && SkeletalPathDefine === void 0 ? (_reportPossibleCrUseOfSkeletalPathDefine({
              error: Error()
      ...
      _export("updateWildSprite", updateWildSprite = (gameTypeInfo, smallGameInfo) => {
        if (smallGameInfo) {}
      });
      /**
       * 是否无限运行
...
//# sourceMappingURL=644e504be6ecaebfcb6e37d3eeefe0504bf94283.js.map