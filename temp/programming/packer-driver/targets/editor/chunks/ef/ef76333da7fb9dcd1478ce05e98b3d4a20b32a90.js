      ...
      _export("Yxx_BetArea", Yxx_BetArea = (_dec = ccclass('Yxx_BetArea'), _dec(_class = class Yxx_BetArea extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        flickerWinSprite(result) {
          Array.from(new Set(result.betTypes)).forEach(v => {
            const uiOpacity = this.getNodeByBetType(v).getChildByName("Sprite_Win").getComponent(UIOpacity);
        ...
        flyChip(betData, isFly = true) {
          ...
          const isWinRateBet = this.isWinRateBet(betData.betType); // log("flyChip ===", betData);
        ...
        healerFlyToBetArea(betType, prizeCount) {
          ...
          const odds = (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
...
//# sourceMappingURL=ef76333da7fb9dcd1478ce05e98b3d4a20b32a90.js.map