          ...
          try {
            if ((_crd && footerViewModel === void 0 ? (_reportPossibleCrUseOffooterViewModel({
              ...
              if (this.propertyNode) {
                const labelNum = this.propertyNode.props_Label_jackpot_num;
                /**可能是直接打开宝箱游戏，不会初始化主页 */

                if (labelNum) {
                  const pre = labelNum.string.replace(/,/g, '');
                  const cur = (_crd && footerViewModel === void 0 ? (_reportPossibleCrUseOffooterViewModel({
                    error: Error()
                  }), footerViewModel) : footerViewModel).comp.getPositionData().value * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
                    error: Error()
...
//# sourceMappingURL=c836fc77ca8dc78dcc4cedccb2543ef25cfaff6d.js.map