System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfphoenix_footer(extras) {
    _reporterNs.report("phoenix_footer", "../components/phoenix_footer", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIProps(extras) {
    _reporterNs.report("IProps", "../components/phoenix_footer", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIEvent(extras) {
    _reporterNs.report("IEvent", "../components/phoenix_footer", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfphoenix_helpPanel(extras) {
    _reporterNs.report("phoenix_helpPanel", "../components/phoenix_helpPanel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfFIProps(extras) {
    _reporterNs.report("FIProps", "../components/phoenix_helpPanel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfFIState(extras) {
    _reporterNs.report("FIState", "../components/phoenix_helpPanel", _context.meta, extras);
  }

  function _reportPossibleCrUseOfFIEvent(extras) {
    _reporterNs.report("FIEvent", "../components/phoenix_helpPanel", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d6cbeIsix1GrIsEyJphzUnT", "FooterViewModel", undefined);
      ...
      FooterViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
          ...
          this.setEvent({
            ...
            openHelpPanel: () => {
              this.helpPanelPanel = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
                error: Error()
              }), BaseViewModel) : BaseViewModel)("phoenix_helpPanel").mountView((_crd && sourceManageSeletor === void 0 ? (_reportPossibleCrUseOfsourceManageSeletor({
                error: Error()
              }), sourceManageSeletor) : sourceManageSeletor)().getFile((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
                error: Error()
        ...
        manualBetHandler() {
          ...
          } // (footerViewModel.comp.getPropertyNode().props_jiacishu as Node).active = false;
          //如果是小游戏，清除气泡倍率值
          ...
          if (this.gameType === (_crd && GameType === void 0 ? (_reportPossibleCrUseOfGameType({
            ...
            (_crd && sktInstance === void 0 ? (_reportPossibleCrUseOfsktInstance({
              ...
              tableId: JSON.parse(sys.localStorage.getItem('phoenix')).tableId
            });
...
//# sourceMappingURL=c83ca98ffc8021244b664731e79d94375827d92c.js.map