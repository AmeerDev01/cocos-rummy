System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Label, Node, tween, Vec3, Sprite, BaseComponent, sourceManageSeletor, SpriteFramePathDefine, StepNumber, changeProfit, _dec, _class, _crd, ccclass, property, Thor_WinShowView;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b2083P/vmxOl7/A2RX+K2Aj", "Thor_WinShowView", undefined);
      ...
      _export("Thor_WinShowView", Thor_WinShowView = (_dec = ccclass('Thor_WinShowView'), _dec(_class = class Thor_WinShowView extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        useProps(key, value) {
          if (key === "winningData" && value.cur) {
            ...
            if (value.cur.count >= 0) {
              let smallIconIcons = [(_crd && SpriteFramePathDefine === void 0 ? (_reportPossibleCrUseOfSpriteFramePathDefine({
                error: Error()
              ...
              let node = instantiate(this.propertyNode.props_item);
              node.active = true;
              let {
                x,
                y
...
//# sourceMappingURL=dda96dbd1d1dd8d81311f094d3ccd2d4fbb0d51d.js.map