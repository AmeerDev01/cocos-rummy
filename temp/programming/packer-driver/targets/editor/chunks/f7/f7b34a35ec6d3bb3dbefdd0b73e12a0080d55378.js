System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, listenerFactoy, LoaderPanelViewModel, global, lang, SubGameRunState, subGameList, addToastAction, setSubGameRunState, AudioMgr, setActiveAudio, config, socketConnect, removeInstance, DragonV2FileMap, bundlePkgName, PrefabPathDefine, fruitStore, getStore, DragonV2MainViewModel, resetStore, initRoller, _crd, sourceManageMap, bundleDragonv2, mainViewModel, Dragonv2_Audio, sourceManageSeletor, NORMAL_MAG_TYPE, msgListener, initTimeoutId, startUp, stopGame;
  ...
  function _reportPossibleCrUseOfDragonV2FileMap(extras) {
    _reporterNs.report("DragonV2FileMap", "./sourceDefine", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfDragonV2MainViewModel(extras) {
    _reporterNs.report("DragonV2MainViewModel", "./viewModel/DragonV2MainViewModel", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      DragonV2FileMap = _unresolved_11.default;
      ...
      DragonV2MainViewModel = _unresolved_14.default;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5a97dOxWG1KXJ+s8c2BV622", "index", undefined);

      __checkObsolete__(['AssetManager', 'Node', 'Prefab', 'assetManager']);

      sourceManageMap = [];

      _export("bundleDragonv2", bundleDragonv2 = null);
      ...
      _export("startUp", startUp = rootNode => {
        ...
        assetManager.loadBundle(_crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
          ...
          _export("bundleDragonv2", bundleDragonv2 = bundle);

          bundleDragonv2.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("Dragonv2_Audio", Dragonv2_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(Dragonv2_Audio); // 默认给10秒进入游戏超时处理，有时候socket连接成功之后，服务器没有发送进入房间 消息，导致卡住
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  _export("mainViewModel", mainViewModel = new (_crd && DragonV2MainViewModel === void 0 ? (_reportPossibleCrUseOfDragonV2MainViewModel({
                    error: Error()
                  }), DragonV2MainViewModel) : DragonV2MainViewModel)(() => {
            ...
            loaderviweModel.comp.startLoad([bundle], [...(_crd && DragonV2FileMap === void 0 ? (_reportPossibleCrUseOfDragonV2FileMap({
              error: Error()
            }), DragonV2FileMap) : DragonV2FileMap)]);
          });
        });
      });
...
//# sourceMappingURL=f7b34a35ec6d3bb3dbefdd0b73e12a0080d55378.js.map