System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, LoaderPanelViewModel, AudioMgr, config, socketConnect, removeInstance, dominoFileMap, bundlePkgName, PrefabPathDefine, SoundPathDefine, dominoStore, global, lang, addToastAction, setSubGameRunState, SubGameRunState, getStore, RoomChooseViewModel, TestViewModel, _crd, sourceManageMap, bundleDomino, qiuqiu_Audio, roomChooseViewModel, sourceManageSeletor, rootNode, initTimeoutId, startUp, stopGame, playBg, playBtnClick, playChooseCard, playCoin, playFapai, playGameBegin, playGuoPai, playGoodCard, playChangeCard, playDead, playFangqi, playTuoAllin, playAllin, playWin, playXiazhuJinbi;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      setSubGameRunState = _unresolved_11.setSubGameRunState;
    }, function (_unresolved_12) {
      SubGameRunState = _unresolved_12.SubGameRunState;
    }, function (_unresolved_13) {
      getStore = _unresolved_13.getStore;
    }, function (_unresolved_14) {
      RoomChooseViewModel = _unresolved_14.default;
    }, function (_unresolved_15) {
      TestViewModel = _unresolved_15.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "a4ab3wkoDpODoeVmkGFPLoA", "index", undefined);
      ...
      _export("sourceManageSeletor", sourceManageSeletor = (bundleName = _crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
        error: Error()
      }), bundlePkgName) : bundlePkgName) => sourceManageMap.find(i => i.bundle.name === bundleName));
          ...
          bundleDomino.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("qiuqiu_Audio", qiuqiu_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
      ...
      _export("playBg", playBg = () => {
        qiuqiu_Audio.play((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_bg, true);
      });

      _export("playBtnClick", playBtnClick = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
      ...
      _export("playChooseCard", playChooseCard = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_choose_card);
      });

      _export("playCoin", playCoin = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_coin);
      });

      _export("playFapai", playFapai = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_fapai);
      });

      _export("playGameBegin", playGameBegin = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_game_start);
      });

      _export("playGuoPai", playGuoPai = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_guopai);
      });

      _export("playGoodCard", playGoodCard = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_goodcard);
      });

      _export("playChangeCard", playChangeCard = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_changcard);
      });

      _export("playDead", playDead = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_dead);
      });

      _export("playFangqi", playFangqi = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_fangqi);
      });

      _export("playTuoAllin", playTuoAllin = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_tuo_allin);
      });

      _export("playAllin", playAllin = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_all_in);
      });

      _export("playWin", playWin = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_win);
      });

      _export("playXiazhuJinbi", playXiazhuJinbi = () => {
        qiuqiu_Audio.playOneShot((_crd && SoundPathDefine === void 0 ? (_reportPossibleCrUseOfSoundPathDefine({
          error: Error()
        }), SoundPathDefine) : SoundPathDefine).qq_xiazhu_jinbi);
      });
...
//# sourceMappingURL=a92ec0a4cdc7211eae9f5e3bf339b3f88a0cf467.js.map