      ...
      _export("default", BgMediator = class BgMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              const comp = this.wrapView.getComponent("gxfc_SlotBg");
        ...
        listenerEvent() {
          const comp = this.wrapView.getComponent("gxfc_SlotBg");
          const autoButtonWrap = this.wrapView.getComponent("gxfc_SlotBg").autoLaunch;
          const props_toggle_fast = this.wrapView.getComponent("gxfc_SlotBg").propsToggleFast;
...
//# sourceMappingURL=763480d227525bb393c28f81153efc7cb82b284c.js.map