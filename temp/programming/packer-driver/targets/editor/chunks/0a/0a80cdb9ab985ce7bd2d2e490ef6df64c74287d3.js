System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Vec3, BaseComponent, config, GameType, getColumnLockIconArr, IconId, cacheData, _dec, _class, _crd, ccclass, property, PhoenixV2_SingleIconRoller;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "19e08S/+htJE6WAoZplIt9C", "PhoenixV2_SingleIconRoller", undefined);
      ...
      _export("PhoenixV2_SingleIconRoller", PhoenixV2_SingleIconRoller = (_dec = ccclass('PhoenixV2_SingleIconRoller'), _dec(_class = class PhoenixV2_SingleIconRoller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        getRollSpeed() {
          ...
          if (this.rollCount <= this.rollMaxCount) {
            this.rollCount === this.rollMaxCount && this.addLastJoinIconIndex(this.stopIconIndex, 3); // console.log(`=====columnIndex:${this.columnIndex},slotIndex:${this.slotIndex},rollCount:${this.rollCount},lastIndex:${this.lastIndex},stopIconIndex:${this.stopIconIndex}`);
        ...
        playWinIcon(index) {
          ...
          if (icon.getId() !== (_crd && IconId === void 0 ? (_reportPossibleCrUseOfIconId({
            error: Error()
          }), IconId) : IconId).WILD) {// icon.playWin(this.iconAnimationNode)
          }
        }
...
//# sourceMappingURL=0a80cdb9ab985ce7bd2d2e490ef6df64c74287d3.js.map