  ...
  return {
    ...
    execute: function () {
      ...
      RollerIconViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        openTotal() {
          let yuanBaoRate = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
            error: Error()
          ...
          let yuanBaoWinNum = (_crd && dataTransfer === void 0 ? (_reportPossibleCrUseOfdataTransfer({
            error: Error()
          }), dataTransfer) : dataTransfer)((_crd && DataKeyType === void 0 ? (_reportPossibleCrUseOfDataKeyType({
            error: Error()
          }), DataKeyType) : DataKeyType).ICON_YUANBAO_EFFECT_DATA).yuanBaoAmount;
          const yuanBaoTotalBet = new (_crd && BaseViewModel === void 0 ? (_reportPossibleCrUseOfBaseViewModel({
            error: Error()
...
//# sourceMappingURL=77ee27574c5af977fdd23a2967c65dc9800420fd.js.map