    ...
    execute: function () {
      ...
      MainBoardViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        isGameIn() {
          ...
          const notGameIn = this.comp.props.statue === (_crd && DeskStatus === void 0 ? (_reportPossibleCrUseOfDeskStatus({
            error: Error()
        ...
        getNextNativePlayer(lastUid) {
          const playerViewModelMap = [this.seatMine, this.seatLeft, this.seatTop, this.seatRight];
          let thisIndex = 0;
        ...
        listenerSocket() {
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            const cardItems = data.map(v => (_crd && genCardItem === void 0 ? (_reportPossibleCrUseOfgenCardItem({
              error: Error()
          ...
          (_crd && sktMsgListener === void 0 ? (_reportPossibleCrUseOfsktMsgListener({
            ...
            const nextPlayer = this.getPlayer(data.dominoNext.memberId); // 设置是否
        ...
        openBalancePanel(balances) {
          ...
          this.openEndingOdds(myBalance.odds, () => {
            const prefabPath = winloss > 0 ? (_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
              error: Error()
...
//# sourceMappingURL=77968782fe7458de19ccfbe6cc464f761da44ac5.js.map