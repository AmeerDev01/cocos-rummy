System.register(["__unresolved_0", "cc", "redux-act", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2541dhR8edCSJfwBdqDzuDL", "roller", undefined);
      ...
      _export("ActionTypes", ActionTypes = /*#__PURE__*/function (ActionTypes) {
        ActionTypes["PHOENIXV2_UPDATE_ROLLER_STATUS"] = "PHOENIXV2_UPDATE_ROLLER_STATUS";
        ActionTypes["PHOENIXV2_UPDATE_SPEED_STATUS"] = "PHOENIXV2_UPDATE_SPEED_STATUS";
        ActionTypes["PHOENIXV2_INIT_ROLLER"] = "PHOENIXV2_INIT_ROLLER";
        return ActionTypes;
      }({}));
      /**定义action的payLoad类型 */
      ...
      _export("updateRollerStatus", updateRollerStatus = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.PHOENIXV2_UPDATE_ROLLER_STATUS, rollerStatus => {
        return {
          rollerStatus
        };
      }));
      ...
      _export("updateSpeedStatus", updateSpeedStatus = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.PHOENIXV2_UPDATE_SPEED_STATUS, isSpeed => {
        return {
          isSpeed
        };
      }));
      ...
      _export("initRoller", initRoller = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.PHOENIXV2_INIT_ROLLER, () => {
        return {
          initState
        };
      }));
...
//# sourceMappingURL=f80ed38a7e996c77e1178fb2e005e8d9c7f7dda1.js.map