  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", BgMediator = class BgMediator extends (_crd && BaseMediator === void 0 ? (_reportPossibleCrUseOfBaseMediator({
        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              const comp = this.wrapView.getComponent("Egypt_SlotBg");
        ...
        listenerEvent() {
          const comp = this.wrapView.getComponent("Egypt_SlotBg");
          const autoButtonWrap = this.wrapView.getComponent("Egypt_SlotBg").autoLaunch;
          const props_toggle_fast = this.wrapView.getComponent("Egypt_SlotBg").propsToggleFast;
...
//# sourceMappingURL=2d44d1a14f7242f9a771d036c4e77fd3655ebf57.js.map