System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, ViewModel, StoreInject, global, getUUID, config, convertToServerBetType, gameCacheData, SKT_MAG_TYPE, sktInstance, getStore, seatBet, selectChip, changeSeatBet, setTipType, _dec, _class, _crd, FooterViewModel;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      selectChip = _unresolved_9.selectChip;
    ...
    execute: function () {
      ...
      FooterViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        begin() {
          this.setEvent({
            selectChip: value => {
              this.dispatch((_crd && selectChip === void 0 ? (_reportPossibleCrUseOfselectChip({
                error: Error()
              }), selectChip) : selectChip)(value));
            },
...
//# sourceMappingURL=2db038ff44b9b692c98ec7154b2938cc11efe8c2.js.map