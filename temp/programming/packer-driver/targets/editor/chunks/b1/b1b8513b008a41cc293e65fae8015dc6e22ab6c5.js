  ...
  return {
    ...
    execute: function () {
      ...
      _export("Common_HotUpdate", Common_HotUpdate = (_dec = ccclass('Common_HotUpdate'), _dec2 = property(ProgressBar), _dec3 = property({
          ...
          (_crd && initConfig === void 0 ? (_reportPossibleCrUseOfinitConfig({
            ...
            this.getPackageInfo().then(content => {
              ...
              if (content && content.abState) {
                ...
                let isApkUpdate = NATIVE; // 要 isApkUpdate 为false，才表示设置了该值，返回一个undefined也要更新包
        ...
        init() {
          const hotInstance = new (_crd && Hot === void 0 ? (_reportPossibleCrUseOfHot({
            error: Error()
          ...
          let options = new (_crd && HotOptions === void 0 ? (_reportPossibleCrUseOfHotOptions({
            error: Error()
          ...
          options.OnUpdateProgress = event => {
            ...
            let msg = event.getMessage(); // console.log('[update]: 进度=' + file);
        ...
        handleManifestFile(newRemotUr) {
          if (!NATIVE) return;
          const storagePath = (native.fileUtils ? native.fileUtils.getWritablePath() : "/") + 'remote-asset'; // this.storagePath = storagePath
        ...
        updateManifestFile(newRemotUr, fileName) {
          ...
          if (fileExist) {
            ...
            const res = native.fileUtils.writeStringToFile(afterVersionString, fileName); // this.mainfestObj = obj;
        ...
        downloadApkHandle(appDumpUrl, appOnlineVersion) {
          ...
          let downloader = new native.Downloader(); //下载失败回调
          ...
          downloader.onProgress = (task, bytesReceived, totalBytesReceived, totalBytesExpected) => {
            ...
            let totalReceived = (totalBytesExpected / 1024).toFixed(1); // var strProgress: string = "Download APK:" + bKReceived + "kb / " + totalReceived + "kb";
          ...
          const url = (_crd && getRedirectUrl === void 0 ? (_reportPossibleCrUseOfgetRedirectUrl({
            error: Error()
        ...
        getPackageInfo() {
          return new Promise((reslove, reject) => {
            const packageName = (_crd && getPackageName === void 0 ? (_reportPossibleCrUseOfgetPackageName({
              error: Error()
...
//# sourceMappingURL=b1b8513b008a41cc293e65fae8015dc6e22ab6c5.js.map