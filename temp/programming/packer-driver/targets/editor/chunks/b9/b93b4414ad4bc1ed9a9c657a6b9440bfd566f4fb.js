    ...
    execute: function () {
      ...
      _export("default", CaptchaGenerator = class CaptchaGenerator {
        ...
        addNoise() {
          ...
          const ctx = this.displayNoiseNode.addComponent(Graphics); // 添加噪点
          ...
          for (let i = 0; i < noiseAmount; i++) {
            ...
            const color = new Color(Math.random() * 255, Math.random() * 255, Math.random() * 255, 255); // 绘制一个小的随机颜色点
...
//# sourceMappingURL=b93b4414ad4bc1ed9a9c657a6b9440bfd566f4fb.js.map