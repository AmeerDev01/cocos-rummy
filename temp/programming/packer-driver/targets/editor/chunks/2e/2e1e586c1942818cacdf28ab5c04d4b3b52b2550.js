    ...
    execute: function () {
      ...
      ThorV2MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        sendBet(betAmount = 0) {
          ...
          const gameModeType = isBuy ? (_crd && GameModeType === void 0 ? (_reportPossibleCrUseOfGameModeType({
            error: Error()
        ...
        enterExitSubGame(dialogInfo, done) {
          let thorV2SubGameCalculateViewModel = new (_crd && ThorV2SubGameCalculateViewModel === void 0 ? (_reportPossibleCrUseOfThorV2SubGameCalculateViewModel({
            error: Error()
        ...
        showDialogWin(winningConfig, amount, done) {
          let thorV2DialogWinViewModel = new (_crd && ThorV2DialogWinViewModel === void 0 ? (_reportPossibleCrUseOfThorV2DialogWinViewModel({
            error: Error()
        ...
        openRule() {
          const rulePanelViewMode = new (_crd && ThorV2RulePanelViewModel === void 0 ? (_reportPossibleCrUseOfThorV2RulePanelViewModel({
            error: Error()
        ...
        openBubMiniPanel() {
          ...
          const thorV2BuyMiniViewModel = new (_crd && ThorV2BuyMiniViewModel === void 0 ? (_reportPossibleCrUseOfThorV2BuyMiniViewModel({
            error: Error()
        ...
        openAutoPanel() {
          const thorV2AuthLauncherViewModel = new (_crd && ThorV2AuthLauncherViewModel === void 0 ? (_reportPossibleCrUseOfThorV2AuthLauncherViewModel({
            error: Error()
...
//# sourceMappingURL=2e1e586c1942818cacdf28ab5c04d4b3b52b2550.js.map