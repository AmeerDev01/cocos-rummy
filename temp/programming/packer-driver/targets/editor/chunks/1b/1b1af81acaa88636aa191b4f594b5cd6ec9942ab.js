System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, assetManager, dfdcStore, bundlePkgName, PrefabPathDefine, LoaderPanelViewModel, dfdcFileMap, SubGameRunState, socketConnect, HeaderViewModel, FooterViewModel, GameBoardViewModel, listenerFactoy, AudioMgr, setActiveAudio, config, global, setSubGameRunState, _crd, sourceManageMap, bundleBlessedWealthy, gameBoardViewModel, footerViewModel, headerViewModel, blessedWealthy_Audio, jackPotViewModel, sourceManageSeletor, NORMAL_MAG_TYPE, msgListener, startUp, playMainBg, playGame1Bg, playGame2Bg, playBtnClick, getCoin, playShellEnd, playLing, playTurn, playMaxCoin, playMinCoin, playFastRoller, playBiu;

  function _reportPossibleCrUseOfdfdcStore(extras) {
    _reporterNs.report("dfdcStore", "./store", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfdfdcFileMap(extras) {
    _reporterNs.report("dfdcFileMap", "./sourceDefine", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      dfdcStore = _unresolved_2.default;
      ...
      dfdcFileMap = _unresolved_6.default;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "96b88lM6V5J0p9ZQjOdextZ", "index", undefined);

      __checkObsolete__(['AssetManager', 'Node', 'Prefab', 'assetManager', 'sys']);

      sourceManageMap = [];

      _export("bundleBlessedWealthy", bundleBlessedWealthy = null);

      _export("sourceManageSeletor", sourceManageSeletor = (bundleName = 'duofuduocai') => sourceManageMap.find(i => i.bundle.name === bundleName));
      ...
      _export("startUp", startUp = rootNode => {
        (_crd && dfdcStore === void 0 ? (_reportPossibleCrUseOfdfdcStore({
          error: Error()
        }), dfdcStore) : dfdcStore).configureStore();
        assetManager.loadBundle(_crd && bundlePkgName === void 0 ? (_reportPossibleCrUseOfbundlePkgName({
          ...
          _export("bundleBlessedWealthy", bundleBlessedWealthy = bundle);

          bundleBlessedWealthy.load((_crd && PrefabPathDefine === void 0 ? (_reportPossibleCrUseOfPrefabPathDefine({
            error: Error()
            ...
            const loaderviweModel = new (_crd && LoaderPanelViewModel === void 0 ? (_reportPossibleCrUseOfLoaderPanelViewModel({
              ...
              onLoadDone: _sourceManageMap => {
                ...
                _export("blessedWealthy_Audio", blessedWealthy_Audio = new (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr)(sourceManageSeletor()));

                (_crd && setActiveAudio === void 0 ? (_reportPossibleCrUseOfsetActiveAudio({
                  error: Error()
                }), setActiveAudio) : setActiveAudio)(blessedWealthy_Audio); // hallConfig.gameConfig.find(item => item.name === "duofuduocai")
                ...
                (_crd && socketConnect === void 0 ? (_reportPossibleCrUseOfsocketConnect({
                  ...
                  loaderviweModel.unMount().then(() => {
                    ...
                    _export("footerViewModel", footerViewModel = new (_crd && FooterViewModel === void 0 ? (_reportPossibleCrUseOfFooterViewModel({
                      ...
                      error: Error()
                    }), PrefabPathDefine) : PrefabPathDefine).FOOTER_DOWN).source).appendTo(gameBoardViewModel.comp.getWrapNode()).connect()); //     // jackPotViewModel = new JackPotViewModel().mountView(sourceManageSeletor().getFile(PrefabPathDefine.JACK_POT).source).appendTo(gameBoardViewModel.comp.getWrapNode()).connect();
            ...
            loaderviweModel.comp.startLoad([bundle], [...(_crd && dfdcFileMap === void 0 ? (_reportPossibleCrUseOfdfdcFileMap({
              error: Error()
            }), dfdcFileMap) : dfdcFileMap)]);
          });
        });
      });
      /**
      ...
      _export("playMainBg", playMainBg = () => {//blessedWealthy_Audio.play(SoundPathDefine.MAIN_BG, true);
      });
      /**
      * 小游戏1背景
      */
      ...
      _export("playGame1Bg", playGame1Bg = () => {//blessedWealthy_Audio.play(SoundPathDefine.GAME1_BG);
      });
      /**
      * 小游戏2背景
      */
      ...
      _export("playGame2Bg", playGame2Bg = () => {//blessedWealthy_Audio.play(SoundPathDefine.GAME2_BG);
      });
      /**点击按钮 */


      _export("playBtnClick", playBtnClick = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.BTN_CLICK);
      });
      /**金币收集结算 */


      _export("getCoin", getCoin = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.GET_COIN);
      });
      /**滚轴停止滚动 */


      _export("playShellEnd", playShellEnd = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.SHELL_END);
      });
      /** 小游戏进入前铃声*/


      _export("playLing", playLing = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.LING);
      });
      /**规则翻页 */


      _export("playTurn", playTurn = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.TURN);
      });
      /** 增加下注*/


      _export("playMaxCoin", playMaxCoin = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.MAX_COIN);
      });
      /** 减小下注*/


      _export("playMinCoin", playMinCoin = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.MIN_COIN);
      });
      /** 滚轴加速*/


      _export("playFastRoller", playFastRoller = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.FAST_ROLLER);
      });
      /** 选择自转次数时音效*/


      _export("playBiu", playBiu = () => {//blessedWealthy_Audio.playOneShot(SoundPathDefine.BIU);
      });
...
//# sourceMappingURL=1b1af81acaa88636aa191b4f594b5cd6ec9942ab.js.map