    ...
    execute: function () {
      ...
      _export("Thor_Roller", Thor_Roller = (_dec = ccclass('Thor_Roller'), _dec(_class = class Thor_Roller extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        joinIcon() {
          //滑槽中的图表数
          //下一个要加入的图标
          const iconData = this.props.rollerType.iconQueue[this.nextJoinIconIndex]; // console.log('下一关图标',this.nextJoinIconIndex,iconData.iconId,'队列',this.props.rollerType.index);
...
//# sourceMappingURL=c29c2a3ab48a778a171238dbf097e52c378af6f8.js.map