System.register(["__unresolved_0", "cc", "redux-act", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "8566d6AqORD1JcuYipn1wge", "roller", undefined);
      ...
      _export("ActionTypes", ActionTypes = /*#__PURE__*/function (ActionTypes) {
        ActionTypes["GXFCV2_UPDATE_ROLLER_STATUS"] = "GXFCV2_UPDATE_ROLLER_STATUS";
        ActionTypes["GXFCV2_UPDATE_SPEED_STATUS"] = "GXFCV2_UPDATE_SPEED_STATUS";
        ActionTypes["GXFCV2_INIT_ROLLER"] = "GXFCV2_ROLLER_QUIT_GAME";
        return ActionTypes;
      }({}));
      /**定义action的payLoad类型 */
      ...
      _export("updateRollerStatus", updateRollerStatus = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.GXFCV2_UPDATE_ROLLER_STATUS, rollerStatus => {
        return {
          rollerStatus
        };
      }));
      ...
      _export("updateSpeedStatus", updateSpeedStatus = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.GXFCV2_UPDATE_SPEED_STATUS, isSpeed => {
        return {
          isSpeed
        };
      }));
      ...
      _export("initRoller", initRoller = (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        error: Error()
      }), reduxAct) : reduxAct).createAction(ActionTypes.GXFCV2_INIT_ROLLER, () => {
        return {
          initState
        };
      }));
...
//# sourceMappingURL=292c99506b0f331905bf24740a933ad69c14cd53.js.map