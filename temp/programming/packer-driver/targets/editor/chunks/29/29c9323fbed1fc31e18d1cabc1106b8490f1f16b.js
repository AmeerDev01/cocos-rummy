System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "redux-act"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "bf4d8aMqvdH85QZkaYXKo6R", "game", undefined);
      ...
      _export("default", (_crd && reduxAct === void 0 ? (_reportPossibleCrUseOfreduxAct({
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_CHANGE_GAME]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_CHANGE_VIEW_GAME]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_UPDATE_BALANCE]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_CHANGE_PROFIT]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_CHANGE_AUTO_LAUNCHER_TYPE]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_UPDATE_SUBGAME_TIMES]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_SUBGAME_TIMES]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_UPDATE_JACKPOT_AMOUNT]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_WAITING]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_AUTO_LAUNCH]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_AUTO_LAUNCHED_TIMES]: (state, payload) => {
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_STOP_MODE]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_SET_SORT]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_FREE_GAME_ID]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_FREE_GAME_RATE]: (state, payload) => {
          return { ...state,
        ...
        [(_crd && ActionTypes === void 0 ? (_reportPossibleCrUseOfActionTypes({
          error: Error()
        }), ActionTypes) : ActionTypes).GODWEALTH_JACK_POT_USER]: (state, payload) => {
          return { ...state,
...
//# sourceMappingURL=29c9323fbed1fc31e18d1cabc1106b8490f1f16b.js.map