      ...
      _export("Yxx_Test", Yxx_Test = (_dec = ccclass('Yxx_Test'), _dec(_class = class Yxx_Test extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        bindEvent() {
          ...
          this.propertyNode.props_join.node.on(Node.EventType.TOUCH_END, () => {
            const headType = (_crd && initHeadType === void 0 ? (_reportPossibleCrUseOfinitHeadType({
              error: Error()
        ...
        bet() {
          ...
          let isMyBet = false;
          let index = Math.floor(Math.random() * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
          }), config) : config).gameOption.seatNumber + 1); // index = this.otherIndex;

          let chipIndex = Math.floor(Math.random() * (_crd && config === void 0 ? (_reportPossibleCrUseOfconfig({
            error: Error()
...
//# sourceMappingURL=8a581cb91d6cddc6ab427ece1bf211bf9f93d3b2.js.map