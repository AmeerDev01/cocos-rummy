        ...
        */
        ...
        createAllBatteryByPosition(sendFuncs, sceneParam) {
          ...
          for (const k in this.batteryPositionConfig) {
            ...
            if (ui !== null) {
              ...
              let obj = node.addComponent(_crd && Battery === void 0 ? (_reportPossibleCrUseOfBattery({
                error: Error()
              }), Battery) : Battery);
        ...
        setBatteryInfo(info) {
          if (!this.objectList.has(info.user_info.player_id)) {
            let batteryObj = this.objectListSet[info.user_info.set_id];
        ...
        removeBatteryByPlayerId(playerID) {
          let batteryObj = this.objectList.get(playerID);
...
//# sourceMappingURL=1c25f953e610771aeb06a12beeafcc1dcd5e8ed6.js.map