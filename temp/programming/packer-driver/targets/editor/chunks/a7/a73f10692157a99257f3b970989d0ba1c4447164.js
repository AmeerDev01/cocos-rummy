    ...
    execute: function () {
      ...
      EgyptV2MainViewModel = (_dec = (_crd && StoreInject === void 0 ? (_reportPossibleCrUseOfStoreInject({
        ...
        showDialogWin(dialogInfo, done) {
          let egyptV2DialogWinViewModel = new (_crd && EgyptV2DialogWinViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2DialogWinViewModel({
            error: Error()
        ...
        openRule() {
          const rulePanelViewMode = new (_crd && EgyptV2RulePanelViewModel === void 0 ? (_reportPossibleCrUseOfEgyptV2RulePanelViewModel({
            error: Error()
...
//# sourceMappingURL=a73f10692157a99257f3b970989d0ba1c4447164.js.map