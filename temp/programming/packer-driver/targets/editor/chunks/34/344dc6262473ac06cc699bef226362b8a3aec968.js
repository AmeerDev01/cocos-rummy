        ...
        constructor(mediatorName = null, viewComponent = null) {
          ...
          this.listNotificationConst = [{
            ...
            handler(notification) {
              ...
              const rollerComp = this.wrapView.getChildByName('Mask').getChildByName("slotListPanel").getComponent("gxfc_RollerPanel");
...
//# sourceMappingURL=344dc6262473ac06cc699bef226362b8a3aec968.js.map