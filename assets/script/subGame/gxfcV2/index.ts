...
import gxfcV2FileMap, { bundlePkgName } from './sourceDefine';
import { PrefabPathDefine } from "./sourceDefine/prefabDefine";
import { SoundPathDefine } from "./sourceDefine/soundDefine";
import fruitStore, { getStore } from './store';
import GxfcV2MainViewModel from "./viewModel/GxfcV2MainViewModel";
...
export let bundleGxfcV2: AssetManager.Bundle = null
export let mainViewModel: GxfcV2MainViewModel;
export let GxfcV2_Audio: AudioMgr<SoundPathDefine>
...
export const startUp = (rootNode: Node) => {
  ...
  assetManager.loadBundle(bundlePkgName, (err, bundle) => {
    bundleGxfcV2 = bundle
    bundleGxfcV2.load(PrefabPathDefine.LOAING_PANEL, Prefab, (progress, total) => {
      ...
      loaderviweModel = new LoaderPanelViewModel().mountView(prefab).appendTo(rootNode).setProps({
        ...
        onLoadDone: (_sourceManageMap) => {
          ...
          GxfcV2_Audio = new AudioMgr<SoundPathDefine>(sourceManageSeletor())
          setActiveAudio(GxfcV2_Audio)
          ...
          socketConnect().then(() => {
            ...
            mainViewModel = new GxfcV2MainViewModel(() => {
      ...
      loaderviweModel.comp.startLoad([bundle], [...gxfcV2FileMap])
    })
  })
}
