...
@ccclass('GxfcV2_SingleIconRoller')
export class GxfcV2_SingleIconRoller extends BaseComponent<IState, IProps, IEvent> {
	start() {
	...
	private rollOverHandle(endIcon: GxfcV2Icon) {
		this.scheduleOnce(() => {
