...
import { phoenixV2_Audio, mainViewModel } from '../index';
...
@ccclass('PhoenixV2_Footer')
export class PhoenixV2_Footer extends BaseComponent<IState, IProps, IEvent> {
	start() {
	...
	protected bindUI(): void {
		...
		mainViewModel.setFreeNumPos( this.node.parent.getChildByName('props_sg_free').worldPosition);
