...
import {
  GodWealthV2_SingleIconRoller,
  IEvent,
  IProps
} from "../components/GodWealthV2_SingleIconRoller";
import { getStore } from "../store";
import { StateType } from "../store/reducer";

@StoreInject(getStore())
class GodWealthV2SingleIconRollerViewModel extends ViewModel<
  GodWealthV2_SingleIconRoller,
  IProps,
  IEvent
> {
  ...
  public mountViewNode(viewNode: Node) {
    ...
    this.comp = this.viewNode.getComponent(
      this.componentStr
    ) as GodWealthV2_SingleIconRoller;
    return this;
  }
