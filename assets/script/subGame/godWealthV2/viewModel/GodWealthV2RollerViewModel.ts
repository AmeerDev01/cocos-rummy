...
import { GodWealthV2_Roller, IEvent, IProps } from "../components/GodWealthV2_Roller"
import { getStore } from "../store"
import { StateType } from "../store/reducer"

@StoreInject(getStore())
class GodWealthV2RollerViewModel extends ViewModel<GodWealthV2_Roller, IProps, IEvent> {
  constructor() {
  ...
  public mountViewNode(viewNode: Node) {
    ...
    this.comp = this.viewNode.getComponent(this.componentStr) as GodWealthV2_Roller
    return this
  }
