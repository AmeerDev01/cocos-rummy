...
export default reduxAct.createReducer<InitStateType>(
  {
    [ActionTypes.GODWEALTHV2_UPDATE_ROLLER_STATUS]: (
      state,
      payload: ActionPayLoad<ActionTypes.GODWEALTHV2_UPDATE_ROLLER_STATUS>
    ): InitStateType => {
      return {
        ...state,
    ...
    [ActionTypes.GODWEALTHV2_UPDATE_SPEED_STATUS]: (
      state,
      payload: ActionPayLoad<ActionTypes.GODWEALTHV2_UPDATE_SPEED_STATUS>
    ): InitStateType => {
      return {
        ...state,
    ...
    [ActionTypes.GODWEALTHV2_INIT_ROLLER]: (
      state,
      payload: ActionPayLoad<ActionTypes.GODWEALTHV2_INIT_ROLLER>
    ): InitStateType => {
      return {
