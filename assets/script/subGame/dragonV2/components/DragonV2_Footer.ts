...
export interface IEvent {
	onSendBet: () => void,
	onOpenRule: () => void,
	subnoteOperation: () => void,
}

@ccclass('DragonV2_Footer')
export class DragonV2_Footer extends BaseComponent<IState, IProps, IEvent> {
	start() {
	...
	private updateBetInfo() {
		...
		mainViewModel.dragonV2topValueViewModel.setProps({ amountInfo: amountInfo })
