...
import { Starlight_AuthLauncher, IProps, IEvent } from "../components/Starlight_AuthLauncher"
...
class AutoLauncherViewModel extends ViewModel<Starlight_AuthLauncher, IProps, IEvent> {
  constructor() {
