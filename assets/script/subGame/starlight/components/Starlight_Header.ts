	...
	protected useProps(key: keyof IProps, value: { pre: any, cur: any }) {
		if (key === "balance") {
			...
			this.stepNumber = new StepNumber(value.pre, value.cur, (num) => {
				this.propertyNode && this.propertyNode.props_Label_up_goldNum && (this.propertyNode.props_Label_up_goldNum.string =(+num) ? Number(value.cur).formatAmountWithCommas() : Number(value.cur).formatAmountWithLetter())
			}, () => { })
