...
import { bandarQiuQiu_Audio, playBtnClick, playMainBg } from '../index';
...
@ccclass('BandarQiuQiu_set')
export class BandarQiuQiu_set extends BaseComponent<IState, IProps, IEvent> {
	start() {
	...
	protected bindEvent(): void {
		...
		this.propertyNode.props_toggle_music.on('toggle', (toggle) => {
			playBtnClick();
			 ...
			 toggle.target.getComponent(Toggle).isChecked ? playMainBg() : bandarQiuQiu_Audio.pause();
			}, this)
