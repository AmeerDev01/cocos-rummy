...
import { ruleViewModel, setViewModel } from '../viewModel/BandarQiuQiuTitleViewModel';
...
@ccclass('BandarQiuQiu_title')
export class BandarQiuQiu_title extends BaseComponent<IState, IProps, IEvent> {
	start() {
