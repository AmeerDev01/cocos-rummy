...
export default reduxAct.createReducer<InitStateType>({
  [ActionTypes.THOR_BEGIN_ROLL]: (state, payload: ActionPayLoad<ActionTypes.THOR_BEGIN_ROLL>): InitStateType => {
  ...
  [ActionTypes.THOR_INIT_ROLL]: (state, payload: ActionPayLoad<ActionTypes.THOR_INIT_ROLL>): InitStateType => {
    return {
      ...state,
      rollerMap: payload.rollerMap
    }
  },
  [ActionTypes.THOR_SET_STOP_ROLL]: (state, payload: ActionPayLoad<ActionTypes.THOR_SET_STOP_ROLL>): InitStateType => {
    const rollerMap = copy(state.rollerMap)
  ...
  [ActionTypes.THOR_END_ROLLING]: (state, payload: ActionPayLoad<ActionTypes.THOR_END_ROLLING>): InitStateType => {
    const rollerMap = copy(state.rollerMap)
  ...
  [ActionTypes.THOR_SET_FLICKER]: (state, payload: ActionPayLoad<ActionTypes.THOR_SET_FLICKER>): InitStateType => {
    return {
      ...state,
      iconEffectData: {
  ...
  [ActionTypes.THOR_SET_ROUNT_END]: (state, payload: ActionPayLoad<ActionTypes.THOR_SET_ROUNT_END>): InitStateType => {
    return {
      ...state,
      roundAllEnd: payload.roundAllEnd
    }
  },
  [ActionTypes.THOR_SET_ROLL_SMALLBOX]: (state, payload: ActionPayLoad<ActionTypes.THOR_SET_ROLL_SMALLBOX>): InitStateType => {
  ...
  [ActionTypes.THOR_SET_ROLL_SPEED]: (state, payload: ActionPayLoad<ActionTypes.THOR_SET_ROLL_SPEED>): InitStateType => {
