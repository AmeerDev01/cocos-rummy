import { _decorator, Button, Color, color, Component, Animation, Label, Layers, Material, AudioSource, Node, Prefab, sp, Sprite, SpriteFrame, SpriteRenderer, tween, UIOpacity, UITransform, Vec3 } from 'cc';
