...
export default reduxAct.createReducer<InitStateType>({
  [ActionTypes.GODWEALTH_BEGIN_ROLL]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_BEGIN_ROLL>): InitStateType => {
  ...
  [ActionTypes.GODWEALTH_INIT_ROLL]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_INIT_ROLL>): InitStateType => {
    // const _state = instantiate(state)
  ...
  [ActionTypes.GODWEALTH_SET_STOP_ROLL]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_SET_STOP_ROLL>): InitStateType => {
  ...
  [ActionTypes.GODWEALTH_END_ROLLING]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_END_ROLLING>): InitStateType => {
    // const _state = instantiate(state)
  ...
  [ActionTypes.GODWEALTH_SET_FLICKER]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_SET_FLICKER>): InitStateType => {
    return {
      ...state,
      iconEffectData: {
  ...
  [ActionTypes.GODWEALTH_SET_ROUNT_END]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_SET_ROUNT_END>): InitStateType => {
    return {
      ...state,
      roundAllEnd: payload.roundAllEnd
    }
  },
  [ActionTypes.GODWEALTH_SET_ROLL_SPEED]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_SET_ROLL_SPEED>): InitStateType => {
    const _state = instantiate(state)
  ...
  [ActionTypes.GODWEALTH_SET_BAOHE_FLICKER]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_SET_BAOHE_FLICKER>): InitStateType => {
    return {
      ...state,
      iconBaoHeEffectData: {
        iconEffect: payload.iconEffect,
  ...
  [ActionTypes.GODWEALTH_SET_FREEGAME_FLICKER]: (state, payload: ActionPayLoad<ActionTypes.GODWEALTH_SET_FREEGAME_FLICKER>): InitStateType => {
    return {
      ...state,
