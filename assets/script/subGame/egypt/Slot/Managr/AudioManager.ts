...
export const SceneBgMusic = {
    mainBg: "bgMain", // 主音乐
    gameBg: "bgFree",// 小游戏1主音乐
    gameBgT: "bgMusic",//小游戏2主音乐
}
export const SoundList = {
    buttonClick: "btn_click", //点击按钮
    admission:"sgbegin1", //小游戏入场动画音效
    sunGod: "sunGod",  //太阳神出场时音效
    absorb: "sunGodNum", //太阳神吸收甲虫身上数值时音效
    coinCollection: "get_coin", // 金币收集
