...
import { phoenix_authLauncher, IProps, IEvent } from "../components/phoenix_authLauncher"
...
class AutoLauncherViewModel extends ViewModel<phoenix_authLauncher, IProps, IEvent> {
  constructor() {
