...
import { phoenix_footer, IProps, IEvent } from "../components/phoenix_footer"
import { StateType } from "../store/reducer"
import { getStore } from "../store"
import AutoLauncherViewModel from "./AutoLauncherViewModel"
import { footerViewModel, phoenix_Audio, playFastRoller, sourceManageSeletor } from "../index"
import { PrefabPathDefine } from "../sourceDefine/prefabDefine"
import { EffectType } from "../../../utils/NodeIOEffect"
import BaseViewModel from "../../../common/viewModel/BaseViewModel"
import { phoenix_helpPanel, IProps as FIProps, IState as FIState, IEvent as FIEvent } from "../components/phoenix_helpPanel"
...
class FooterViewModel extends ViewModel<phoenix_footer, IProps, IEvent> {
  constructor() {
    super('phoenix_footer')
  }
  public autoLauncherPanel: AutoLauncherViewModel
  public helpPanelPanel: BaseViewModel<phoenix_helpPanel, FIState, FIProps, FIEvent>
  ...
  protected begin() {
    ...
    this.setEvent({
      ...
      openHelpPanel: () => {
        this.helpPanelPanel = new BaseViewModel<phoenix_helpPanel, FIState, FIProps, FIEvent>("phoenix_helpPanel").mountView(sourceManageSeletor().getFile(PrefabPathDefine.RULE).source)
  ...
  public manualBetHandler() {
    ...
    if(!this.comp || !this.comp.props){return}
