import { _decorator, Component, EditBox, ImageAsset, instantiate, isValid, Label, native, Node, Prefab, Sprite, SpriteFrame, sys, systemEvent, Texture2D, tween, UIOpacity, UITransform, Vec2, Vec3 } from 'cc';
