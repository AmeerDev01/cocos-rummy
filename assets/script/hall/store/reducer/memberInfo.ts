...
export default reduxAct.createReducer<InitStateType>({
  ...
  [ActionTypes.SET_VIP]: (state, payload: ActionPayLoad<ActionTypes.SET_VIP>): InitStateType => {
    return {
      ...state,
      vipLevel: payload.vipLevel,
      vipLevelExperience: payload.vipLevelExperience
  ...
  [ActionTypes.CHANGE_GOLD]: (state, payload: ActionPayLoad<ActionTypes.CHANGE_GOLD>): InitStateType => {
    return {
      ...state,
      memberAssetGoldPieces: state.memberAssetGoldPieces + payload.value,
    }
  },
  [ActionTypes.UPDATE_ACTIVITY_STATUS]: (state, payload: ActionPayLoad<ActionTypes.UPDATE_ACTIVITY_STATUS>): InitStateType => {
    return {
      ...state,
